...
export const GAME_DATA: GameData = {
  ...
  regions: [
    ...
    { id: 'chubu', name: 'ちゅうぶ', kanji: '中部', emoji: '🗻', active: true, color: '#FFE0B2', mapFile: 'map-chubu.json', unlockFests: 6 },
    { id: 'kinki', name: 'きんき', kanji: '近畿', emoji: '🦌', active: true, color: '#F8BBD0', mapFile: 'map-kinki.json', unlockFests: 9 },
    { id: 'chugoku', name: 'ちゅうごく', kanji: '中国', emoji: '⛩️', active: true, color: '#FFF59D', mapFile: 'map-chugoku.json', unlockFests: 12 },
    { id: 'shikoku', name: 'しこく', kanji: '四国', emoji: '🍊', active: true, color: '#B2DFDB', mapFile: 'map-shikoku.json', unlockFests: 15 },
  ...
  /* ---------- そざいマスタ(Tier1) ---------- */
  materials: [
    { id: 'm01', name: 'みず', emoji: '💧', origins: ['ibaraki', 'akita', 'yamanashi', 'shiga', 'tottori', 'kochi'], rarity: 'common',
      gather: { type: 'infra', building: 'いど', bEmoji: '⛲', rateSec: 120, max: 3, collectVerb: 'くみあげる' } },
    { id: 'm02', name: 'こめ', emoji: '🌾', origins: ['chiba', 'akita', 'miyagi', 'fukushima', 'niigata', 'toyama', 'fukui', 'gifu', 'shiga'], rarity: 'common',
    ...
    { id: 'm03', name: 'だいず', emoji: '🫘', origins: ['tochigi', 'aichi', 'hyogo'], rarity: 'local',
    ...
    { id: 'm04', name: 'さつまいも', emoji: '🍠', origins: ['ibaraki', 'chiba', 'saitama', 'tokushima'], rarity: 'local',
    ...
    { id: 'm06', name: 'うめ', emoji: '🫒', origins: ['ibaraki', 'gunma', 'tokyo', 'fukui', 'wakayama'], rarity: 'local',
    ...
    { id: 'm07', name: 'ねんど', emoji: '🟤', origins: ['ibaraki', 'tochigi', 'ishikawa', 'gifu', 'shiga', 'okayama'], rarity: 'local',
    ...
    { id: 'm09', name: 'いわし', emoji: '🐟', origins: ['chiba', 'kanagawa', 'kagawa'], rarity: 'local',
    ...
    { id: 'm10', name: 'なし', emoji: '🍐', origins: ['chiba', 'tochigi', 'fukushima', 'yamagata', 'tottori'], rarity: 'local',
    ...
    { id: 'm11', name: 'いちご', emoji: '🍓', origins: ['tochigi', 'miyagi', 'nara'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300,
    ...
    /* --- ぐんま --- */
    { id: 'm13', name: 'キャベツ', emoji: '🥬', origins: ['gunma', 'kanagawa', 'gifu', 'aichi'], rarity: 'local',
    ...
    /* --- さいたま --- */
    { id: 'm16', name: 'ちゃば', emoji: '🍃', origins: ['saitama', 'kanagawa', 'ishikawa', 'shizuoka', 'aichi', 'mie', 'shiga', 'kyoto', 'nara'], rarity: 'local',
    ...
    /* --- かながわ --- */
    { id: 'm19', name: 'みかん', emoji: '🍊', origins: ['kanagawa', 'shizuoka', 'aichi', 'wakayama', 'yamaguchi', 'ehime'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
        harvest: { engine: 'catch', target: '🍊', prompt: 'おちてくる みかんを かごで キャッチ! えだは よけてね' },
        care: { target: '🐝', label: 'はちが みに あつまってる! タップで はらおう!' } } },

    /* --- あおもり --- */
    { id: 'm20', name: 'りんご', emoji: '🍎', origins: ['aomori', 'iwate', 'nagano'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
    ...
    /* --- ふくしま --- */
    { id: 'm30', name: 'もも', emoji: '🍑', origins: ['fukushima', 'yamanashi', 'okayama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
    ...
    { id: 'm34', name: 'ねぎ', emoji: '🧅', origins: ['saitama', 'gunma', 'akita', 'kyoto', 'tottori'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
        harvest: { engine: 'pluck', target: '🧅', prompt: 'そだった ねぎを おさえて、ゆーっくり ひきぬこう! はやいと ちぎれちゃう' },
        care: { target: '🐛', label: 'むしが はっぱに ついてる! タップで とろう!' } } },
    { id: 'm35', name: 'すいか', emoji: '🍉', origins: ['kanagawa'], rarity: 'local',
    ...
    { id: 'm36', name: 'かに', emoji: '🦀', origins: ['hokkaido', 'ishikawa', 'fukui', 'kyoto', 'tottori'], rarity: 'local',
    ...
    { id: 'm37', name: 'ほたて', emoji: '🐚', origins: ['aomori'], rarity: 'unique',
      gather: { type: 'plant', verb: 'かごを つるす', growSec: 480, fieldLabel: 'ほたての いかだ',
        ...
        care: { target: '🦅', label: 'とりが いかだを ねらってる! タップで おいはらえ!' } } },
    { id: 'm38', name: 'わかめ', emoji: '☘️', origins: ['iwate', 'tokushima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねなわを しずめる', growSec: 480, fieldLabel: 'いかだ',
        ...
        care: { target: '🐠', label: 'さかなが わかめを たべにきた! タップで おいはらえ!' } } },
    { id: 'm39', name: 'せり', emoji: '🌱', origins: ['miyagi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'みずた',
        harvest: { engine: 'pluck', target: '🌱', prompt: 'せりは ねっこも おいしい! おさえて ゆーっくり ひきぬこう' },
        care: { target: '🐛', label: 'むしが はっぱに ついてる! タップで とろう!' } } },
    { id: 'm40', name: 'べにばな', emoji: '🌺', origins: ['yamagata'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420,
        harvest: { engine: 'chain', target: '🌺', prompt: 'きいろから あかに かわった はなだけ つもう! きいろは まだ はやいよ' },
        care: { target: '🐝', label: 'はちが はなに あつまってる! タップで はらおう!' } } },
    { id: 'm41', name: 'わさび', emoji: '🍀', origins: ['tokyo', 'nagano', 'shizuoka'], rarity: 'local',
    ...
    { id: 'm44', name: 'いか', emoji: '🦑', origins: ['hokkaido', 'aomori', 'toyama', 'yamaguchi'], rarity: 'local',
    ...
    { id: 'm46', name: 'そば', emoji: '🌰', origins: ['fukushima', 'fukui', 'nagano', 'shimane'], rarity: 'local',
    ...
    { id: 'm42', name: 'うど', emoji: '🎍', origins: ['tokyo'], rarity: 'unique',
      gather: { type: 'plant', verb: 'かぶを うえる', growSec: 480, fieldLabel: 'むろ',
        ...
        care: { target: '🌀', label: 'むろの ひかりが もれてる! タップで ふさごう!' } } },

    /* --- ちゅうぶ(2026-07 追加) --- */
    { id: 'm47', name: 'さけ', emoji: '🐡', origins: ['niigata', 'toyama'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'かわを のぼる さけの きせつが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐡', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐡'] } } },
    { id: 'm48', name: 'なす', emoji: '🍆', origins: ['niigata'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
        harvest: { engine: 'chain', target: '🍆', prompt: 'つやつやの むらさきに なった なすだけ つもう! みどりは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm49', name: 'チューリップ', emoji: '🌷', origins: ['niigata', 'toyama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'きゅうこんを うえる', growSec: 480, fieldLabel: 'はなばたけ',
        harvest: { engine: 'pluck', target: '🌷', prompt: 'さきごろの はなを おさえて、ゆーっくり ひきぬこう! はやいと くきが おれちゃう' },
        care: { target: '🐛', label: 'むしが はっぱに ついてる! タップで とろう!' } } },
    { id: 'm50', name: 'しろえび', emoji: '🦐', origins: ['toyama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 420, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🦐', prompt: 'ざるを うごかして、ひかる しろえびの むれを すくいとろう!' },
        care: { target: '🦅', label: 'とんびが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm51', name: 'しお', emoji: '🧂', origins: ['ishikawa', 'hyogo'], rarity: 'unique',
      gather: { type: 'infra', building: 'えんでん', bEmoji: '🏖️', rateSec: 180, max: 3, collectVerb: 'かきあつめる' } },
    { id: 'm52', name: 'れんこん', emoji: '🪷', origins: ['ishikawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねばすを うえる', growSec: 540, fieldLabel: 'はすだ',
        ...
        care: { target: '🐦', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm53', name: 'チタン', emoji: '🔩', origins: ['fukui'], rarity: 'unique',
      gather: { type: 'dig', verb: 'ほりに いく',
        theme: { intro: 'かるくて つよい きんぞくの こうせきを みつけた!', prompt: 'すうじは「まわりに こうせきが いくつ あるか」の ヒント! すいりして ほろう', success: 'ほりあて せいこう!', stages: ['⛰️', '⛏️', '✨'] } } },
    { id: 'm54', name: 'ぶどう', emoji: '🍇', origins: ['yamanashi', 'nagano', 'osaka', 'shimane', 'okayama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900,
        harvest: { engine: 'pluck', target: '🍇', prompt: 'むらさきに じゅくした ふさを おさえて、ゆーっくり ひっぱろう!' },
        care: { target: '🐦', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    { id: 'm55', name: 'すいしょう', emoji: '💎', origins: ['yamanashi'], rarity: 'unique',
      gather: { type: 'dig', verb: 'ほりに いく',
        theme: { intro: 'きらきら ひかる いしが ねむる やまを みつけた!', prompt: 'すうじは「まわりに すいしょうが いくつ あるか」の ヒント! すいりして ほろう', success: 'ほりあて せいこう!', stages: ['⛰️', '⛏️', '✨'] } } },
    { id: 'm56', name: 'かぼちゃ', emoji: '🎃', origins: ['yamanashi'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 600,
        harvest: { engine: 'flick', target: '🎃', prompt: 'おもい かぼちゃを はじいて、かごに ころがしこもう!' },
        care: { target: '🐗', label: 'いのししが かぼちゃを ねらってる! タップで おいはらえ!' } } },
    { id: 'm57', name: 'きのこ', emoji: '🍄', origins: ['nagano'], rarity: 'unique',
      gather: { type: 'plant', verb: 'ほだぎを ならべる', growSec: 420, fieldLabel: 'きのこごや',
        harvest: { engine: 'chain', target: '🍄', prompt: 'かさが ぴんと ひらいた きのこだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐌', label: 'なめくじが きのこを たべてる! タップで とろう!' } } },
    { id: 'm58', name: 'こうぞ', emoji: '🪵', origins: ['gifu'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 660, fieldLabel: 'こうぞばたけ',
        harvest: { engine: 'reap', target: '🪵', prompt: 'よこに なぞって こうぞを かりとろう! 1れつを ひとふでで かると ボーナス!' },
        care: { target: '🐛', label: 'むしが かわを かじってる! タップで とろう!' } } },
    { id: 'm59', name: 'あゆ', emoji: '🐟', origins: ['gifu', 'nara'], rarity: 'unique',
      gather: { type: 'timing', verb: 'うかいに でる',
        theme: { intro: 'ながらがわの うかい(かがり火の りょう)が はじまる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'] } } },
    { id: 'm60', name: 'しらす', emoji: '🐟', origins: ['shizuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 300, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🐟', prompt: 'ざるを うごかして、しらすの むれを すくいとろう!' },
        care: { target: '🦅', label: 'とんびが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm62', name: 'さくらえび', emoji: '🍤', origins: ['shizuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 480, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🍤', prompt: 'ざるを うごかして、うすピンクの さくらえびを すくいとろう!' },
        care: { target: '🦅', label: 'とんびが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm61', name: 'うずらのたまご', emoji: '🥚', origins: ['aichi'], rarity: 'unique',
      gather: { type: 'infra', building: 'うずらごや', bEmoji: '🐣', rateSec: 150, max: 3, collectVerb: 'あつめる' } },
    ...
    /* --- きんき(2026-07 追加) --- */
    { id: 'm63', name: 'しんじゅ', emoji: '🦪', origins: ['mie'], rarity: 'unique',
      gather: { type: 'plant', verb: 'アコヤがいを つるす', growSec: 540, fieldLabel: 'しんじゅの いかだ',
        harvest: { engine: 'shell', target: '🦪', prompt: 'ロープを ちょうどよい はやさで ひきあげて、デッキで たまを とりだそう! はやすぎると おちるよ' },
        care: { target: '🌀', label: 'あかしおが きそう! タップで いかだを うごかせ!' } } },
    { id: 'm64', name: 'いせえび', emoji: '🦞', origins: ['mie'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 480, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🦞', prompt: 'ざるを うごかして、いわばに あつまった いせえびを すくいとろう!' },
        care: { target: '🦈', label: 'おおきな さかなが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm65', name: 'のり', emoji: '🟩', origins: ['mie'], rarity: 'local',
      gather: { type: 'plant', verb: 'のりあみを はる', growSec: 420, fieldLabel: 'のりひび',
        harvest: { engine: 'reap', target: '🟩', prompt: 'よこに なぞって のりを つみとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🦆', label: 'かもが のりを たべにきた! タップで おいはらえ!' } } },
    { id: 'm66', name: 'わぎゅう', emoji: '🐄', origins: ['mie'], rarity: 'unique',
      gather: { type: 'infra', building: 'ぼくじょう', bEmoji: '🏡', rateSec: 180, max: 3, collectVerb: 'せわを する' } },
    { id: 'm67', name: 'ふな', emoji: '🐟', origins: ['shiga'], rarity: 'unique',
      gather: { type: 'timing', verb: 'ふなを つる',
        theme: { intro: 'びわこの ふなが およいでいる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['🚣', '🌊', '🐟'] } } },
    { id: 'm68', name: 'たけのこ', emoji: '🎍', origins: ['kyoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たけやまを ととのえる', growSec: 480, fieldLabel: 'たけやま',
        ...
        care: { target: '🐗', label: 'いのししが たけのこを ほりにきた! タップで おいはらえ!' } } },
    { id: 'm69', name: 'まつたけ', emoji: '🍄', origins: ['kyoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あかまつの やまを まもる', growSec: 600, fieldLabel: 'あかまつの やま',
        harvest: { engine: 'sweep', target: '🍄', prompt: 'おちばを こすって かきわけて、かくれている まつたけを さがそう!' },
        care: { target: '🐗', label: 'いのししが やまを あらしてる! タップで おいはらえ!' } } },
    { id: 'm70', name: 'たこ', emoji: '🐙', origins: ['osaka', 'hyogo'], rarity: 'local',
      gather: { type: 'plant', verb: 'たこつぼを しずめる', growSec: 420, fieldLabel: 'たこつぼば',
        harvest: { engine: 'shell', target: '🐙', prompt: 'ロープを ちょうどよい はやさで ひきあげて、デッキで たこを つぼから だそう!' },
        care: { target: '🦅', label: 'とんびが つぼを ねらってる! タップで おいはらえ!' } } },
    { id: 'm79', name: 'みずなす', emoji: '🍆', origins: ['osaka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'せんしゅうの はたけ',
        harvest: { engine: 'chain', target: '🍆', prompt: 'つやつやの まるい みずなすだけ つもう! みどりは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm71', name: 'しゅんぎく', emoji: '🌿', origins: ['osaka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'なにわの はたけ',
        harvest: { engine: 'reap', target: '🌿', prompt: 'よこに なぞって しゅんぎくを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm72', name: 'たまねぎ', emoji: '🧅', origins: ['osaka', 'hyogo'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 420, fieldLabel: 'たまねぎばたけ',
        harvest: { engine: 'pluck', target: '🧅', prompt: 'おおきく なった たまねぎを おさえて、ゆーっくり ひきぬこう! はやいと はっぱが ちぎれる' },
        care: { target: '🐦', label: 'とりが なえを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm73', name: 'いかなご', emoji: '🐟', origins: ['hyogo'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 300, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🐟', prompt: 'ざるを うごかして、ひかる いかなごの むれを すくいとろう!' },
        care: { target: '🦅', label: 'かもめが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm74', name: 'かきのみ', emoji: '🟠', origins: ['nara'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'かきばたけ',
        harvest: { engine: 'catch', target: '🟠', prompt: 'おちてくる かきを かごで うけとめよう! きんの かきは とくてん おおい!' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm75', name: 'よしのすぎ', emoji: '🌲', origins: ['nara'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 600, fieldLabel: 'すぎの やま',
        harvest: { engine: 'reap', target: '🌲', prompt: 'よこに なぞって のこぎりで すぎを きりだそう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', label: 'えだが しげって ひが とどかない! タップで えだうち!' } } },
    { id: 'm76', name: 'さんしょう', emoji: '🌶️', origins: ['wakayama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 420, fieldLabel: 'さんしょうばたけ',
        harvest: { engine: 'chain', target: '🌶️', prompt: 'みどりが こくなった つぶだけ つもう! まだ うすいのは はやいよ' },
        care: { target: '🐛', label: 'あおむしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm77', name: 'まぐろ', emoji: '🐟', origins: ['wakayama'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'おきに まぐろの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'] } } },
    { id: 'm78', name: 'びんちょうたん', emoji: '⬛', origins: ['wakayama'], rarity: 'unique',
      gather: { type: 'infra', building: 'すみやきがま', bEmoji: '🔥', rateSec: 180, max: 3, collectVerb: 'とりだす' } },

    /* --- ちゅうごく・しこく(2026-07 追加) --- */
    { id: 'm80', name: 'らっきょう', emoji: '🧄', origins: ['tottori'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを うえる', growSec: 480, fieldLabel: 'すなおかの はたけ',
        ...
        care: { target: '🐦', label: 'とりが なえを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm81', name: 'しじみ', emoji: '🐚', origins: ['shimane'], rarity: 'unique',
      gather: { type: 'plant', verb: 'じょれんを しずめる', growSec: 420, fieldLabel: 'しじみの りょうば',
        harvest: { engine: 'shell', target: '🐚', prompt: 'じょれんの ロープを ちょうどよい はやさで ひきあげて、ふねで しじみを えらぼう!' },
        care: { target: '🦆', label: 'かもが しじみを たべにきた! タップで おいはらえ!' } } },
    { id: 'm82', name: 'のどぐろ', emoji: '🐠', origins: ['shimane'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'ふかい うみに のどぐろが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐠', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐠'] } } },
    { id: 'm83', name: 'ままかり', emoji: '🐟', origins: ['okayama'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'せとうちに ままかりの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['🚣', '🌊', '🐟'] } } },
    { id: 'm84', name: 'きにら', emoji: '🌿', origins: ['okayama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'くらの はたけ',
        harvest: { engine: 'reap', target: '🌿', prompt: 'よこに なぞって きにらを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', label: 'ひかりが もれて みどりに なっちゃう! タップで ふさごう!' } } },
    { id: 'm85', name: 'レモン', emoji: '🍋', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 480, fieldLabel: 'レモンばたけ',
        harvest: { engine: 'catch', target: '🍋', prompt: 'おちてくる レモンを かごで うけとめよう! きんの レモンは とくてん おおい!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm86', name: 'ひろしまな', emoji: '🥬', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'なばたけ',
        harvest: { engine: 'reap', target: '🥬', prompt: 'よこに なぞって ひろしまなを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', label: 'あおむしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm87', name: 'あなご', emoji: '🐟', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'みやじまの おきに あなごが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'] } } },
    { id: 'm88', name: 'わけぎ', emoji: '🌱', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'きゅうこんを うえる', growSec: 300, fieldLabel: 'わけぎばたけ',
        harvest: { engine: 'pluck', target: '🌱', prompt: 'そっと おさえて、ゆーっくり ひきぬこう! はやいと ちぎれちゃう' },
        care: { target: '🐦', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm89', name: 'ふぐ', emoji: '🐡', origins: ['yamaguchi'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'しものせきの うみに ふぐが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐡', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐡'] } } },
    { id: 'm104', name: 'いわくにれんこん', emoji: '🪷', origins: ['yamaguchi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねばすを うえる', growSec: 540, fieldLabel: 'はすだ',
        harvest: { engine: 'mine', prompt: 'れんこんは どろの なか。すうじの ヒントで ばしょを すいりして ほろう!' },
        care: { target: '🐦', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm90', name: 'はなっこりー', emoji: '🥦', origins: ['yamaguchi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'はなっこりーばたけ',
        harvest: { engine: 'chain', target: '🥦', prompt: 'つぼみが ふくらんだ ものだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm91', name: 'すだち', emoji: '🟢', origins: ['tokushima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 420, fieldLabel: 'すだちばたけ',
        harvest: { engine: 'catch', target: '🟢', prompt: 'おちてくる すだちを かごで うけとめよう! きんの すだちは とくてん おおい!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm92', name: 'あい', emoji: '🟦', origins: ['tokushima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 480, fieldLabel: 'あいばたけ',
        harvest: { engine: 'reap', target: '🟦', prompt: 'よこに なぞって あいの はっぱを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm93', name: 'たい', emoji: '🐠', origins: ['tokushima', 'ehime'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'うずしおの ながれに たいが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐠', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐠'] } } },
    { id: 'm94', name: 'こむぎ', emoji: '🌾', origins: ['kagawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'むぎばたけ',
        harvest: { engine: 'reap', target: '🌾', prompt: 'よこに なぞって こむぎを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐦', label: 'すずめが ほを たべにきた! タップで おいはらえ!' } } },
    { id: 'm95', name: 'オリーブ', emoji: '🫒', origins: ['kagawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'オリーブばたけ',
        harvest: { engine: 'pluck', target: '🫒', prompt: 'いろの ついた みを おさえて、ゆーっくり つみとろう! はやいと えだが おれる' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm96', name: 'きんときにんじん', emoji: '🥕', origins: ['kagawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'にんじんばたけ',
        harvest: { engine: 'pluck', target: '🥕', prompt: 'はっぱを おさえて、ゆーっくり ひきぬこう! はやいと ちぎれちゃう' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm97', name: 'わた', emoji: '🧵', origins: ['ehime', 'kagawa'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 480, fieldLabel: 'わたばたけ',
        harvest: { engine: 'chain', target: '🧵', prompt: 'まっしろに はじけた わただけ つもう! みどりの みは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが みを たべてる! タップで とろう!' } } },
    { id: 'm98', name: 'キウイ', emoji: '🥝', origins: ['ehime'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'キウイの たな',
        harvest: { engine: 'pluck', target: '🥝', prompt: 'そっと おさえて、ゆーっくり つみとろう! はやいと つるが きれちゃう' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm99', name: 'はだかむぎ', emoji: '🌾', origins: ['ehime'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'むぎばたけ',
        harvest: { engine: 'reap', target: '🌾', prompt: 'よこに なぞって はだかむぎを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐦', label: 'すずめが ほを たべにきた! タップで おいはらえ!' } } },
    { id: 'm100', name: 'ゆず', emoji: '🍋', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'ゆずばたけ',
        harvest: { engine: 'catch', target: '🍋', prompt: 'おちてくる ゆずを かごで うけとめよう! きんの ゆずは とくてん おおい!' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm101', name: 'かつお', emoji: '🐟', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'timing', verb: 'いっぽんづりに でる',
        theme: { intro: 'とさの おきに かつおの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'さおを あげる!', marker: '🐟', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'] } } },
    { id: 'm102', name: 'しょうが', emoji: '🫚', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねしょうがを うえる', growSec: 480, fieldLabel: 'しょうがばたけ',
        ...
        care: { target: '🌀', label: 'つちが かわいてる! タップで みずを やろう!' } } },
    { id: 'm103', name: 'ししとう', emoji: '🫑', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'ハウスの はたけ',
        harvest: { engine: 'chain', target: '🫑', prompt: 'つやつやの みどりの ししとうだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが みを たべてる! タップで とろう!' } } },
  ],
  ...
  recipes: [
    ...
    /* ぐんま */
    { id: 'r41', name: 'うめぼし', emoji: '🍙', tier: 2, type: 'kakou', pref: 'gunma',
      ingredients: [{ ref: 'm06', count: 2, origin: 'gunma' }] },
    /* さいたま */
    { id: 'r42', name: 'ねぎの まるやき', emoji: '🔥', tier: 3, type: 'gattai', pref: 'saitama',
      ingredients: [{ ref: 'm34', count: 2, origin: 'saitama' }, { ref: 'r08', count: 1 }] },
    /* とうきょう */
    { id: 'r43', name: 'わさびづけ', emoji: '🫙', tier: 2, type: 'kakou', pref: 'tokyo',
      ingredients: [{ ref: 'm41', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r44', name: 'つくだに', emoji: '🍚', tier: 3, type: 'gattai', pref: 'tokyo',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'r07', count: 1 }] },
    /* かながわ */
    { id: 'r45', name: 'あしがらちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'kanagawa',
      ingredients: [{ ref: 'm16', count: 2, origin: 'kanagawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r46', name: 'よこすか カレー', emoji: '🍛', tier: 3, type: 'gattai', pref: 'kanagawa',
      ingredients: [{ ref: 'm33', count: 2 }, { ref: 'm01', count: 1 }] },
    /* ほっかいどう */
    { id: 'r47', name: 'チーズ', emoji: '🧀', tier: 2, type: 'kakou', pref: 'hokkaido',
      ingredients: [{ ref: 'm23', count: 2, origin: 'hokkaido' }] },
    { id: 'r48', name: 'かにめし', emoji: '🍱', tier: 3, type: 'gattai', pref: 'hokkaido',
      ingredients: [{ ref: 'm36', count: 2 }, { ref: 'm02', count: 1 }] },
    /* あおもり */
    { id: 'r49', name: 'ほたての かいやき', emoji: '🐚', tier: 3, type: 'gattai', pref: 'aomori',
      ingredients: [{ ref: 'm37', count: 2 }, { ref: 'r08', count: 1 }] },
    { id: 'r50', name: 'アップルパイ', emoji: '🥧', tier: 3, type: 'gattai', pref: 'aomori',
      ingredients: [{ ref: 'm20', count: 2, origin: 'aomori' }, { ref: 'r39', count: 1 }] },
    /* いわて */
    { id: 'r51', name: 'ほしわかめ', emoji: '🍂', tier: 2, type: 'kakou', pref: 'iwate',
      ingredients: [{ ref: 'm38', count: 2 }] },
    { id: 'r52', name: 'わかめの おにぎり', emoji: '🍙', tier: 3, type: 'gattai', pref: 'iwate',
      ingredients: [{ ref: 'm38', count: 1 }, { ref: 'm02', count: 1 }, { ref: 'm01', count: 1 }] },
    /* みやぎ */
    { id: 'r53', name: 'ささかまぼこ', emoji: '🍥', tier: 2, type: 'kakou', pref: 'miyagi',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r54', name: 'せりなべ', emoji: '🍲', tier: 3, type: 'gattai', pref: 'miyagi',
      ingredients: [{ ref: 'm39', count: 2 }, { ref: 'r08', count: 1 }] },
    /* あきた */
    { id: 'r55', name: 'しょっつる', emoji: '🧴', tier: 2, type: 'kakou', pref: 'akita',
      ingredients: [{ ref: 'm27', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r56', name: 'はたはたずし', emoji: '🍣', tier: 3, type: 'gattai', pref: 'akita',
      ingredients: [{ ref: 'm27', count: 2 }, { ref: 'm02', count: 1, origin: 'akita' }] },
    /* やまがた */
    { id: 'r57', name: 'たまこんにゃく', emoji: '🍡', tier: 2, type: 'kakou', pref: 'yamagata',
      ingredients: [{ ref: 'm14', count: 2 }, { ref: 'r07', count: 1 }] },
    /* ふくしま */
    { id: 'r58', name: 'いかにんじん', emoji: '🥕', tier: 3, type: 'gattai', pref: 'fukushima',
      ingredients: [{ ref: 'm22', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'r59', name: 'ブランドもも', emoji: '👑', tier: 3, type: 'syukaku', pref: 'fukushima',
      ingredients: [{ ref: 'm30', count: 1, quality: 3 }] },

    /* --- 数そろえ(2026-07): 全県 tier2×3 に そろえる ---
       いばらき・ちば が 3品だったので、そこに あわせて 各県に 1品ずつ 足した */
    { id: 'r60', name: 'ずんだ', emoji: '🥣', tier: 2, type: 'kakou', pref: 'miyagi',
      ingredients: [{ ref: 'm25', count: 2, origin: 'miyagi' }, { ref: 'm01', count: 1 }] },
    { id: 'r61', name: 'にっこうゆば', emoji: '🍥', tier: 2, type: 'kakou', pref: 'tochigi',
      ingredients: [{ ref: 'm03', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r62', name: 'きいと', emoji: '🧵', tier: 2, type: 'kakou', pref: 'gunma',
      ingredients: [{ ref: 'm15', count: 2, origin: 'gunma' }, { ref: 'm01', count: 1 }] },
    { id: 'r63', name: 'いもせんべい', emoji: '🍘', tier: 2, type: 'kakou', pref: 'saitama',
      ingredients: [{ ref: 'm04', count: 2, origin: 'saitama' }, { ref: 'm01', count: 1 }] },
    { id: 'r64', name: 'うどの きんぴら', emoji: '🥢', tier: 2, type: 'kakou', pref: 'tokyo',
      ingredients: [{ ref: 'm42', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'r65', name: 'ひもの', emoji: '🐟', tier: 2, type: 'kakou', pref: 'kanagawa',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r66', name: 'ソフトクリーム', emoji: '🍦', tier: 2, type: 'kakou', pref: 'hokkaido',
      ingredients: [{ ref: 'm23', count: 2, origin: 'hokkaido' }] },
    { id: 'r67', name: 'するめ', emoji: '🦑', tier: 2, type: 'kakou', pref: 'aomori',
      ingredients: [{ ref: 'm44', count: 2, origin: 'aomori' }] },
    { id: 'r68', name: 'やまぶどうジュース', emoji: '🍷', tier: 2, type: 'kakou', pref: 'iwate',
      ingredients: [{ ref: 'm45', count: 2 }] },
    { id: 'r69', name: 'あまざけ', emoji: '🍶', tier: 2, type: 'kakou', pref: 'akita',
      ingredients: [{ ref: 'm02', count: 2, origin: 'akita' }, { ref: 'm01', count: 1 }] },
    { id: 'r70', name: 'べにばなぞめ', emoji: '🧣', tier: 2, type: 'kakou', pref: 'yamagata',
      ingredients: [{ ref: 'm40', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r71', name: 'てうちそば', emoji: '🍜', tier: 2, type: 'kakou', pref: 'fukushima',
      ingredients: [{ ref: 'm46', count: 2 }, { ref: 'm01', count: 1 }] },

    /* ===== ちゅうぶ9県(2026-07 追加) ===== */
    /* --- にいがた --- */
    { id: 'r72', name: 'こめせんべい', emoji: '🍘', tier: 2, type: 'kakou', pref: 'niigata',
      ingredients: [{ ref: 'm02', count: 2, origin: 'niigata' }] },
    { id: 'r73', name: 'しおびきざけ', emoji: '🐡', tier: 2, type: 'kakou', pref: 'niigata',
      ingredients: [{ ref: 'm47', count: 2, origin: 'niigata' }, { ref: 'm51', count: 1 }] },
    { id: 'r74', name: 'なすの つけもの', emoji: '🍆', tier: 2, type: 'kakou', pref: 'niigata',
      ingredients: [{ ref: 'm48', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r75', name: 'わっぱめし', emoji: '🍱', tier: 3, type: 'gattai', pref: 'niigata',
      ingredients: [{ ref: 'm47', count: 1 }, { ref: 'm02', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'r76', name: 'チューリップの はなたば', emoji: '💐', tier: 3, type: 'kougei', pref: 'niigata',
      ingredients: [{ ref: 'm49', count: 2, origin: 'niigata' }, { ref: 'm01', count: 1 }] },
    { id: 'rf15', name: 'にいがた まつり', emoji: '🪭', tier: 4, type: 'matsuri', pref: 'niigata',
      implemented: true, festGame: 'minyou',
      ingredients: [{ ref: 'r72', count: 1 }, { ref: 'r75', count: 1 }],
      menu: ['r72', 'r75', 'r74'] },

    /* --- とやま --- */
    { id: 'r77', name: 'しろえびせんべい', emoji: '🍘', tier: 2, type: 'kakou', pref: 'toyama',
      ingredients: [{ ref: 'm50', count: 2 }] },
    { id: 'r78', name: 'ほたるいかの おきづけ', emoji: '🦑', tier: 2, type: 'kakou', pref: 'toyama',
      ingredients: [{ ref: 'm44', count: 2, origin: 'toyama' }, { ref: 'm51', count: 1 }] },
    { id: 'r79', name: 'いろどりかまぼこ', emoji: '🍥', tier: 2, type: 'kakou', pref: 'toyama',
      ingredients: [{ ref: 'm47', count: 2, origin: 'toyama' }, { ref: 'm51', count: 1 }] },
    { id: 'r80', name: 'ますのすし', emoji: '🍣', tier: 3, type: 'gattai', pref: 'toyama',
      ingredients: [{ ref: 'm47', count: 2, origin: 'toyama' }, { ref: 'm02', count: 1 }] },
    { id: 'r81', name: 'ブランドしろえび', emoji: '👑', tier: 3, type: 'syukaku', pref: 'toyama',
      ingredients: [{ ref: 'm50', count: 1, quality: 3 }] },
    { id: 'rf16', name: 'おわら かぜの ぼん', emoji: '🎼', tier: 4, type: 'matsuri', pref: 'toyama',
      implemented: true, festGame: 'owara',
      ingredients: [{ ref: 'r80', count: 1 }, { ref: 'r77', count: 1 }],
      menu: ['r77', 'r80', 'r79'] },

    /* --- いしかわ --- */
    { id: 'r82', name: 'かがぼうちゃ', emoji: '🫖', tier: 2, type: 'kakou', pref: 'ishikawa',
      ingredients: [{ ref: 'm16', count: 2, origin: 'ishikawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r83', name: 'れんこんもち', emoji: '🍡', tier: 2, type: 'kakou', pref: 'ishikawa',
      ingredients: [{ ref: 'm52', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r84', name: 'かにの しおゆで', emoji: '🦀', tier: 2, type: 'kakou', pref: 'ishikawa',
      ingredients: [{ ref: 'm36', count: 2, origin: 'ishikawa' }, { ref: 'm51', count: 1 }] },
    { id: 'r85', name: 'くたにやき', emoji: '🏺', tier: 3, type: 'kougei', pref: 'ishikawa',
      ingredients: [{ ref: 'm07', count: 2, origin: 'ishikawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r86', name: 'はすむし', emoji: '🍲', tier: 3, type: 'gattai', pref: 'ishikawa',
      ingredients: [{ ref: 'm52', count: 1 }, { ref: 'm36', count: 1 }, { ref: 'm51', count: 1 }] },
    { id: 'rf17', name: 'かなざわ ひゃくまんごく まつり', emoji: '🏮', tier: 4, type: 'matsuri', pref: 'ishikawa',
      implemented: true, festGame: 'tourou',
      ingredients: [{ ref: 'r85', count: 1 }, { ref: 'r86', count: 1 }],
      menu: ['r82', 'r83', 'r85'] },

    /* --- ふくい --- */
    { id: 'r87', name: 'そばこ', emoji: '🌰', tier: 2, type: 'kakou', pref: 'fukui',
      ingredients: [{ ref: 'm46', count: 2, origin: 'fukui' }] },
    { id: 'r88', name: 'うめシロップ', emoji: '🧃', tier: 2, type: 'kakou', pref: 'fukui',
      ingredients: [{ ref: 'm06', count: 2, origin: 'fukui' }, { ref: 'm01', count: 1 }] },
    { id: 'r89', name: 'かにの こうらやき', emoji: '🦀', tier: 2, type: 'kakou', pref: 'fukui',
      ingredients: [{ ref: 'm36', count: 2, origin: 'fukui' }, { ref: 'm51', count: 1 }] },
    { id: 'r90', name: 'おろしそば', emoji: '🍜', tier: 3, type: 'gattai', pref: 'fukui',
      ingredients: [{ ref: 'r87', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'r91', name: 'さばえの めがね', emoji: '👓', tier: 3, type: 'kougei', pref: 'fukui',
      ingredients: [{ ref: 'm53', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf18', name: 'えちぜん がにまつり', emoji: '🦀', tier: 4, type: 'matsuri', pref: 'fukui',
      implemented: true, festGame: 'kani',
      ingredients: [{ ref: 'r89', count: 1 }, { ref: 'r90', count: 1 }],
      menu: ['r89', 'r90', 'r91'] },

    /* --- やまなし --- */
    { id: 'r92', name: 'ほしぶどう', emoji: '🍇', tier: 2, type: 'kakou', pref: 'yamanashi',
      ingredients: [{ ref: 'm54', count: 2, origin: 'yamanashi' }] },
    { id: 'r93', name: 'ももの コンポート', emoji: '🍑', tier: 2, type: 'kakou', pref: 'yamanashi',
      ingredients: [{ ref: 'm30', count: 2, origin: 'yamanashi' }, { ref: 'm01', count: 1 }] },
    { id: 'r94', name: 'かぼちゃの にもの', emoji: '🥣', tier: 2, type: 'kakou', pref: 'yamanashi',
      ingredients: [{ ref: 'm56', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r95', name: 'ほうとう', emoji: '🍲', tier: 3, type: 'gattai', pref: 'yamanashi',
      ingredients: [{ ref: 'm56', count: 1 }, { ref: 'r08', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'r96', name: 'すいしょうざいく', emoji: '💎', tier: 3, type: 'kougei', pref: 'yamanashi',
      ingredients: [{ ref: 'm55', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf19', name: 'よしだの ひまつり', emoji: '🔥', tier: 4, type: 'matsuri', pref: 'yamanashi',
      implemented: true, festGame: 'himatsuri',
      ingredients: [{ ref: 'r95', count: 1 }, { ref: 'r96', count: 1 }],
      menu: ['r92', 'r95', 'r96'] },

    /* --- ながの --- */
    { id: 'r97', name: 'ほしきのこ', emoji: '🍄', tier: 2, type: 'kakou', pref: 'nagano',
      ingredients: [{ ref: 'm57', count: 2 }] },
    { id: 'r98', name: 'ぶどうジャム', emoji: '🫙', tier: 2, type: 'kakou', pref: 'nagano',
      ingredients: [{ ref: 'm54', count: 2, origin: 'nagano' }] },
    { id: 'r99', name: 'りんごバター', emoji: '🧈', tier: 2, type: 'kakou', pref: 'nagano',
      ingredients: [{ ref: 'm20', count: 2, origin: 'nagano' }, { ref: 'r39', count: 1 }] },
    { id: 'r100', name: 'しんしゅうそば', emoji: '🍜', tier: 3, type: 'gattai', pref: 'nagano',
      ingredients: [{ ref: 'm46', count: 2, origin: 'nagano' }, { ref: 'm01', count: 1 }] },
    { id: 'r101', name: 'きのこなべ', emoji: '🍲', tier: 3, type: 'gattai', pref: 'nagano',
      ingredients: [{ ref: 'm57', count: 2 }, { ref: 'r08', count: 1 }] },
    { id: 'rf20', name: 'すわの おんばしら', emoji: '🪵', tier: 4, type: 'matsuri', pref: 'nagano',
      implemented: true, festGame: 'onbashira',
      ingredients: [{ ref: 'r100', count: 1 }, { ref: 'r101', count: 1 }],
      menu: ['r97', 'r100', 'r101'] },

    /* --- ぎふ --- */
    { id: 'r102', name: 'みのわし', emoji: '📜', tier: 2, type: 'kakou', pref: 'gifu',
      ingredients: [{ ref: 'm58', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r103', name: 'ひだの つけもの', emoji: '🥬', tier: 2, type: 'kakou', pref: 'gifu',
      ingredients: [{ ref: 'm13', count: 2, origin: 'gifu' }, { ref: 'm51', count: 1 }] },
    { id: 'r104', name: 'あゆの しおやき', emoji: '🐟', tier: 2, type: 'kakou', pref: 'gifu',
      ingredients: [{ ref: 'm59', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r105', name: 'みのやき', emoji: '🍵', tier: 3, type: 'kougei', pref: 'gifu',
      ingredients: [{ ref: 'm07', count: 2, origin: 'gifu' }, { ref: 'm01', count: 1 }] },
    { id: 'r106', name: 'あゆめし', emoji: '🍚', tier: 3, type: 'gattai', pref: 'gifu',
      ingredients: [{ ref: 'm59', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'rf21', name: 'たかやままつり', emoji: '🎎', tier: 4, type: 'matsuri', pref: 'gifu',
      implemented: true, festGame: 'karakuri',
      ingredients: [{ ref: 'r105', count: 1 }, { ref: 'r106', count: 1 }],
      menu: ['r102', 'r104', 'r105'] },

    /* --- しずおか --- */
    { id: 'r107', name: 'しずおかちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'shizuoka',
      ingredients: [{ ref: 'm16', count: 2, origin: 'shizuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r108', name: 'しらすぼし', emoji: '🐟', tier: 2, type: 'kakou', pref: 'shizuoka',
      ingredients: [{ ref: 'm60', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r109', name: 'みかんジュース', emoji: '🧃', tier: 2, type: 'kakou', pref: 'shizuoka',
      ingredients: [{ ref: 'm19', count: 2, origin: 'shizuoka' }] },
    { id: 'r110', name: 'しらすどん', emoji: '🍚', tier: 3, type: 'gattai', pref: 'shizuoka',
      ingredients: [{ ref: 'm60', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r111', name: 'さくらえびの かきあげ', emoji: '🍤', tier: 3, type: 'gattai', pref: 'shizuoka',
      ingredients: [{ ref: 'm62', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf22', name: 'はままつまつり', emoji: '🪁', tier: 4, type: 'matsuri', pref: 'shizuoka',
      implemented: true, festGame: 'tako',
      ingredients: [{ ref: 'r107', count: 1 }, { ref: 'r110', count: 1 }],
      menu: ['r107', 'r108', 'r110'] },

    /* --- あいち --- */
    { id: 'r112', name: 'はっちょうみそ', emoji: '🍲', tier: 2, type: 'kakou', pref: 'aichi',
      ingredients: [{ ref: 'm03', count: 2, origin: 'aichi' }, { ref: 'm51', count: 1 }] },
    { id: 'r113', name: 'にしおの まっちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'aichi',
      ingredients: [{ ref: 'm16', count: 2, origin: 'aichi' }] },
    { id: 'r114', name: 'ゆでうずらたまご', emoji: '🥚', tier: 2, type: 'kakou', pref: 'aichi',
      ingredients: [{ ref: 'm61', count: 2 }] },
    { id: 'r115', name: 'まっちゃアイス', emoji: '🍨', tier: 3, type: 'gattai', pref: 'aichi',
      ingredients: [{ ref: 'r113', count: 1 }, { ref: 'm23', count: 1 }] },
    { id: 'r116', name: 'たまごプリン', emoji: '🍮', tier: 3, type: 'gattai', pref: 'aichi',
      ingredients: [{ ref: 'm61', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf23', name: 'つしま てんのうさい', emoji: '🏮', tier: 4, type: 'matsuri', pref: 'aichi',
      implemented: true, festGame: 'makiwara',
      ingredients: [{ ref: 'r112', count: 1 }, { ref: 'r115', count: 1 }],
      menu: ['r112', 'r113', 'r115'] },
    /* ===== きんき7県(2026-07 追加) ===== */
    /* --- みえ --- */
    { id: 'r117', name: 'いせちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'mie',
      ingredients: [{ ref: 'm16', count: 2, origin: 'mie' }, { ref: 'm01', count: 1 }] },
    { id: 'r118', name: 'やきのり', emoji: '🟩', tier: 2, type: 'kakou', pref: 'mie',
      ingredients: [{ ref: 'm65', count: 2 }] },
    { id: 'r119', name: 'まつざかぎゅうの しぐれに', emoji: '🍲', tier: 2, type: 'kakou', pref: 'mie',
      ingredients: [{ ref: 'm66', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r120', name: 'いせえびの しおやき', emoji: '🦞', tier: 3, type: 'gattai', pref: 'mie',
      ingredients: [{ ref: 'm64', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r121', name: 'しんじゅの ネックレス', emoji: '📿', tier: 3, type: 'kougei', pref: 'mie',
      ingredients: [{ ref: 'm63', count: 2, quality: 3 }] },
    { id: 'rf24', name: 'くわなの いしどりまつり', emoji: '🔔', tier: 4, type: 'matsuri', pref: 'mie',
      implemented: true, festGame: 'ishidori',
      ingredients: [{ ref: 'r118', count: 1 }, { ref: 'r120', count: 1 }],
      menu: ['r117', 'r118', 'r120'] },

    /* --- しが --- */
    { id: 'r122', name: 'おうみまいの おにぎり', emoji: '🍙', tier: 2, type: 'kakou', pref: 'shiga',
      ingredients: [{ ref: 'm02', count: 2, origin: 'shiga' }, { ref: 'm51', count: 1 }] },
    { id: 'r123', name: 'あさみやちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'shiga',
      ingredients: [{ ref: 'm16', count: 2, origin: 'shiga' }, { ref: 'm01', count: 1 }] },
    { id: 'r124', name: 'ふなずし', emoji: '🐟', tier: 2, type: 'kakou', pref: 'shiga',
      ingredients: [{ ref: 'm67', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r125', name: 'しがらきやきの たぬき', emoji: '🏺', tier: 3, type: 'kougei', pref: 'shiga',
      ingredients: [{ ref: 'm07', count: 2, origin: 'shiga' }, { ref: 'm01', count: 1 }] },
    { id: 'r126', name: 'おうみの ちゃがゆ', emoji: '🍚', tier: 3, type: 'gattai', pref: 'shiga',
      ingredients: [{ ref: 'r123', count: 1 }, { ref: 'm02', count: 1, origin: 'shiga' }] },
    { id: 'rf25', name: 'ながはま ひきやままつり', emoji: '🎎', tier: 4, type: 'matsuri', pref: 'shiga',
      implemented: true, festGame: 'kabuki',
      ingredients: [{ ref: 'r122', count: 1 }, { ref: 'r126', count: 1 }],
      menu: ['r122', 'r124', 'r126'] },

    /* --- きょうと --- */
    { id: 'r127', name: 'うじまっちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'kyoto',
      ingredients: [{ ref: 'm16', count: 2, origin: 'kyoto' }, { ref: 'm01', count: 1 }] },
    { id: 'r128', name: 'くじょうねぎの やきねぎ', emoji: '🧅', tier: 2, type: 'kakou', pref: 'kyoto',
      ingredients: [{ ref: 'm34', count: 2, origin: 'kyoto' }, { ref: 'm51', count: 1 }] },
    { id: 'r129', name: 'たけのこの にもの', emoji: '🎍', tier: 2, type: 'kakou', pref: 'kyoto',
      ingredients: [{ ref: 'm68', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r130', name: 'まつたけごはん', emoji: '🍄', tier: 3, type: 'gattai', pref: 'kyoto',
      ingredients: [{ ref: 'm69', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r131', name: 'まっちゃの わらびもち', emoji: '🍡', tier: 3, type: 'gattai', pref: 'kyoto',
      ingredients: [{ ref: 'r127', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'rf26', name: 'ぎおんまつり', emoji: '🏮', tier: 4, type: 'matsuri', pref: 'kyoto',
      implemented: true, festGame: 'gion',
      ingredients: [{ ref: 'r127', count: 1 }, { ref: 'r130', count: 1 }],
      menu: ['r127', 'r129', 'r131'] },

    /* --- おおさか --- */
    { id: 'r132', name: 'たこやき', emoji: '🐙', tier: 2, type: 'kakou', pref: 'osaka',
      ingredients: [{ ref: 'm70', count: 2, origin: 'osaka' }, { ref: 'm01', count: 1 }] },
    { id: 'r133', name: 'みずなすの あさづけ', emoji: '🍆', tier: 2, type: 'kakou', pref: 'osaka',
      ingredients: [{ ref: 'm79', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r134', name: 'しゅんぎくの おひたし', emoji: '🌿', tier: 2, type: 'kakou', pref: 'osaka',
      ingredients: [{ ref: 'm71', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r135', name: 'せんしゅうたまねぎの スープ', emoji: '🍲', tier: 3, type: 'gattai', pref: 'osaka',
      ingredients: [{ ref: 'm72', count: 2, origin: 'osaka' }, { ref: 'm01', count: 1 }] },
    { id: 'r136', name: 'デラウェアの ゼリー', emoji: '🍇', tier: 3, type: 'gattai', pref: 'osaka',
      ingredients: [{ ref: 'm54', count: 2, origin: 'osaka' }, { ref: 'm01', count: 1 }] },
    { id: 'rf27', name: 'きしわだ だんじりまつり', emoji: '🏯', tier: 4, type: 'matsuri', pref: 'osaka',
      implemented: true, festGame: 'danjiri',
      ingredients: [{ ref: 'r132', count: 1 }, { ref: 'r135', count: 1 }],
      menu: ['r132', 'r133', 'r135'] },

    /* --- ひょうご --- */
    { id: 'r137', name: 'たんばの くろまめに', emoji: '🫘', tier: 2, type: 'kakou', pref: 'hyogo',
      ingredients: [{ ref: 'm03', count: 2, origin: 'hyogo' }, { ref: 'm51', count: 1, origin: 'hyogo' }] },
    { id: 'r138', name: 'あかしやき', emoji: '🐙', tier: 2, type: 'kakou', pref: 'hyogo',
      ingredients: [{ ref: 'm70', count: 2, origin: 'hyogo' }, { ref: 'm01', count: 1 }] },
    { id: 'r139', name: 'いかなごの くぎに', emoji: '🐟', tier: 2, type: 'kakou', pref: 'hyogo',
      ingredients: [{ ref: 'm73', count: 2 }, { ref: 'm51', count: 1, origin: 'hyogo' }] },
    { id: 'r140', name: 'あわじたまねぎの まるやき', emoji: '🧅', tier: 3, type: 'gattai', pref: 'hyogo',
      ingredients: [{ ref: 'm72', count: 2, origin: 'hyogo' }, { ref: 'm51', count: 1, origin: 'hyogo' }] },
    { id: 'r141', name: 'たこめし', emoji: '🍚', tier: 3, type: 'gattai', pref: 'hyogo',
      ingredients: [{ ref: 'm70', count: 2, origin: 'hyogo' }, { ref: 'm02', count: 1 }] },
    { id: 'rf28', name: 'にしのみやの とおかえびす', emoji: '🎍', tier: 4, type: 'matsuri', pref: 'hyogo',
      implemented: true, festGame: 'fukuotoko',
      ingredients: [{ ref: 'r137', count: 1 }, { ref: 'r141', count: 1 }],
      menu: ['r137', 'r139', 'r141'] },

    /* --- なら --- */
    { id: 'r142', name: 'やまとちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'nara',
      ingredients: [{ ref: 'm16', count: 2, origin: 'nara' }, { ref: 'm01', count: 1 }] },
    { id: 'r143', name: 'あすかルビーの ジャム', emoji: '🍓', tier: 2, type: 'kakou', pref: 'nara',
      ingredients: [{ ref: 'm11', count: 2, origin: 'nara' }, { ref: 'm01', count: 1 }] },
    { id: 'r144', name: 'ほしがき', emoji: '🟠', tier: 2, type: 'kakou', pref: 'nara',
      ingredients: [{ ref: 'm74', count: 2 }] },
    { id: 'r145', name: 'あゆの しおやき', emoji: '🐟', tier: 3, type: 'gattai', pref: 'nara',
      ingredients: [{ ref: 'm59', count: 2, origin: 'nara' }, { ref: 'm51', count: 1 }] },
    { id: 'r146', name: 'よしのすぎの わりばし', emoji: '🥢', tier: 3, type: 'kougei', pref: 'nara',
      ingredients: [{ ref: 'm75', count: 2 }] },
    { id: 'rf29', name: 'わかくさやまの やまやき', emoji: '🔥', tier: 4, type: 'matsuri', pref: 'nara',
      implemented: true, festGame: 'yamayaki',
      ingredients: [{ ref: 'r142', count: 1 }, { ref: 'r145', count: 1 }],
      menu: ['r142', 'r144', 'r145'] },

    /* --- わかやま --- */
    { id: 'r147', name: 'なんこううめの うめぼし', emoji: '🫒', tier: 2, type: 'kakou', pref: 'wakayama',
      ingredients: [{ ref: 'm06', count: 2, origin: 'wakayama' }, { ref: 'm51', count: 1 }] },
    { id: 'r148', name: 'ありたみかんの ジュース', emoji: '🧃', tier: 2, type: 'kakou', pref: 'wakayama',
      ingredients: [{ ref: 'm19', count: 2, origin: 'wakayama' }] },
    { id: 'r149', name: 'さんしょうの つくだに', emoji: '🌶️', tier: 2, type: 'kakou', pref: 'wakayama',
      ingredients: [{ ref: 'm76', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r150', name: 'まぐろの づけどん', emoji: '🍣', tier: 3, type: 'gattai', pref: 'wakayama',
      ingredients: [{ ref: 'm77', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r151', name: 'すみびやきの まぐろ', emoji: '🔥', tier: 3, type: 'gattai', pref: 'wakayama',
      ingredients: [{ ref: 'm77', count: 1 }, { ref: 'm78', count: 2 }] },
    { id: 'rf30', name: 'なちの おうぎまつり', emoji: '🪭', tier: 4, type: 'matsuri', pref: 'wakayama',
      implemented: true, festGame: 'ougi',
      ingredients: [{ ref: 'r147', count: 1 }, { ref: 'r150', count: 1 }],
      menu: ['r147', 'r148', 'r150'] },
    /* ===== ちゅうごく5県・しこく4県(2026-07 追加) ===== */
    /* --- とっとり --- */
    { id: 'r152', name: 'にじゅっせいきなしの ゼリー', emoji: '🍐', tier: 2, type: 'kakou', pref: 'tottori',
      ingredients: [{ ref: 'm10', count: 2, origin: 'tottori' }, { ref: 'm01', count: 1 }] },
    { id: 'r153', name: 'らっきょうづけ', emoji: '🧄', tier: 2, type: 'kakou', pref: 'tottori',
      ingredients: [{ ref: 'm80', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r154', name: 'しろねぎの やきねぎ', emoji: '🧅', tier: 2, type: 'kakou', pref: 'tottori',
      ingredients: [{ ref: 'm34', count: 2, origin: 'tottori' }, { ref: 'm51', count: 1 }] },
    { id: 'r155', name: 'まつばがにの しおゆで', emoji: '🦀', tier: 3, type: 'gattai', pref: 'tottori',
      ingredients: [{ ref: 'm36', count: 2, origin: 'tottori' }, { ref: 'm51', count: 1 }] },
    { id: 'r156', name: 'かにめし', emoji: '🍚', tier: 3, type: 'gattai', pref: 'tottori',
      ingredients: [{ ref: 'm36', count: 2, origin: 'tottori' }, { ref: 'm02', count: 1 }] },
    { id: 'rf31', name: 'とっとり しゃんしゃんまつり', emoji: '🌂', tier: 4, type: 'matsuri', pref: 'tottori',
      implemented: true, festGame: 'shanshan',
      ingredients: [{ ref: 'r153', count: 1 }, { ref: 'r155', count: 1 }],
      menu: ['r152', 'r153', 'r155'] },

    /* --- しまね --- */
    { id: 'r157', name: 'しじみの みそしる', emoji: '🐚', tier: 2, type: 'kakou', pref: 'shimane',
      ingredients: [{ ref: 'm81', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r158', name: 'いずもそば', emoji: '🍜', tier: 2, type: 'kakou', pref: 'shimane',
      ingredients: [{ ref: 'm46', count: 2, origin: 'shimane' }, { ref: 'm01', count: 1 }] },
    { id: 'r159', name: 'のどぐろの しおやき', emoji: '🐠', tier: 2, type: 'kakou', pref: 'shimane',
      ingredients: [{ ref: 'm82', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r160', name: 'たたらの ほうちょう', emoji: '🔪', tier: 3, type: 'kougei', pref: 'shimane',
      ingredients: [{ ref: 'm24', count: 2, origin: 'shimane' }] },
    { id: 'r161', name: 'デラウェアの ジュース', emoji: '🧃', tier: 3, type: 'gattai', pref: 'shimane',
      ingredients: [{ ref: 'm54', count: 2, origin: 'shimane' }, { ref: 'm01', count: 1 }] },
    { id: 'rf32', name: 'いわみかぐら', emoji: '🐉', tier: 4, type: 'matsuri', pref: 'shimane',
      implemented: true, festGame: 'kagura',
      ingredients: [{ ref: 'r157', count: 1 }, { ref: 'r158', count: 1 }],
      menu: ['r157', 'r158', 'r159'] },

    /* --- おかやま --- */
    { id: 'r162', name: 'マスカットの ゼリー', emoji: '🍇', tier: 2, type: 'kakou', pref: 'okayama',
      ingredients: [{ ref: 'm54', count: 2, origin: 'okayama' }, { ref: 'm01', count: 1 }] },
    { id: 'r163', name: 'はくとうの コンポート', emoji: '🍑', tier: 2, type: 'kakou', pref: 'okayama',
      ingredients: [{ ref: 'm30', count: 2, origin: 'okayama' }, { ref: 'm01', count: 1 }] },
    { id: 'r164', name: 'ままかりずし', emoji: '🍣', tier: 2, type: 'kakou', pref: 'okayama',
      ingredients: [{ ref: 'm83', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r165', name: 'きにらの スープ', emoji: '🍲', tier: 3, type: 'gattai', pref: 'okayama',
      ingredients: [{ ref: 'm84', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r166', name: 'びぜんやきの つぼ', emoji: '🏺', tier: 3, type: 'kougei', pref: 'okayama',
      ingredients: [{ ref: 'm07', count: 2, origin: 'okayama' }] },
    { id: 'rf33', name: 'さいだいじ えよう', emoji: '🪵', tier: 4, type: 'matsuri', pref: 'okayama',
      implemented: true, festGame: 'eyou',
      ingredients: [{ ref: 'r164', count: 1 }, { ref: 'r165', count: 1 }],
      menu: ['r162', 'r164', 'r166'] },

    /* --- ひろしま --- */
    { id: 'r167', name: 'かきの どてなべ', emoji: '🦪', tier: 2, type: 'kakou', pref: 'hiroshima',
      ingredients: [{ ref: 'm26', count: 2, origin: 'hiroshima' }, { ref: 'm51', count: 1 }] },
    { id: 'r168', name: 'レモンの はちみつづけ', emoji: '🍋', tier: 2, type: 'kakou', pref: 'hiroshima',
      ingredients: [{ ref: 'm85', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r169', name: 'ひろしまなの つけもの', emoji: '🥬', tier: 2, type: 'kakou', pref: 'hiroshima',
      ingredients: [{ ref: 'm86', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r170', name: 'あなごめし', emoji: '🍚', tier: 3, type: 'gattai', pref: 'hiroshima',
      ingredients: [{ ref: 'm87', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r171', name: 'わけぎの ぬた', emoji: '🌱', tier: 3, type: 'gattai', pref: 'hiroshima',
      ingredients: [{ ref: 'm88', count: 2 }, { ref: 'm03', count: 1 }] },
    { id: 'rf34', name: 'おのみち べっちゃーまつり', emoji: '👹', tier: 4, type: 'matsuri', pref: 'hiroshima',
      implemented: true, festGame: 'betcha',
      ingredients: [{ ref: 'r167', count: 1 }, { ref: 'r170', count: 1 }],
      menu: ['r167', 'r168', 'r170'] },

    /* --- やまぐち --- */
    { id: 'r172', name: 'ふぐの さしみ', emoji: '🐡', tier: 2, type: 'kakou', pref: 'yamaguchi',
      ingredients: [{ ref: 'm89', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r173', name: 'なつみかんの ママレード', emoji: '🍊', tier: 2, type: 'kakou', pref: 'yamaguchi',
      ingredients: [{ ref: 'm19', count: 2, origin: 'yamaguchi' }, { ref: 'm01', count: 1 }] },
    { id: 'r174', name: 'いわくにれんこんの きんぴら', emoji: '🪷', tier: 2, type: 'kakou', pref: 'yamaguchi',
      ingredients: [{ ref: 'm104', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r175', name: 'はなっこりーの おひたし', emoji: '🥦', tier: 3, type: 'gattai', pref: 'yamaguchi',
      ingredients: [{ ref: 'm90', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r176', name: 'けんさきいかの いかそうめん', emoji: '🦑', tier: 3, type: 'gattai', pref: 'yamaguchi',
      ingredients: [{ ref: 'm44', count: 2, origin: 'yamaguchi' }, { ref: 'm51', count: 1 }] },
    { id: 'rf35', name: 'やない きんぎょちょうちんまつり', emoji: '🐟', tier: 4, type: 'matsuri', pref: 'yamaguchi',
      implemented: true, festGame: 'kingyo',
      ingredients: [{ ref: 'r172', count: 1 }, { ref: 'r176', count: 1 }],
      menu: ['r172', 'r173', 'r176'] },

    /* --- とくしま --- */
    { id: 'r177', name: 'すだちの しぼり', emoji: '🟢', tier: 2, type: 'kakou', pref: 'tokushima',
      ingredients: [{ ref: 'm91', count: 2 }] },
    { id: 'r178', name: 'なるときんときの やきいも', emoji: '🍠', tier: 2, type: 'kakou', pref: 'tokushima',
      ingredients: [{ ref: 'm04', count: 2, origin: 'tokushima' }] },
    { id: 'r179', name: 'なるとわかめの すのもの', emoji: '☘️', tier: 2, type: 'kakou', pref: 'tokushima',
      ingredients: [{ ref: 'm38', count: 2, origin: 'tokushima' }, { ref: 'm51', count: 1 }] },
    { id: 'r180', name: 'あわあいぞめの ハンカチ', emoji: '🟦', tier: 3, type: 'kougei', pref: 'tokushima',
      ingredients: [{ ref: 'm92', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r181', name: 'なるとだいの しおやき', emoji: '🐠', tier: 3, type: 'gattai', pref: 'tokushima',
      ingredients: [{ ref: 'm93', count: 2, origin: 'tokushima' }, { ref: 'm51', count: 1 }] },
    { id: 'rf36', name: 'あわおどり', emoji: '👘', tier: 4, type: 'matsuri', pref: 'tokushima',
      implemented: true, festGame: 'awaodori',
      ingredients: [{ ref: 'r178', count: 1 }, { ref: 'r181', count: 1 }],
      menu: ['r177', 'r178', 'r181'] },

    /* --- かがわ --- */
    { id: 'r182', name: 'さぬきうどん', emoji: '🍜', tier: 2, type: 'kakou', pref: 'kagawa',
      ingredients: [{ ref: 'm94', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r183', name: 'オリーブの つけもの', emoji: '🫒', tier: 2, type: 'kakou', pref: 'kagawa',
      ingredients: [{ ref: 'm95', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r184', name: 'いりこだし', emoji: '🐟', tier: 2, type: 'kakou', pref: 'kagawa',
      ingredients: [{ ref: 'm09', count: 2, origin: 'kagawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r185', name: 'きんときにんじんの にもの', emoji: '🥕', tier: 3, type: 'gattai', pref: 'kagawa',
      ingredients: [{ ref: 'm96', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r186', name: 'さぬきの てぶくろ', emoji: '🧤', tier: 3, type: 'kougei', pref: 'kagawa',
      ingredients: [{ ref: 'm97', count: 2, origin: 'kagawa' }] },
    { id: 'rf37', name: 'さぬき ちょうさまつり', emoji: '🥁', tier: 4, type: 'matsuri', pref: 'kagawa',
      implemented: true, festGame: 'chousa',
      ingredients: [{ ref: 'r182', count: 1 }, { ref: 'r185', count: 1 }],
      menu: ['r182', 'r183', 'r185'] },

    /* --- えひめ --- */
    { id: 'r187', name: 'いよかんジュース', emoji: '🧃', tier: 2, type: 'kakou', pref: 'ehime',
      ingredients: [{ ref: 'm19', count: 2, origin: 'ehime' }] },
    { id: 'r188', name: 'まだいの かぶとに', emoji: '🐠', tier: 2, type: 'kakou', pref: 'ehime',
      ingredients: [{ ref: 'm93', count: 2, origin: 'ehime' }, { ref: 'm51', count: 1 }] },
    { id: 'r189', name: 'キウイの ジャム', emoji: '🥝', tier: 2, type: 'kakou', pref: 'ehime',
      ingredients: [{ ref: 'm98', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r190', name: 'いまばりの タオル', emoji: '🛁', tier: 3, type: 'kougei', pref: 'ehime',
      ingredients: [{ ref: 'm97', count: 2, origin: 'ehime' }, { ref: 'm01', count: 1 }] },
    { id: 'r191', name: 'はだかむぎの むぎみそ', emoji: '🍲', tier: 3, type: 'gattai', pref: 'ehime',
      ingredients: [{ ref: 'm99', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'rf38', name: 'うわじま うしおにまつり', emoji: '🐮', tier: 4, type: 'matsuri', pref: 'ehime',
      implemented: true, festGame: 'ushioni',
      ingredients: [{ ref: 'r187', count: 1 }, { ref: 'r188', count: 1 }],
      menu: ['r187', 'r188', 'r190'] },

    /* --- こうち --- */
    { id: 'r192', name: 'ゆずポン', emoji: '🍋', tier: 2, type: 'kakou', pref: 'kochi',
      ingredients: [{ ref: 'm100', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r193', name: 'かつおの たたき', emoji: '🐟', tier: 2, type: 'kakou', pref: 'kochi',
      ingredients: [{ ref: 'm101', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r194', name: 'しょうがの あめに', emoji: '🫚', tier: 2, type: 'kakou', pref: 'kochi',
      ingredients: [{ ref: 'm102', count: 2 }, { ref: 'm01', count: 1, origin: 'kochi' }] },
    { id: 'r195', name: 'ししとうの やきびたし', emoji: '🫑', tier: 3, type: 'gattai', pref: 'kochi',
      ingredients: [{ ref: 'm103', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r196', name: 'かつおめし', emoji: '🍚', tier: 3, type: 'gattai', pref: 'kochi',
      ingredients: [{ ref: 'm101', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'rf39', name: 'よさこいまつり', emoji: '🪇', tier: 4, type: 'matsuri', pref: 'kochi',
  ...
  trivia: [
    ...
    { target: 'm48', text: 'にいがたけんは なすの さくづけめんせきが にほんいち! つけものに すると おいしいよ。', check: '統計裏取り' },
    { target: 'm49', text: 'にいがたと とやまは チューリップの きゅうこんの さんち。はるは はなが いちめんに さくよ。', check: '統計裏取り' },
    ...
    { target: 'm54', text: 'やまなしけんと ながのけんは ぶどうの めいさんち。あまい きょほうや シャインマスカットが とれるよ。', check: '統計裏取り' },
    { target: 'm55', text: 'こうしゅう(やまなし)の すいしょうざいくは、いしを みがいて つくる でんとうこうげいだよ。' },
    { target: 'm56', text: 'やまなしの ほうとうには、あまい かぼちゃが かかせないよ。' },
    { target: 'm57', text: 'ながのけんは きのこづくりが にほんいち! えのきたけや しめじが たくさん とれるよ。', check: '統計裏取り' },
    ...
    { target: 'm61', text: 'あいちけんは うずらの たまごが にほんいち! にわとりの たまごより ずっと ちいさいよ。', check: '統計裏取り' },
    ...
    { target: 'r76', text: 'にいがたは チューリップの きりばなの しゅっかも おおい。はなたばに すると はなやかだね!', check: '統計裏取り' },
    ...
    { target: 'r81', text: 'とくべつに おおきくて すきとおった ★3の しろえびだけが ブランドに えらばれるよ。' },
    ...
    { target: 'r91', text: 'にほんの めがねフレームの ほとんどは、ふくいの さばえで つくられているよ。', check: '統計裏取り' },
    ...
    { target: 'r102', text: 'みのわしは 1300ねん いじょうの れきしが あると いわれる ぎふの かみ。とても じょうぶだよ。', check: '歴史年数裏取り' },
    { target: 'r103', text: 'ひだの つけものは、こうげんで そだった やさいを しおで つけた ぎふの あじだよ。' },
    { target: 'r104', text: 'とれたての あゆに しおを ふって やくと、かわが ぱりっと して おいしいよ。' },
    { target: 'r105', text: 'みのやきは にほんの しょっきの おおくを つくっている ぎふの やきものだよ。', check: '統計裏取り' },
    ...
    { target: 'm62', text: 'さくらえびは うすピンクの ちいさな えび。にほんでは するがわんだけで とれるんだ。', check: '唯一表現裏取り' },
    ...
    { target: 'rf19', text: 'よしだの ひまつりは、おおきな たいまつに ひを つけて まちを あかるく てらす やまなしの おまつり。にほんの きさいの ひとつと いわれるよ。', check: '三奇祭表現裏取り' },
  ...
  quizzes: [
    ...
    { id: 'qz07', kind: 'sozai', tags: ['m40'], q: 'べにばなの はなの いろは どう かわる?', choices: ['きいろ → あか', 'あお → しろ', 'みどりの まま'], answer: 0 },
    ...
    { id: 'qn05', kind: 'kaitaku', type: 'shape', tags: ['kyoto'], q: 'この かたちの けんは どこ?', choices: ['きょうと', 'ひょうご', 'おおさか'], answer: 0 },
    { id: 'qn06', kind: 'kaitaku', type: 'position', tags: ['kyoto'], q: 'ひかっている けんは どこ?', choices: ['きょうと', 'しが', 'なら'], answer: 0 },
    { id: 'qn07', kind: 'kaitaku', type: 'shape', tags: ['osaka'], q: 'この かたちの けんは どこ?', choices: ['おおさか', 'なら', 'ひょうご'], answer: 0 },
    { id: 'qn08', kind: 'kaitaku', type: 'position', tags: ['osaka'], q: 'ひかっている けんは どこ?', choices: ['おおさか', 'きょうと', 'わかやま'], answer: 0 },
