...
export const GAME_DATA: GameData = {
  ...
  regions: [
    ...
    { id: 'kyushu', name: 'きゅうしゅう・おきなわ', kanji: '九州・沖縄', emoji: '🌺', active: true, color: '#FFCC80', mapFile: 'map-kyushu.json', unlockFests: 18 },
  ],
  ...
  /* ---------- そざいマスタ(Tier1) ---------- */
  materials: [
    { id: 'm01', name: 'みず', emoji: '💧', origins: ['ibaraki', 'akita', 'yamanashi', 'shiga', 'tottori', 'kochi', 'oita'], rarity: 'common',
      gather: { type: 'infra', building: 'いど', bEmoji: '⛲', rateSec: 120, max: 3, collectVerb: 'くみあげる' } },
    { id: 'm02', name: 'こめ', emoji: '🌾', origins: ['chiba', 'akita', 'miyagi', 'fukushima', 'niigata', 'toyama', 'fukui', 'gifu', 'shiga', 'saga', 'kumamoto'], rarity: 'common',
    ...
    { id: 'm04', name: 'さつまいも', emoji: '🍠', origins: ['ibaraki', 'chiba', 'saitama', 'tokushima', 'kagoshima'], rarity: 'local',
    ...
    { id: 'm07', name: 'ねんど', emoji: '🟤', origins: ['ibaraki', 'tochigi', 'ishikawa', 'gifu', 'shiga', 'okayama', 'saga'], rarity: 'local',
    ...
    { id: 'm11', name: 'いちご', emoji: '🍓', origins: ['tochigi', 'miyagi', 'nara', 'fukuoka', 'saga'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300,
    ...
    /* --- さいたま --- */
    { id: 'm16', name: 'ちゃば', emoji: '🍃', origins: ['saitama', 'kanagawa', 'ishikawa', 'shizuoka', 'aichi', 'mie', 'shiga', 'kyoto', 'nara', 'fukuoka', 'nagasaki', 'miyazaki', 'kagoshima'], rarity: 'local',
    ...
    /* --- いわて --- */
    { id: 'm23', name: 'ぎゅうにゅう', emoji: '🥛', origins: ['iwate', 'hokkaido', 'kumamoto'], rarity: 'local',
    ...
    { id: 'm34', name: 'ねぎ', emoji: '🧅', origins: ['saitama', 'gunma', 'akita', 'kyoto', 'tottori', 'oita'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
    ...
    { id: 'm32', name: 'とうもろこし', emoji: '🌽', origins: ['hokkaido'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420,
        ...
        care: { target: '🐦', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    { id: 'm33', name: 'じゃがいも', emoji: '🥔', origins: ['hokkaido', 'nagasaki'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねいもを うえる', growSec: 420,
    ...
    { id: 'm65', name: 'のり', emoji: '🟩', origins: ['mie', 'fukuoka', 'saga'], rarity: 'local',
    ...
    { id: 'm68', name: 'たけのこ', emoji: '🎍', origins: ['kyoto', 'fukuoka'], rarity: 'unique',
    ...
    { id: 'm88', name: 'わけぎ', emoji: '🌱', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'きゅうこんを うえる', growSec: 300, fieldLabel: 'わけぎばたけ',
        ...
        care: { target: '🐦', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm89', name: 'ふぐ', emoji: '🐡', origins: ['yamaguchi', 'nagasaki'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
    ...
    { id: 'm100', name: 'ゆず', emoji: '🍋', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'ゆずばたけ',
        ...
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm101', name: 'かつお', emoji: '🐟', origins: ['kochi', 'miyazaki'], rarity: 'unique',
    ...
    { id: 'm105', name: 'かつおな', emoji: '🥬', origins: ['fukuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'はかたの はたけ',
        harvest: { engine: 'reap', target: '🥬', prompt: 'よこに なぞって かつおなを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm106', name: 'むつごろう', emoji: '🐟', origins: ['saga'], rarity: 'unique',
      gather: { type: 'timing', verb: 'ひがたに でる',
        theme: { intro: 'ありあけの ひがたに むつごろうが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'さおを あげる!', marker: '🐟', success: 'たいりょうだ!', stages: ['🛶', '🌊', '🐟'] } } },
    { id: 'm107', name: 'びわ', emoji: '🟠', origins: ['nagasaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'びわばたけ',
        harvest: { engine: 'catch', target: '🟠', prompt: 'おちてくる びわを かごで うけとめよう! きんの びわは とくてん おおい!' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm108', name: 'あじ', emoji: '🐟', origins: ['nagasaki', 'oita'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'はやい しおの ところに あじの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'] } } },
    { id: 'm109', name: 'いぐさ', emoji: '🎋', origins: ['kumamoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 480, fieldLabel: 'いぐさだ',
        harvest: { engine: 'reap', target: '🎋', prompt: 'よこに なぞって いぐさを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', label: 'みずが へってる! タップで みずを 入れよう!' } } },
    { id: 'm110', name: 'デコポン', emoji: '🍊', origins: ['kumamoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'デコポンばたけ',
        harvest: { engine: 'catch', target: '🍊', prompt: 'おちてくる デコポンを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm111', name: 'くり', emoji: '🌰', origins: ['kumamoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'くりばたけ',
        harvest: { engine: 'chain', target: '🌰', prompt: 'いがが ひらいた くりだけ ひろおう! まだ とじているのは はやいよ' },
        care: { target: '🐗', label: 'いのししが くりを たべにきた! タップで おいはらえ!' } } },
    { id: 'm112', name: 'かぼす', emoji: '🟢', origins: ['oita'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 480, fieldLabel: 'かぼすばたけ',
        harvest: { engine: 'catch', target: '🟢', prompt: 'おちてくる かぼすを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm113', name: 'しいたけ', emoji: '🍄', origins: ['oita'], rarity: 'unique',
      gather: { type: 'plant', verb: 'ほだぎを ならべる', growSec: 480, fieldLabel: 'ほだばの もり',
        harvest: { engine: 'pluck', target: '🍄', prompt: 'かさが ひらいた しいたけを おさえて、ゆーっくり もぎとろう!' },
        care: { target: '🌀', label: 'ほだぎが かわいてる! タップで みずを かけよう!' } } },
    { id: 'm114', name: 'マンゴー', emoji: '🥭', origins: ['miyazaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 600, fieldLabel: 'ハウスの きばたけ',
        harvest: { engine: 'catch', target: '🥭', prompt: 'じゅくして おちる マンゴーを ネットで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm115', name: 'きゅうり', emoji: '🥒', origins: ['miyazaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 300, fieldLabel: 'きゅうりの ハウス',
        harvest: { engine: 'pluck', target: '🥒', prompt: 'ちょうど よい ながさの きゅうりを おさえて、ゆーっくり もぎとろう!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm116', name: 'ピーマン', emoji: '🫑', origins: ['miyazaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'ピーマンの ハウス',
        harvest: { engine: 'chain', target: '🫑', prompt: 'つやつやの みどりの ピーマンだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが みを たべてる! タップで とろう!' } } },
    { id: 'm117', name: 'うなぎ', emoji: '🐟', origins: ['kagoshima'], rarity: 'unique',
      gather: { type: 'timing', verb: 'いけすに いく',
        theme: { intro: 'あたたかい みずの いけすで うなぎが そだった!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', success: 'たいりょうだ!', stages: ['🪣', '🌊', '🐟'] } } },
    { id: 'm118', name: 'そらまめ', emoji: '🫛', origins: ['kagoshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'そらまめばたけ',
        harvest: { engine: 'chain', target: '🫛', prompt: 'そらを むいた さやが ふくらんだら つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', label: 'むしが さやを たべてる! タップで とろう!' } } },
    { id: 'm119', name: 'きんかん', emoji: '🟠', origins: ['kagoshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 480, fieldLabel: 'きんかんばたけ',
        harvest: { engine: 'catch', target: '🟠', prompt: 'おちてくる きんかんを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm120', name: 'さとうきび', emoji: '🎍', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 600, fieldLabel: 'さとうきびばたけ',
        harvest: { engine: 'reap', target: '🎍', prompt: 'よこに なぞって さとうきびを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', label: 'たいふうが きそう! タップで ささえよう!' } } },
    { id: 'm121', name: 'ゴーヤー', emoji: '🥒', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'ゴーヤーの たな',
        harvest: { engine: 'chain', target: '🥒', prompt: 'こい みどりで ぶつぶつが そろった ゴーヤーだけ つもう!' },
        care: { target: '🐛', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm122', name: 'パイナップル', emoji: '🍍', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 600, fieldLabel: 'パインばたけ',
        harvest: { engine: 'catch', target: '🍍', prompt: 'かりとった パイナップルを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐦', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm123', name: 'もずく', emoji: '☘️', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを はる', growSec: 420, fieldLabel: 'もずくの あみば',
        harvest: { engine: 'reap', target: '☘️', prompt: 'よこに なぞって もずくを つみとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', label: 'なみが たかい! タップで あみを なおそう!' } } },
    { id: 'm124', name: 'べにいも', emoji: '🟣', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 480, fieldLabel: 'べにいもばたけ',
        ...
        care: { target: '🐗', label: 'いのししが はたけを あらしてる! タップで おいはらえ!' } } },
  ],
  ...
  recipes: [
    ...
    /* --- ふくおか --- */
    { id: 'r197', name: 'あまおうの ジャム', emoji: '🍓', tier: 2, type: 'kakou', pref: 'fukuoka',
      ingredients: [{ ref: 'm11', count: 2, origin: 'fukuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r198', name: 'やめちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'fukuoka',
      ingredients: [{ ref: 'm16', count: 2, origin: 'fukuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r199', name: 'ありあけの やきのり', emoji: '🟩', tier: 2, type: 'kakou', pref: 'fukuoka',
      ingredients: [{ ref: 'm65', count: 2, origin: 'fukuoka' }] },
    { id: 'r200', name: 'たけのこの わかたけに', emoji: '🎍', tier: 3, type: 'gattai', pref: 'fukuoka',
      ingredients: [{ ref: 'm68', count: 2, origin: 'fukuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r201', name: 'かつおなの ぞうに', emoji: '🍲', tier: 3, type: 'gattai', pref: 'fukuoka',
      ingredients: [{ ref: 'm105', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'rf40', name: 'はかた ぎおん やまかさ', emoji: '🏮', tier: 4, type: 'matsuri', pref: 'fukuoka',
      implemented: true, festGame: 'yamakasa',
      ingredients: [{ ref: 'r199', count: 1 }, { ref: 'r200', count: 1 }],
      menu: ['r197', 'r198', 'r200'] },

    /* --- さが --- */
    { id: 'r202', name: 'のりの つくだに', emoji: '🟩', tier: 2, type: 'kakou', pref: 'saga',
      ingredients: [{ ref: 'm65', count: 2, origin: 'saga' }, { ref: 'm51', count: 1 }] },
    { id: 'r203', name: 'さがびよりの おにぎり', emoji: '🍙', tier: 2, type: 'kakou', pref: 'saga',
      ingredients: [{ ref: 'm02', count: 2, origin: 'saga' }, { ref: 'm51', count: 1 }] },
    { id: 'r204', name: 'いちごさんの タルト', emoji: '🍓', tier: 2, type: 'kakou', pref: 'saga',
      ingredients: [{ ref: 'm11', count: 2, origin: 'saga' }, { ref: 'm01', count: 1 }] },
    { id: 'r205', name: 'ありたやきの おさら', emoji: '🏺', tier: 3, type: 'kougei', pref: 'saga',
      ingredients: [{ ref: 'm07', count: 2, origin: 'saga' }] },
    { id: 'r206', name: 'むつごろうの かばやき', emoji: '🐟', tier: 3, type: 'gattai', pref: 'saga',
      ingredients: [{ ref: 'm106', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'rf41', name: 'さが バルーンフェスタ', emoji: '🎈', tier: 4, type: 'matsuri', pref: 'saga',
      implemented: true, festGame: 'balloon',
      ingredients: [{ ref: 'r203', count: 1 }, { ref: 'r206', count: 1 }],
      menu: ['r202', 'r203', 'r206'] },

    /* --- ながさき --- */
    { id: 'r207', name: 'びわの ゼリー', emoji: '🟠', tier: 2, type: 'kakou', pref: 'nagasaki',
      ingredients: [{ ref: 'm107', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r208', name: 'あじの ひらき', emoji: '🐟', tier: 2, type: 'kakou', pref: 'nagasaki',
      ingredients: [{ ref: 'm108', count: 2, origin: 'nagasaki' }, { ref: 'm51', count: 1 }] },
    { id: 'r209', name: 'そのぎちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'nagasaki',
      ingredients: [{ ref: 'm16', count: 2, origin: 'nagasaki' }, { ref: 'm01', count: 1 }] },
    { id: 'r210', name: 'ちゃんぽん', emoji: '🍜', tier: 3, type: 'gattai', pref: 'nagasaki',
      ingredients: [{ ref: 'm94', count: 2 }, { ref: 'm108', count: 1, origin: 'nagasaki' }] },
    { id: 'r211', name: 'とらふぐの てっさ', emoji: '🐡', tier: 3, type: 'gattai', pref: 'nagasaki',
      ingredients: [{ ref: 'm89', count: 2, origin: 'nagasaki' }, { ref: 'm51', count: 1 }] },
    { id: 'rf42', name: 'ながさきくんち', emoji: '🐲', tier: 4, type: 'matsuri', pref: 'nagasaki',
      implemented: true, festGame: 'kokkodesho',
      ingredients: [{ ref: 'r208', count: 1 }, { ref: 'r210', count: 1 }],
      menu: ['r207', 'r209', 'r210'] },

    /* --- くまもと --- */
    { id: 'r212', name: 'いぐさの コースター', emoji: '🎋', tier: 2, type: 'kougei', pref: 'kumamoto',
      ingredients: [{ ref: 'm109', count: 2 }] },
    { id: 'r213', name: 'デコポンの ジュース', emoji: '🍊', tier: 2, type: 'kakou', pref: 'kumamoto',
      ingredients: [{ ref: 'm110', count: 2 }] },
    { id: 'r214', name: 'くまもとの こめせんべい', emoji: '🍘', tier: 2, type: 'kakou', pref: 'kumamoto',
      ingredients: [{ ref: 'm02', count: 2, origin: 'kumamoto' }, { ref: 'm51', count: 1 }] },
    { id: 'r215', name: 'くりの きんとん', emoji: '🌰', tier: 3, type: 'gattai', pref: 'kumamoto',
      ingredients: [{ ref: 'm111', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r216', name: 'らくのうの ミルクプリン', emoji: '🍮', tier: 3, type: 'gattai', pref: 'kumamoto',
      ingredients: [{ ref: 'm23', count: 2, origin: 'kumamoto' }, { ref: 'm01', count: 1 }] },
    { id: 'rf43', name: 'ふじさきはちまんぐうの ぼした祭り', emoji: '🐴', tier: 4, type: 'matsuri', pref: 'kumamoto',
      implemented: true, festGame: 'kazariuma',
      ingredients: [{ ref: 'r213', count: 1 }, { ref: 'r216', count: 1 }],
      menu: ['r212', 'r213', 'r216'] },

    /* --- おおいた --- */
    { id: 'r217', name: 'かぼすの ぽんず', emoji: '🟢', tier: 2, type: 'kakou', pref: 'oita',
      ingredients: [{ ref: 'm112', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r218', name: 'ほししいたけ', emoji: '🍄', tier: 2, type: 'kakou', pref: 'oita',
      ingredients: [{ ref: 'm113', count: 2 }] },
    { id: 'r219', name: 'せきあじの さしみ', emoji: '🐟', tier: 2, type: 'kakou', pref: 'oita',
      ingredients: [{ ref: 'm108', count: 2, origin: 'oita' }, { ref: 'm51', count: 1 }] },
    { id: 'r220', name: 'おんせんたまご', emoji: '🥚', tier: 3, type: 'gattai', pref: 'oita',
      ingredients: [{ ref: 'm61', count: 2 }, { ref: 'm01', count: 1, origin: 'oita' }] },
    { id: 'r221', name: 'しいたけの にもの', emoji: '🍲', tier: 3, type: 'gattai', pref: 'oita',
      ingredients: [{ ref: 'm113', count: 2 }, { ref: 'm34', count: 1, origin: 'oita' }] },
    { id: 'rf44', name: 'べっぷ おんせんまつり', emoji: '♨️', tier: 4, type: 'matsuri', pref: 'oita',
      implemented: true, festGame: 'yukake',
      ingredients: [{ ref: 'r218', count: 1 }, { ref: 'r220', count: 1 }],
      menu: ['r217', 'r218', 'r220'] },

    /* --- みやざき --- */
    { id: 'r222', name: 'たいようのタマゴ', emoji: '🥭', tier: 2, type: 'kakou', pref: 'miyazaki',
      ingredients: [{ ref: 'm114', count: 2 }] },
    { id: 'r223', name: 'みやざきの ちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'miyazaki',
      ingredients: [{ ref: 'm16', count: 2, origin: 'miyazaki' }, { ref: 'm01', count: 1 }] },
    { id: 'r224', name: 'きゅうりの あさづけ', emoji: '🥒', tier: 2, type: 'kakou', pref: 'miyazaki',
      ingredients: [{ ref: 'm115', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r225', name: 'ピーマンの やきびたし', emoji: '🫑', tier: 3, type: 'gattai', pref: 'miyazaki',
      ingredients: [{ ref: 'm116', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r226', name: 'マンゴーの スムージー', emoji: '🥤', tier: 3, type: 'gattai', pref: 'miyazaki',
      ingredients: [{ ref: 'm114', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf45', name: 'ひゅうが ひょっとこ なつまつり', emoji: '🤡', tier: 4, type: 'matsuri', pref: 'miyazaki',
      implemented: true, festGame: 'hyottoko',
      ingredients: [{ ref: 'r222', count: 1 }, { ref: 'r225', count: 1 }],
      menu: ['r222', 'r223', 'r225'] },

    /* --- かごしま --- */
    { id: 'r227', name: 'さつまいもの かりんとう', emoji: '🍠', tier: 2, type: 'kakou', pref: 'kagoshima',
      ingredients: [{ ref: 'm04', count: 2, origin: 'kagoshima' }, { ref: 'm01', count: 1 }] },
    { id: 'r228', name: 'ちらんちゃ', emoji: '🍵', tier: 2, type: 'kakou', pref: 'kagoshima',
      ingredients: [{ ref: 'm16', count: 2, origin: 'kagoshima' }, { ref: 'm01', count: 1 }] },
    { id: 'r229', name: 'そらまめの しおゆで', emoji: '🫛', tier: 2, type: 'kakou', pref: 'kagoshima',
      ingredients: [{ ref: 'm118', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r230', name: 'うなぎの かばやき', emoji: '🐟', tier: 3, type: 'gattai', pref: 'kagoshima',
      ingredients: [{ ref: 'm117', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r231', name: 'きんかんの あまに', emoji: '🟠', tier: 3, type: 'gattai', pref: 'kagoshima',
      ingredients: [{ ref: 'm119', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf46', name: 'かごしまの ろくがつどう', emoji: '🏮', tier: 4, type: 'matsuri', pref: 'kagoshima',
      implemented: true, festGame: 'rokugatsudo',
      ingredients: [{ ref: 'r227', count: 1 }, { ref: 'r230', count: 1 }],
      menu: ['r227', 'r230', 'r231'] },

    /* --- おきなわ --- */
    { id: 'r232', name: 'くろざとう', emoji: '🍬', tier: 2, type: 'kakou', pref: 'okinawa',
      ingredients: [{ ref: 'm120', count: 2 }] },
    { id: 'r233', name: 'ゴーヤーチャンプルー', emoji: '🥒', tier: 2, type: 'kakou', pref: 'okinawa',
      ingredients: [{ ref: 'm121', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r234', name: 'パイナップルの ジュース', emoji: '🍍', tier: 2, type: 'kakou', pref: 'okinawa',
      ingredients: [{ ref: 'm122', count: 2 }] },
    { id: 'r235', name: 'もずくの すのもの', emoji: '☘️', tier: 3, type: 'gattai', pref: 'okinawa',
      ingredients: [{ ref: 'm123', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r236', name: 'べにいもの タルト', emoji: '🟣', tier: 3, type: 'gattai', pref: 'okinawa',
      ingredients: [{ ref: 'm124', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf47', name: 'なは おおづなひき', emoji: '🪢', tier: 4, type: 'matsuri', pref: 'okinawa',
