...
export const GAME_DATA: GameData = {
  ...
  materials: [
    ...
    /* --- ぐんま --- */
    { id: 'm13', name: 'キャベツ', emoji: '🥬', icon: 'leafy:lime', origins: ['gunma', 'gifu', 'aichi'], rarity: 'local',
    ...
    { id: 'm32', name: 'とうもろこし', emoji: '🌽', icon: 'grain:yellow', origins: ['hokkaido'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420,
        ...
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    { id: 'm33', name: 'じゃがいも', emoji: '🥔', icon: 'tuber:tan', origins: ['hokkaido', 'nagasaki', 'kanagawa'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねいもを うえる', growSec: 420,
  ...
  recipes: [
    ...
    { id: 'r145', name: 'よしのがわの あゆやき', emoji: '🐟', icon: 'skewer:teal', tier: 3, type: 'gattai', pref: 'nara',
    ...
    { id: 'r156', name: 'まつばがにの かにめし', emoji: '🍚', icon: 'bowl:red', tier: 3, type: 'gattai', pref: 'tottori',
    ...
    { id: 'rf43', name: 'ふじさきはちまんぐうの あきまつり', emoji: '🐴', icon: 'horse:brown', tier: 4, type: 'matsuri', pref: 'kumamoto',
