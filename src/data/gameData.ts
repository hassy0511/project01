...
export const GAME_DATA: GameData = {
  ...
  /* ---------- そざいマスタ(Tier1) ---------- */
  materials: [
    { id: 'm01', name: 'みず', emoji: '💧', origins: ['ibaraki', 'akita', 'yamanashi', 'shiga'], rarity: 'common',
    ...
    { id: 'm07', name: 'ねんど', emoji: '🟤', origins: ['ibaraki', 'tochigi', 'ishikawa', 'gifu', 'shiga'], rarity: 'local',
    ...
    /* --- かながわ --- */
    { id: 'm19', name: 'みかん', emoji: '🍊', origins: ['kanagawa', 'shizuoka', 'aichi', 'wakayama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
    ...
    /* --- ふくしま --- */
    { id: 'm30', name: 'もも', emoji: '🍑', origins: ['fukushima', 'yamanashi'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
    ...
    { id: 'm34', name: 'ねぎ', emoji: '🧅', origins: ['saitama', 'gunma', 'akita', 'kyoto'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
    ...
    { id: 'm36', name: 'かに', emoji: '🦀', origins: ['hokkaido', 'ishikawa', 'fukui', 'kyoto'], rarity: 'local',
    ...
    { id: 'm44', name: 'いか', emoji: '🦑', origins: ['hokkaido', 'aomori', 'toyama'], rarity: 'local',
    ...
    { id: 'm46', name: 'そば', emoji: '🌰', origins: ['fukushima', 'fukui', 'nagano'], rarity: 'local',
    ...
    { id: 'm54', name: 'ぶどう', emoji: '🍇', origins: ['yamanashi', 'nagano', 'osaka'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900,
        harvest: { engine: 'pluck', target: '🍇', prompt: 'むらさきに じゅくした ふさを おさえて、ゆーっくり ひっぱろう!' },
        care: { target: '🐦', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
