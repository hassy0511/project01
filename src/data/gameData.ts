...
export interface HarvestSpec {
  ...
  target?: string;
  /** しゅうかくで つかむ ものの アイコン(かたち:いろ)。target がある engine では 必須あつかい */
  targetIcon?: string;
  prompt: string;
  success?: string;
}
...
export interface TimingTheme {
  ...
  stopBtn: string;
  marker: string;
  /** ねらう ものの アイコン(かたち:いろ)。marker の 置きかえ先 */
  markerIcon: string;
  success: string;
  stages: string[];
  /** 3だんかいの えんしゅつアイコン(かたち:いろ)。stages の 置きかえ先 */
  stageIcons: string[];
}
...
export interface InfraGather {
  ...
  building: string;
  bEmoji: string;
  /** たてものの アイコン(かたち:いろ)。bEmoji の 置きかえ先 */
  bIcon: string;
  rateSec: number;
  max: number;
  collectVerb: string;
...
export const GAME_DATA: GameData = {
  ...
  regions: [
    ...
    { id: 'tohoku', name: 'ほっかいどう・とうほく', kanji: '北海道・東北', emoji: '❄️', icon: 'snowflake:sky', active: true, color: '#C5E1A5', mapFile: 'map-tohoku.json', unlockFests: 3 },
    { id: 'kanto', name: 'かんとう', kanji: '関東', emoji: '🗼', icon: 'tower:red', active: true, color: '#A9DC76', mapFile: 'map-gen.json' },
    { id: 'chubu', name: 'ちゅうぶ', kanji: '中部', emoji: '🗻', icon: 'mountain:sky', active: true, color: '#FFE0B2', mapFile: 'map-chubu.json', unlockFests: 6 },
    { id: 'kinki', name: 'きんき', kanji: '近畿', emoji: '🦌', icon: 'deer:brown', active: true, color: '#F8BBD0', mapFile: 'map-kinki.json', unlockFests: 9 },
    { id: 'chugoku', name: 'ちゅうごく', kanji: '中国', emoji: '⛩️', icon: 'shrine:red', active: true, color: '#FFF59D', mapFile: 'map-chugoku.json', unlockFests: 12 },
    { id: 'shikoku', name: 'しこく', kanji: '四国', emoji: '🍊', icon: 'wave:teal', active: true, color: '#B2DFDB', mapFile: 'map-shikoku.json', unlockFests: 15 },
    { id: 'kyushu', name: 'きゅうしゅう・おきなわ', kanji: '九州・沖縄', emoji: '🌺', icon: 'hibiscus:pink', active: true, color: '#FFCC80', mapFile: 'map-kyushu.json', unlockFests: 18 },
  ],
  ...
  /* ---------- そざいマスタ(Tier1) ---------- */
  materials: [
    { id: 'm01', name: 'みず', emoji: '💧', icon: 'drop:sky', origins: ['ibaraki', 'akita', 'yamanashi', 'shiga', 'tottori', 'kochi', 'oita'], rarity: 'common',
      gather: { type: 'infra', building: 'いど', bEmoji: '⛲', bIcon: 'well:gray', rateSec: 120, max: 3, collectVerb: 'くみあげる' } },
    { id: 'm02', name: 'こめ', emoji: '🌾', icon: 'grain:amber', origins: ['chiba', 'akita', 'miyagi', 'fukushima', 'niigata', 'toyama', 'fukui', 'gifu', 'shiga', 'saga', 'kumamoto'], rarity: 'common',
      gather: { type: 'plant', verb: 'いねを うえる', growSec: 240, fieldLabel: 'たんぼ',
        harvest: { engine: 'reap', target: '🌾', targetIcon: 'grain:amber', prompt: 'よこに なぞって いねを かろう! 1れつを ひとふでで かると ボーナス!' },
        care: { target: '🦗', targetIcon: 'bug:lime', label: 'いなごが きた! タップで おいはらえ!' } } },
    { id: 'm03', name: 'だいず', emoji: '🫘', icon: 'pod:tan', origins: ['tochigi', 'aichi', 'hyogo'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300,
        harvest: { engine: 'chain', target: '🫘', targetIcon: 'pod:tan', prompt: 'ちゃいろに じゅくした まめだけ つもう! みどりは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが ついてる! タップで とろう!' } } },
    { id: 'm04', name: 'さつまいも', emoji: '🍠', icon: 'tuber:purple', origins: ['ibaraki', 'chiba', 'saitama', 'tokushima', 'kagoshima'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねいもを うえる', growSec: 420,
        ...
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが きた! タップで おいはらえ!' } } },
    { id: 'm05', name: 'メロン', emoji: '🍈', icon: 'melon:lime', origins: ['ibaraki'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 600,
        harvest: { engine: 'flick', target: '🍈', targetIcon: 'melon:lime', prompt: 'メロンを ひっぱって はなして、かごに ころがしこもう!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'つるが のびすぎ! タップで ととのえよう!' } } },
    { id: 'm06', name: 'うめ', emoji: '🫒', icon: 'round:lime', origins: ['ibaraki', 'gunma', 'tokyo', 'fukui', 'wakayama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
        harvest: { engine: 'catch', target: '🫒', targetIcon: 'round:lime', prompt: 'おちてくる うめを かごで キャッチ! えだは よけてね' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが えだに ついてる! タップで とろう!' } } },
    { id: 'm07', name: 'ねんど', emoji: '🟤', icon: 'clay:brown', origins: ['ibaraki', 'tochigi', 'ishikawa', 'gifu', 'shiga', 'okayama', 'saga'], rarity: 'local',
      gather: { type: 'dig', verb: 'ほりに いく',
        theme: { intro: 'いい ねんどが ねむる つちばを みつけた!', prompt: 'すうじは「まわりに ねんどが いくつ あるか」の ヒント! すいりして ほろう', success: 'ほりあて せいこう!', stages: ['⛰️', '⛏️', '✨'], stageIcons: ['mountain:gray', 'pick:silver', 'sparkle:gold'] } } },
    { id: 'm08', name: 'らっかせい', emoji: '🥜', icon: 'nut:tan', origins: ['chiba'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 360,
        harvest: { engine: 'mine', prompt: 'らっかせいは つちのなかに できるよ。ヒントの すうじで ばしょを すいりして ほろう!' },
        care: { target: '🐜', targetIcon: 'ant:dark', label: 'ありが あつまってきた! タップで はらおう!' } } },
    { id: 'm09', name: 'いわし', emoji: '🐟', icon: 'fish:silver', origins: ['chiba', 'kanagawa', 'kagawa'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'いわしの むれが やってきた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'fish:silver', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'], stageIcons: ['boat:white', 'wave:sky', 'fish:silver'] } } },
    { id: 'm10', name: 'なし', emoji: '🍐', icon: 'round:tan', origins: ['chiba', 'tochigi', 'fukushima', 'yamagata', 'tottori'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1500,
        harvest: { engine: 'catch', target: '🍐', targetIcon: 'round:tan', prompt: 'おちてくる なしを かごで キャッチ! えだは よけてね' },
        care: { target: '🐝', targetIcon: 'bee:amber', label: 'はちが みに あつまってる! タップで はらおう!' } } },
    { id: 'm11', name: 'いちご', emoji: '🍓', icon: 'strawberry:red', origins: ['tochigi', 'miyagi', 'nara', 'fukuoka', 'saga'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300,
        harvest: { engine: 'pluck', target: '🍓', targetIcon: 'strawberry:red', prompt: 'まっかな いちごを おさえて、したに ゆーっくり ひっぱろう! はやいと くきが きれちゃう' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが いちごを ねらってる! タップで おいはらえ!' } } },
    { id: 'm12', name: 'ゆうがお', emoji: '🥒', icon: 'cucumber:cream', origins: ['tochigi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420,
        harvest: { engine: 'flick', target: '🥒', targetIcon: 'cucumber:cream', prompt: 'おおきな みを はじいて、かごに ころがしこもう!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'つるが あばれてる! タップで しちゅうに とめよう!' } } },

    /* --- ぐんま --- */
    { id: 'm13', name: 'キャベツ', emoji: '🥬', icon: 'leafy:lime', origins: ['gunma', 'kanagawa', 'gifu', 'aichi'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
        harvest: { engine: 'flick', target: '🥬', targetIcon: 'leafy:lime', prompt: 'まるまる そだった キャベツを はじいて、かごに ころがしこもう!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'あおむしが はっぱを むしゃむしゃ! タップで とろう!' } } },
    { id: 'm14', name: 'こんにゃくいも', emoji: '🟣', icon: 'tuber:dark', origins: ['gunma'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねいもを うえる', growSec: 480,
        harvest: { engine: 'mine', prompt: 'こんにゃくいもは つちのなか。すうじの ヒントで すいりして ほろう!' },
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが きた! タップで おいはらえ!' } } },
    { id: 'm15', name: 'まゆ', emoji: '🧶', icon: 'silk:white', origins: ['gunma'], rarity: 'unique',
      gather: { type: 'plant', verb: 'かいこを そだてる', growSec: 300, fieldLabel: 'かいこべや',
        harvest: { engine: 'pluck', target: '🧶', targetIcon: 'silk:white', prompt: 'まっしろな まゆを おさえて、ゆーっくり ひっぱって とろう! はやいと いとが きれちゃう' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが かいこを ねらってる! タップで おいはらえ!' } } },

    /* --- さいたま --- */
    { id: 'm16', name: 'ちゃば', emoji: '🍃', icon: 'tealeaf:deepgreen', origins: ['saitama', 'kanagawa', 'ishikawa', 'shizuoka', 'aichi', 'mie', 'shiga', 'kyoto', 'nara', 'fukuoka', 'nagasaki', 'miyazaki', 'kagoshima'], rarity: 'local',
      gather: { type: 'plant', verb: 'ちゃのきを うえる', growSec: 300,
        harvest: { engine: 'rhythm', target: '🍃', targetIcon: 'tealeaf:deepgreen', prompt: 'わっかに わかばが きたら タップ! リズムよく ちゃつみ しよう' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが わかばに ついてる! タップで とろう!' } } },

    /* --- とうきょう --- */
    { id: 'm17', name: 'こまつな', emoji: '🌿', icon: 'leafy:green', origins: ['tokyo', 'saitama'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 240,
        harvest: { engine: 'reap', target: '🌿', targetIcon: 'leafy:green', prompt: 'よこに なぞって こまつなを かろう! 1れつを ひとふでで かると ボーナス!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm18', name: 'ブルーベリー', emoji: '🫐', icon: 'berry:navy', origins: ['tokyo'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900,
        harvest: { engine: 'chain', target: '🫐', targetIcon: 'berry:navy', prompt: 'むらさきに いろづいた みだけ つもう! あかいのは まだ はやいよ' },
        care: { target: '🐿️', targetIcon: 'squirrel:tan', label: 'りすが みを ねらってる! タップで おいはらえ!' } } },

    /* --- かながわ --- */
    { id: 'm19', name: 'みかん', emoji: '🍊', icon: 'citrus:orange', origins: ['kanagawa', 'shizuoka', 'aichi', 'wakayama', 'yamaguchi', 'ehime'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
        harvest: { engine: 'catch', target: '🍊', targetIcon: 'citrus:orange', prompt: 'おちてくる みかんを かごで キャッチ! えだは よけてね' },
        care: { target: '🐝', targetIcon: 'bee:amber', label: 'はちが みに あつまってる! タップで はらおう!' } } },

    /* --- あおもり --- */
    { id: 'm20', name: 'りんご', emoji: '🍎', icon: 'round:red', origins: ['aomori', 'iwate', 'nagano'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
        harvest: { engine: 'catch', target: '🍎', targetIcon: 'round:red', prompt: 'おちてくる りんごを かごで キャッチ! えだは よけてね' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが りんごを つついてる! タップで おいはらえ!' } } },
    { id: 'm21', name: 'にんにく', emoji: '🧄', icon: 'onion:white', origins: ['aomori'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを うえる', growSec: 420,
        harvest: { engine: 'mine', prompt: 'にんにくは つちのなか。すうじの ヒントで ばしょを すいりして ほろう!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが きた! タップで とろう!' } } },
    { id: 'm22', name: 'ゆきしたにんじん', emoji: '🥕', icon: 'root:orange', origins: ['aomori'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 480, fieldLabel: 'ゆきばたけ',
        harvest: { engine: 'sweep', target: '🥕', targetIcon: 'root:orange', prompt: 'ゆきを こすって はらうと にんじんが でてくる! でてきたら タップで あつめよう' },
        care: { target: '🐰', targetIcon: 'rabbit:white', label: 'うさぎが にんじんを ねらってる! タップで おいはらえ!' } } },

    /* --- いわて --- */
    { id: 'm23', name: 'ぎゅうにゅう', emoji: '🥛', icon: 'milk:white', origins: ['iwate', 'hokkaido', 'kumamoto'], rarity: 'local',
      gather: { type: 'infra', building: 'ぼくじょう', bEmoji: '🐄', bIcon: 'cow:white', rateSec: 300, max: 3, collectVerb: 'しぼる' } },
    { id: 'm24', name: 'てついし', emoji: '🪨', icon: 'stone:gray', origins: ['iwate', 'shimane'], rarity: 'unique',
      gather: { type: 'dig', verb: 'ほりに いく',
        theme: { intro: 'いい てつが ねむる やまを みつけた!', prompt: 'すうじは「まわりに てついしが いくつ あるか」の ヒント! すいりして ほろう', success: 'ほりあて せいこう!', stages: ['⛰️', '⛏️', '✨'], stageIcons: ['mountain:gray', 'pick:silver', 'sparkle:gold'] } } },

    /* --- みやぎ --- */
    { id: 'm25', name: 'えだまめ', emoji: '🫛', icon: 'pod:green', origins: ['miyagi', 'yamagata', 'akita', 'niigata'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300,
        harvest: { engine: 'chain', target: '🫛', targetIcon: 'pod:green', prompt: 'ぷっくり ふくらんだ さやだけ つもう! ぺたんこは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが さやに ついてる! タップで とろう!' } } },
    { id: 'm26', name: 'かき', emoji: '🦪', icon: 'shell:gray', origins: ['miyagi', 'hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねがいを つるす', growSec: 480, fieldLabel: 'かきの いかだ',
        harvest: { engine: 'shell', target: '🦪', targetIcon: 'shell:gray', prompt: 'ロープを ちょうどよい はやさで ひきあげて、デッキで かきを はずそう! はやすぎると おちるよ' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'とりが いかだを ねらってる! タップで おいはらえ!' } } },

    /* --- あきた --- */
    { id: 'm27', name: 'はたはた', emoji: '🐠', icon: 'fish:amber', origins: ['akita'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'ふゆの うみに はたはたが やってきた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐠', markerIcon: 'fish:amber', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐠'], stageIcons: ['boat:white', 'wave:sky', 'fish:amber'] } } },

    /* --- やまがた --- */
    { id: 'm28', name: 'さくらんぼ', emoji: '🍒', icon: 'berry:crimson', origins: ['yamagata'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900,
        harvest: { engine: 'pluck', target: '🍒', targetIcon: 'berry:crimson', prompt: 'まっかな さくらんぼを おさえて、ゆーっくり ひっぱろう! はやいと えだが きれちゃう' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが さくらんぼを ねらってる! タップで おいはらえ!' } } },
    { id: 'm29', name: 'さといも', emoji: '🥔', icon: 'tuber:brown', origins: ['yamagata'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねいもを うえる', growSec: 420,
        harvest: { engine: 'mine', prompt: 'さといもは つちのなか。すうじの ヒントで すいりして ほろう!' },
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが きた! タップで おいはらえ!' } } },

    /* --- ふくしま --- */
    { id: 'm30', name: 'もも', emoji: '🍑', icon: 'round:pink', origins: ['fukushima', 'yamanashi', 'okayama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
        harvest: { engine: 'pluck', target: '🍑', targetIcon: 'round:pink', prompt: 'いいにおいの ももを おさえて、ゆーっくり ひっぱろう! はやいと えだが きれちゃう' },
        care: { target: '🐝', targetIcon: 'bee:amber', label: 'はちが みに あつまってる! タップで はらおう!' } } },
    { id: 'm31', name: 'トマト', emoji: '🍅', icon: 'round:crimson', origins: ['fukushima'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
        harvest: { engine: 'chain', target: '🍅', targetIcon: 'round:crimson', prompt: 'まっかに いろづいた トマトだけ つもう! みどりは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが ついてる! タップで とろう!' } } },

    /* --- バランス調整で追加(2026-07): 各県 そざい5種(みず ふくむ)以上に そろえる ---
       ひとつの そざいを 複数の 産地で 共有する(ねぎ = ふかや/しもにた/しらかみ 等)。
       産地の追加は origins に足すだけ = データ駆動 */
    { id: 'm34', name: 'ねぎ', emoji: '🧅', icon: 'stalk:white', origins: ['saitama', 'gunma', 'akita', 'kyoto', 'tottori', 'oita'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
        harvest: { engine: 'pluck', target: '🧅', targetIcon: 'stalk:white', prompt: 'そだった ねぎを おさえて、ゆーっくり ひきぬこう! はやいと ちぎれちゃう' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱに ついてる! タップで とろう!' } } },
    { id: 'm35', name: 'すいか', emoji: '🍉', icon: 'melon:deepgreen', origins: ['kanagawa'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 660,
        harvest: { engine: 'flick', target: '🍉', targetIcon: 'melon:deepgreen', prompt: 'おもい すいかを はじいて、かごに ころがしこもう!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが すいかを つついてる! タップで おいはらえ!' } } },
    { id: 'm36', name: 'かに', emoji: '🦀', icon: 'crab:red', origins: ['hokkaido', 'ishikawa', 'fukui', 'kyoto', 'tottori'], rarity: 'local',
      gather: { type: 'plant', verb: 'かにかごを しずめる', growSec: 540, fieldLabel: 'かにかごば',
        harvest: { engine: 'shell', target: '🦀', targetIcon: 'crab:red', prompt: 'かごの ロープを ちょうどよい はやさで ひきあげて、デッキで かにを とりだそう!' },
        care: { target: '🐙', targetIcon: 'octopus:red', label: 'たこが かごに はいってる! タップで だそう!' } } },
    { id: 'm37', name: 'ほたて', emoji: '🐚', icon: 'shell:cream', origins: ['aomori'], rarity: 'unique',
      gather: { type: 'plant', verb: 'かごを つるす', growSec: 480, fieldLabel: 'ほたての いかだ',
        harvest: { engine: 'shell', target: '🐚', targetIcon: 'shell:cream', prompt: 'ロープを ちょうどよい はやさで ひきあげて、デッキで ほたてを はずそう!' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'とりが いかだを ねらってる! タップで おいはらえ!' } } },
    { id: 'm38', name: 'わかめ', emoji: '☘️', icon: 'seaweed:deepgreen', origins: ['iwate', 'tokushima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねなわを しずめる', growSec: 480, fieldLabel: 'いかだ',
        harvest: { engine: 'reap', target: '☘️', targetIcon: 'seaweed:deepgreen', prompt: 'よこに なぞって わかめを かりとろう! 1れつを ひとふでで かると ボーナス!' },
        care: { target: '🐠', targetIcon: 'fish:orange', label: 'さかなが わかめを たべにきた! タップで おいはらえ!' } } },
    { id: 'm39', name: 'せり', emoji: '🌱', icon: 'stalk:green', origins: ['miyagi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'みずた',
        harvest: { engine: 'pluck', target: '🌱', targetIcon: 'stalk:green', prompt: 'せりは ねっこも おいしい! おさえて ゆーっくり ひきぬこう' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱに ついてる! タップで とろう!' } } },
    { id: 'm40', name: 'べにばな', emoji: '🌺', icon: 'flower:orange', origins: ['yamagata'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420,
        harvest: { engine: 'chain', target: '🌺', targetIcon: 'flower:orange', prompt: 'きいろから あかに かわった はなだけ つもう! きいろは まだ はやいよ' },
        care: { target: '🐝', targetIcon: 'bee:amber', label: 'はちが はなに あつまってる! タップで はらおう!' } } },
    { id: 'm41', name: 'わさび', emoji: '🍀', icon: 'root:lime', origins: ['tokyo', 'nagano', 'shizuoka'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900, fieldLabel: 'さわ',
        harvest: { engine: 'pluck', target: '🍀', targetIcon: 'root:lime', prompt: 'きれいな みずで そだった わさびを、ゆーっくり ひきぬこう!' },
        care: { target: '🐌', targetIcon: 'snail:tan', label: 'かたつむりが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm43', name: 'ブロッコリー', emoji: '🥦', icon: 'flower:deepgreen', origins: ['saitama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 420,
        harvest: { engine: 'chain', target: '🥦', targetIcon: 'flower:deepgreen', prompt: 'つぼみが きゅっと しまった ブロッコリーだけ つもう! きいろい はなは おそいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'あおむしが つぼみを たべてる! タップで とろう!' } } },
    { id: 'm44', name: 'いか', emoji: '🦑', icon: 'squid:cream', origins: ['hokkaido', 'aomori', 'toyama', 'yamaguchi'], rarity: 'local',
      gather: { type: 'timing', verb: 'いかつりに でる',
        theme: { intro: 'よるの うみに いかつりの あかりを つけたよ!', prompt: 'いかを タップして つりあげよう! おおきい いかほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'いとを あげる!', marker: '🦑', markerIcon: 'squid:cream', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🦑'], stageIcons: ['boat:white', 'wave:sky', 'squid:cream'] } } },
    { id: 'm45', name: 'やまぶどう', emoji: '🍇', icon: 'berry:violet', origins: ['iwate'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 720,
        harvest: { engine: 'pluck', target: '🍇', targetIcon: 'berry:violet', prompt: 'むらさきに じゅくした ふさを おさえて、ゆーっくり ひっぱろう!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    { id: 'm46', name: 'そば', emoji: '🌰', icon: 'grain:brown', origins: ['fukushima', 'fukui', 'nagano', 'shimane'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 360, fieldLabel: 'そばばたけ',
        harvest: { engine: 'reap', target: '🌰', targetIcon: 'grain:brown', prompt: 'よこに なぞって そばを かりとろう! 1れつを ひとふでで かると ボーナス!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを たべにきた! タップで おいはらえ!' } } },
    { id: 'm42', name: 'うど', emoji: '🎍', icon: 'stalk:cream', origins: ['tokyo'], rarity: 'unique',
      gather: { type: 'plant', verb: 'かぶを うえる', growSec: 480, fieldLabel: 'むろ',
        ...
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'むろの ひかりが もれてる! タップで ふさごう!' } } },

    /* --- ちゅうぶ(2026-07 追加) --- */
    { id: 'm47', name: 'さけ', emoji: '🐡', icon: 'bigfish:pink', origins: ['niigata', 'toyama'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'かわを のぼる さけの きせつが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐡', markerIcon: 'bigfish:pink', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐡'], stageIcons: ['boat:white', 'wave:sky', 'bigfish:pink'] } } },
    { id: 'm48', name: 'なす', emoji: '🍆', icon: 'eggplant:violet', origins: ['niigata'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
        harvest: { engine: 'chain', target: '🍆', targetIcon: 'eggplant:violet', prompt: 'つやつやの むらさきに なった なすだけ つもう! みどりは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm49', name: 'チューリップ', emoji: '🌷', icon: 'tulip:red', origins: ['niigata', 'toyama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'きゅうこんを うえる', growSec: 480, fieldLabel: 'はなばたけ',
        harvest: { engine: 'pluck', target: '🌷', targetIcon: 'tulip:red', prompt: 'さきごろの はなを おさえて、ゆーっくり ひきぬこう! はやいと くきが おれちゃう' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱに ついてる! タップで とろう!' } } },
    { id: 'm50', name: 'しろえび', emoji: '🦐', icon: 'shrimp:white', origins: ['toyama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 420, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🦐', targetIcon: 'shrimp:white', prompt: 'ざるを うごかして、ひかる しろえびの むれを すくいとろう!' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'とんびが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm51', name: 'しお', emoji: '🧂', icon: 'salt:white', origins: ['ishikawa', 'hyogo'], rarity: 'unique',
      gather: { type: 'infra', building: 'えんでん', bEmoji: '🏖️', bIcon: 'salt:cream', rateSec: 180, max: 3, collectVerb: 'かきあつめる' } },
    { id: 'm52', name: 'れんこん', emoji: '🪷', icon: 'lotus:cream', origins: ['ishikawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねばすを うえる', growSec: 540, fieldLabel: 'はすだ',
        ...
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm53', name: 'チタン', emoji: '🔩', icon: 'stone:silver', origins: ['fukui'], rarity: 'unique',
      gather: { type: 'dig', verb: 'ほりに いく',
        theme: { intro: 'かるくて つよい きんぞくの こうせきを みつけた!', prompt: 'すうじは「まわりに こうせきが いくつ あるか」の ヒント! すいりして ほろう', success: 'ほりあて せいこう!', stages: ['⛰️', '⛏️', '✨'], stageIcons: ['mountain:gray', 'pick:silver', 'sparkle:gold'] } } },
    { id: 'm54', name: 'ぶどう', emoji: '🍇', icon: 'berry:purple', origins: ['yamanashi', 'nagano', 'osaka', 'shimane', 'okayama'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900,
        harvest: { engine: 'pluck', target: '🍇', targetIcon: 'berry:purple', prompt: 'むらさきに じゅくした ふさを おさえて、ゆーっくり ひっぱろう!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    { id: 'm55', name: 'すいしょう', emoji: '💎', icon: 'gem:sky', origins: ['yamanashi'], rarity: 'unique',
      gather: { type: 'dig', verb: 'ほりに いく',
        theme: { intro: 'きらきら ひかる いしが ねむる やまを みつけた!', prompt: 'すうじは「まわりに すいしょうが いくつ あるか」の ヒント! すいりして ほろう', success: 'ほりあて せいこう!', stages: ['⛰️', '⛏️', '✨'], stageIcons: ['mountain:gray', 'pick:silver', 'sparkle:gold'] } } },
    { id: 'm56', name: 'かぼちゃ', emoji: '🎃', icon: 'round:deepgreen', origins: ['yamanashi'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 600,
        harvest: { engine: 'flick', target: '🎃', targetIcon: 'round:deepgreen', prompt: 'おもい かぼちゃを はじいて、かごに ころがしこもう!' },
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが かぼちゃを ねらってる! タップで おいはらえ!' } } },
    { id: 'm57', name: 'きのこ', emoji: '🍄', icon: 'mushroom:brown', origins: ['nagano'], rarity: 'unique',
      gather: { type: 'plant', verb: 'ほだぎを ならべる', growSec: 420, fieldLabel: 'きのこごや',
        harvest: { engine: 'chain', target: '🍄', targetIcon: 'mushroom:brown', prompt: 'かさが ぴんと ひらいた きのこだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐌', targetIcon: 'snail:tan', label: 'なめくじが きのこを たべてる! タップで とろう!' } } },
    { id: 'm58', name: 'こうぞ', emoji: '🪵', icon: 'log:tan', origins: ['gifu'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 660, fieldLabel: 'こうぞばたけ',
        harvest: { engine: 'reap', target: '🪵', targetIcon: 'log:tan', prompt: 'よこに なぞって こうぞを かりとろう! 1れつを ひとふでで かると ボーナス!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが かわを かじってる! タップで とろう!' } } },
    { id: 'm59', name: 'あゆ', emoji: '🐟', icon: 'fish:teal', origins: ['gifu', 'nara'], rarity: 'unique',
      gather: { type: 'timing', verb: 'うかいに でる',
        theme: { intro: 'ながらがわの うかい(かがり火の りょう)が はじまる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'fish:teal', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'], stageIcons: ['boat:white', 'wave:sky', 'fish:teal'] } } },
    { id: 'm60', name: 'しらす', emoji: '🐟', icon: 'fish:white', origins: ['shizuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 300, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🐟', targetIcon: 'fish:white', prompt: 'ざるを うごかして、しらすの むれを すくいとろう!' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'とんびが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm62', name: 'さくらえび', emoji: '🍤', icon: 'shrimp:pink', origins: ['shizuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 480, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🍤', targetIcon: 'shrimp:pink', prompt: 'ざるを うごかして、うすピンクの さくらえびを すくいとろう!' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'とんびが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm61', name: 'うずらのたまご', emoji: '🥚', icon: 'egg:cream', origins: ['aichi'], rarity: 'unique',
      gather: { type: 'infra', building: 'うずらごや', bEmoji: '🐣', bIcon: 'chick:amber', rateSec: 150, max: 3, collectVerb: 'あつめる' } },

    /* --- ほっかいどう --- */
    { id: 'm32', name: 'とうもろこし', emoji: '🌽', icon: 'grain:yellow', origins: ['hokkaido'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420,
        harvest: { engine: 'chain', target: '🌽', targetIcon: 'grain:yellow', prompt: 'ひげが ちゃいろに なった とうもろこしだけ つもう!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    { id: 'm33', name: 'じゃがいも', emoji: '🥔', icon: 'tuber:tan', origins: ['hokkaido', 'nagasaki'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねいもを うえる', growSec: 420,
        harvest: { engine: 'mine', prompt: 'じゃがいもは つちのなか。すうじの ヒントで ばしょを すいりして ほろう!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱに ついてる! タップで とろう!' } } },

    /* --- きんき(2026-07 追加) --- */
    { id: 'm63', name: 'しんじゅ', emoji: '🦪', icon: 'pearl:white', origins: ['mie'], rarity: 'unique',
      gather: { type: 'plant', verb: 'アコヤがいを つるす', growSec: 540, fieldLabel: 'しんじゅの いかだ',
        harvest: { engine: 'shell', target: '🦪', targetIcon: 'pearl:white', prompt: 'ロープを ちょうどよい はやさで ひきあげて、デッキで たまを とりだそう! はやすぎると おちるよ' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'あかしおが きそう! タップで いかだを うごかせ!' } } },
    { id: 'm64', name: 'いせえび', emoji: '🦞', icon: 'shrimp:crimson', origins: ['mie'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 480, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🦞', targetIcon: 'shrimp:crimson', prompt: 'ざるを うごかして、いわばに あつまった いせえびを すくいとろう!' },
        care: { target: '🦈', targetIcon: 'shark:gray', label: 'おおきな さかなが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm65', name: 'のり', emoji: '🟩', icon: 'seaweed:dark', origins: ['mie', 'fukuoka', 'saga'], rarity: 'local',
      gather: { type: 'plant', verb: 'のりあみを はる', growSec: 420, fieldLabel: 'のりひび',
        harvest: { engine: 'reap', target: '🟩', targetIcon: 'seaweed:dark', prompt: 'よこに なぞって のりを つみとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🦆', targetIcon: 'duck:brown', label: 'かもが のりを たべにきた! タップで おいはらえ!' } } },
    { id: 'm66', name: 'わぎゅう', emoji: '🐄', icon: 'cow:dark', origins: ['mie'], rarity: 'unique',
      gather: { type: 'infra', building: 'ぼくじょう', bEmoji: '🏡', bIcon: 'hut:brown', rateSec: 180, max: 3, collectVerb: 'せわを する' } },
    { id: 'm67', name: 'ふな', emoji: '🐟', icon: 'fish:gray', origins: ['shiga'], rarity: 'unique',
      gather: { type: 'timing', verb: 'ふなを つる',
        theme: { intro: 'びわこの ふなが およいでいる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'fish:gray', success: 'たいりょうだ!', stages: ['🚣', '🌊', '🐟'], stageIcons: ['rowboat:brown', 'wave:sky', 'fish:gray'] } } },
    { id: 'm68', name: 'たけのこ', emoji: '🎍', icon: 'bamboo:cream', origins: ['kyoto', 'fukuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たけやまを ととのえる', growSec: 480, fieldLabel: 'たけやま',
        ...
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが たけのこを ほりにきた! タップで おいはらえ!' } } },
    { id: 'm69', name: 'まつたけ', emoji: '🍄', icon: 'mushroom:tan', origins: ['kyoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あかまつの やまを まもる', growSec: 600, fieldLabel: 'あかまつの やま',
        harvest: { engine: 'sweep', target: '🍄', targetIcon: 'mushroom:tan', prompt: 'おちばを こすって かきわけて、かくれている まつたけを さがそう!' },
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが やまを あらしてる! タップで おいはらえ!' } } },
    { id: 'm70', name: 'たこ', emoji: '🐙', icon: 'octopus:crimson', origins: ['osaka', 'hyogo'], rarity: 'local',
      gather: { type: 'plant', verb: 'たこつぼを しずめる', growSec: 420, fieldLabel: 'たこつぼば',
        harvest: { engine: 'shell', target: '🐙', targetIcon: 'octopus:crimson', prompt: 'ロープを ちょうどよい はやさで ひきあげて、デッキで たこを つぼから だそう!' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'とんびが つぼを ねらってる! タップで おいはらえ!' } } },
    { id: 'm79', name: 'みずなす', emoji: '🍆', icon: 'eggplant:purple', origins: ['osaka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'せんしゅうの はたけ',
        harvest: { engine: 'chain', target: '🍆', targetIcon: 'eggplant:purple', prompt: 'つやつやの まるい みずなすだけ つもう! みどりは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm71', name: 'しゅんぎく', emoji: '🌿', icon: 'leafy:teal', origins: ['osaka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'なにわの はたけ',
        harvest: { engine: 'reap', target: '🌿', targetIcon: 'leafy:teal', prompt: 'よこに なぞって しゅんぎくを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm72', name: 'たまねぎ', emoji: '🧅', icon: 'onion:tan', origins: ['osaka', 'hyogo'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 420, fieldLabel: 'たまねぎばたけ',
        harvest: { engine: 'pluck', target: '🧅', targetIcon: 'onion:tan', prompt: 'おおきく なった たまねぎを おさえて、ゆーっくり ひきぬこう! はやいと はっぱが ちぎれる' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが なえを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm73', name: 'いかなご', emoji: '🐟', icon: 'fish:cream', origins: ['hyogo'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを しかける', growSec: 300, fieldLabel: 'あみば',
        harvest: { engine: 'scoop', target: '🐟', targetIcon: 'fish:cream', prompt: 'ざるを うごかして、ひかる いかなごの むれを すくいとろう!' },
        care: { target: '🦅', targetIcon: 'hawk:brown', label: 'かもめが あみを ねらってる! タップで おいはらえ!' } } },
    { id: 'm74', name: 'かきのみ', emoji: '🟠', icon: 'round:orange', origins: ['nara'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'かきばたけ',
        harvest: { engine: 'catch', target: '🟠', targetIcon: 'round:orange', prompt: 'おちてくる かきを かごで うけとめよう! きんの かきは とくてん おおい!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm75', name: 'よしのすぎ', emoji: '🌲', icon: 'tree:deepgreen', origins: ['nara'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 600, fieldLabel: 'すぎの やま',
        harvest: { engine: 'reap', target: '🌲', targetIcon: 'tree:deepgreen', prompt: 'よこに なぞって のこぎりで すぎを きりだそう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'えだが しげって ひが とどかない! タップで えだうち!' } } },
    { id: 'm76', name: 'さんしょう', emoji: '🌶️', icon: 'berry:lime', origins: ['wakayama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 420, fieldLabel: 'さんしょうばたけ',
        harvest: { engine: 'chain', target: '🌶️', targetIcon: 'berry:lime', prompt: 'みどりが こくなった つぶだけ つもう! まだ うすいのは はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'あおむしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm77', name: 'まぐろ', emoji: '🐟', icon: 'bigfish:navy', origins: ['wakayama'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'おきに まぐろの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'bigfish:navy', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'], stageIcons: ['boat:white', 'wave:sky', 'bigfish:navy'] } } },
    { id: 'm78', name: 'びんちょうたん', emoji: '⬛', icon: 'log:dark', origins: ['wakayama'], rarity: 'unique',
      gather: { type: 'infra', building: 'すみやきがま', bEmoji: '🔥', bIcon: 'kiln:brown', rateSec: 180, max: 3, collectVerb: 'とりだす' } },

    /* --- ちゅうごく・しこく(2026-07 追加) --- */
    { id: 'm80', name: 'らっきょう', emoji: '🧄', icon: 'onion:cream', origins: ['tottori'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを うえる', growSec: 480, fieldLabel: 'すなおかの はたけ',
        ...
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが なえを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm81', name: 'しじみ', emoji: '🐚', icon: 'shell:dark', origins: ['shimane'], rarity: 'unique',
      gather: { type: 'plant', verb: 'じょれんを しずめる', growSec: 420, fieldLabel: 'しじみの りょうば',
        harvest: { engine: 'shell', target: '🐚', targetIcon: 'shell:dark', prompt: 'じょれんの ロープを ちょうどよい はやさで ひきあげて、ふねで しじみを えらぼう!' },
        care: { target: '🦆', targetIcon: 'duck:brown', label: 'かもが しじみを たべにきた! タップで おいはらえ!' } } },
    { id: 'm82', name: 'のどぐろ', emoji: '🐠', icon: 'fish:crimson', origins: ['shimane'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'ふかい うみに のどぐろが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐠', markerIcon: 'fish:crimson', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐠'], stageIcons: ['boat:white', 'wave:sky', 'fish:crimson'] } } },
    { id: 'm83', name: 'ままかり', emoji: '🐟', icon: 'fish:blue', origins: ['okayama'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'せとうちに ままかりの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'fish:blue', success: 'たいりょうだ!', stages: ['🚣', '🌊', '🐟'], stageIcons: ['rowboat:brown', 'wave:sky', 'fish:blue'] } } },
    { id: 'm84', name: 'きにら', emoji: '🌿', icon: 'stalk:yellow', origins: ['okayama'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'くらの はたけ',
        harvest: { engine: 'reap', target: '🌿', targetIcon: 'stalk:yellow', prompt: 'よこに なぞって きにらを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'ひかりが もれて みどりに なっちゃう! タップで ふさごう!' } } },
    { id: 'm85', name: 'レモン', emoji: '🍋', icon: 'citrus:yellow', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 480, fieldLabel: 'レモンばたけ',
        harvest: { engine: 'catch', target: '🍋', targetIcon: 'citrus:yellow', prompt: 'おちてくる レモンを かごで うけとめよう! きんの レモンは とくてん おおい!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm86', name: 'ひろしまな', emoji: '🥬', icon: 'leafy:deepgreen', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'なばたけ',
        harvest: { engine: 'reap', target: '🥬', targetIcon: 'leafy:deepgreen', prompt: 'よこに なぞって ひろしまなを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'あおむしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm87', name: 'あなご', emoji: '🐟', icon: 'eel:tan', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'みやじまの おきに あなごが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'eel:tan', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'], stageIcons: ['boat:white', 'wave:sky', 'eel:tan'] } } },
    { id: 'm88', name: 'わけぎ', emoji: '🌱', icon: 'stalk:lime', origins: ['hiroshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'きゅうこんを うえる', growSec: 300, fieldLabel: 'わけぎばたけ',
        harvest: { engine: 'pluck', target: '🌱', targetIcon: 'stalk:lime', prompt: 'そっと おさえて、ゆーっくり ひきぬこう! はやいと ちぎれちゃう' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm89', name: 'ふぐ', emoji: '🐡', icon: 'pufferfish:cream', origins: ['yamaguchi', 'nagasaki'], rarity: 'unique',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'しものせきの うみに ふぐが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐡', markerIcon: 'pufferfish:cream', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐡'], stageIcons: ['boat:white', 'wave:sky', 'pufferfish:cream'] } } },
    { id: 'm104', name: 'いわくにれんこん', emoji: '🪷', icon: 'lotus:white', origins: ['yamaguchi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねばすを うえる', growSec: 540, fieldLabel: 'はすだ',
        harvest: { engine: 'mine', prompt: 'れんこんは どろの なか。すうじの ヒントで ばしょを すいりして ほろう!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが はっぱを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm90', name: 'はなっこりー', emoji: '🥦', icon: 'flower:lime', origins: ['yamaguchi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'はなっこりーばたけ',
        harvest: { engine: 'chain', target: '🥦', targetIcon: 'flower:lime', prompt: 'つぼみが ふくらんだ ものだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm91', name: 'すだち', emoji: '🟢', icon: 'citrus:deepgreen', origins: ['tokushima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 420, fieldLabel: 'すだちばたけ',
        harvest: { engine: 'catch', target: '🟢', targetIcon: 'citrus:deepgreen', prompt: 'おちてくる すだちを かごで うけとめよう! きんの すだちは とくてん おおい!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm92', name: 'あい', emoji: '🟦', icon: 'leaf:navy', origins: ['tokushima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 480, fieldLabel: 'あいばたけ',
        harvest: { engine: 'reap', target: '🟦', targetIcon: 'leaf:navy', prompt: 'よこに なぞって あいの はっぱを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm93', name: 'たい', emoji: '🐠', icon: 'fish:pink', origins: ['tokushima', 'ehime'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'うずしおの ながれに たいが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐠', markerIcon: 'fish:pink', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐠'], stageIcons: ['boat:white', 'wave:sky', 'fish:pink'] } } },
    { id: 'm94', name: 'こむぎ', emoji: '🌾', icon: 'grain:tan', origins: ['kagawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'むぎばたけ',
        harvest: { engine: 'reap', target: '🌾', targetIcon: 'grain:tan', prompt: 'よこに なぞって こむぎを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'すずめが ほを たべにきた! タップで おいはらえ!' } } },
    { id: 'm95', name: 'オリーブ', emoji: '🫒', icon: 'berry:deepgreen', origins: ['kagawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'オリーブばたけ',
        harvest: { engine: 'pluck', target: '🫒', targetIcon: 'berry:deepgreen', prompt: 'いろの ついた みを おさえて、ゆーっくり つみとろう! はやいと えだが おれる' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm96', name: 'きんときにんじん', emoji: '🥕', icon: 'root:crimson', origins: ['kagawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'にんじんばたけ',
        harvest: { engine: 'pluck', target: '🥕', targetIcon: 'root:crimson', prompt: 'はっぱを おさえて、ゆーっくり ひきぬこう! はやいと ちぎれちゃう' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm97', name: 'わた', emoji: '🧵', icon: 'cloth:white', origins: ['ehime', 'kagawa'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 480, fieldLabel: 'わたばたけ',
        harvest: { engine: 'chain', target: '🧵', targetIcon: 'cloth:white', prompt: 'まっしろに はじけた わただけ つもう! みどりの みは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが みを たべてる! タップで とろう!' } } },
    { id: 'm98', name: 'キウイ', emoji: '🥝', icon: 'kiwi:brown', origins: ['ehime'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'キウイの たな',
        harvest: { engine: 'pluck', target: '🥝', targetIcon: 'kiwi:brown', prompt: 'そっと おさえて、ゆーっくり つみとろう! はやいと つるが きれちゃう' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm99', name: 'はだかむぎ', emoji: '🌾', icon: 'grain:cream', origins: ['ehime'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'むぎばたけ',
        harvest: { engine: 'reap', target: '🌾', targetIcon: 'grain:cream', prompt: 'よこに なぞって はだかむぎを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'すずめが ほを たべにきた! タップで おいはらえ!' } } },
    { id: 'm100', name: 'ゆず', emoji: '🍋', icon: 'citrus:amber', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'ゆずばたけ',
        harvest: { engine: 'catch', target: '🍋', targetIcon: 'citrus:amber', prompt: 'おちてくる ゆずを かごで うけとめよう! きんの ゆずは とくてん おおい!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm101', name: 'かつお', emoji: '🐟', icon: 'bigfish:blue', origins: ['kochi', 'miyazaki'], rarity: 'unique',
      gather: { type: 'timing', verb: 'いっぽんづりに でる',
        theme: { intro: 'とさの おきに かつおの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'さおを あげる!', marker: '🐟', markerIcon: 'bigfish:blue', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'], stageIcons: ['boat:white', 'wave:sky', 'bigfish:blue'] } } },
    { id: 'm102', name: 'しょうが', emoji: '🫚', icon: 'ginger:tan', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねしょうがを うえる', growSec: 480, fieldLabel: 'しょうがばたけ',
        ...
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'つちが かわいてる! タップで みずを やろう!' } } },
    { id: 'm103', name: 'ししとう', emoji: '🫑', icon: 'pepper:green', origins: ['kochi'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'ハウスの はたけ',
        harvest: { engine: 'chain', target: '🫑', targetIcon: 'pepper:green', prompt: 'つやつやの みどりの ししとうだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが みを たべてる! タップで とろう!' } } },

    /* --- きゅうしゅう・おきなわ(2026-07 追加) --- */
    { id: 'm105', name: 'かつおな', emoji: '🥬', icon: 'leafy:lime', origins: ['fukuoka'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300, fieldLabel: 'はかたの はたけ',
        harvest: { engine: 'reap', target: '🥬', targetIcon: 'leafy:lime', prompt: 'よこに なぞって かつおなを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm106', name: 'むつごろう', emoji: '🐟', icon: 'fish:brown', origins: ['saga'], rarity: 'unique',
      gather: { type: 'timing', verb: 'ひがたに でる',
        theme: { intro: 'ありあけの ひがたに むつごろうが いる!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'さおを あげる!', marker: '🐟', markerIcon: 'fish:brown', success: 'たいりょうだ!', stages: ['🛶', '🌊', '🐟'], stageIcons: ['raft:tan', 'wave:sky', 'fish:brown'] } } },
    { id: 'm107', name: 'びわ', emoji: '🟠', icon: 'round:amber', origins: ['nagasaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'びわばたけ',
        harvest: { engine: 'catch', target: '🟠', targetIcon: 'round:amber', prompt: 'おちてくる びわを かごで うけとめよう! きんの びわは とくてん おおい!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm108', name: 'あじ', emoji: '🐟', icon: 'fish:navy', origins: ['nagasaki', 'oita'], rarity: 'local',
      gather: { type: 'timing', verb: 'りょうに でる',
        theme: { intro: 'はやい しおの ところに あじの むれが きた!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'fish:navy', success: 'たいりょうだ!', stages: ['⛵', '🌊', '🐟'], stageIcons: ['boat:white', 'wave:sky', 'fish:navy'] } } },
    { id: 'm109', name: 'いぐさ', emoji: '🎋', icon: 'stalk:deepgreen', origins: ['kumamoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 480, fieldLabel: 'いぐさだ',
        harvest: { engine: 'reap', target: '🎋', targetIcon: 'stalk:deepgreen', prompt: 'よこに なぞって いぐさを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'みずが へってる! タップで みずを 入れよう!' } } },
    { id: 'm110', name: 'デコポン', emoji: '🍊', icon: 'citrus:orange', origins: ['kumamoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'デコポンばたけ',
        harvest: { engine: 'catch', target: '🍊', targetIcon: 'citrus:orange', prompt: 'おちてくる デコポンを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm111', name: 'くり', emoji: '🌰', icon: 'chestnut:brown', origins: ['kumamoto'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 540, fieldLabel: 'くりばたけ',
        harvest: { engine: 'chain', target: '🌰', targetIcon: 'nut:brown', prompt: 'いがが ひらいた くりだけ ひろおう! まだ とじているのは はやいよ' },
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが くりを たべにきた! タップで おいはらえ!' } } },
    { id: 'm112', name: 'かぼす', emoji: '🟢', icon: 'citrus:lime', origins: ['oita'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 480, fieldLabel: 'かぼすばたけ',
        harvest: { engine: 'catch', target: '🟢', targetIcon: 'citrus:lime', prompt: 'おちてくる かぼすを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm113', name: 'しいたけ', emoji: '🍄', icon: 'mushroom:dark', origins: ['oita'], rarity: 'unique',
      gather: { type: 'plant', verb: 'ほだぎを ならべる', growSec: 480, fieldLabel: 'ほだばの もり',
        harvest: { engine: 'pluck', target: '🍄', targetIcon: 'mushroom:dark', prompt: 'かさが ひらいた しいたけを おさえて、ゆーっくり もぎとろう!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'ほだぎが かわいてる! タップで みずを かけよう!' } } },
    { id: 'm114', name: 'マンゴー', emoji: '🥭', icon: 'mango:orange', origins: ['miyazaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 600, fieldLabel: 'ハウスの きばたけ',
        harvest: { engine: 'catch', target: '🥭', targetIcon: 'mango:orange', prompt: 'じゅくして おちる マンゴーを ネットで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm115', name: 'きゅうり', emoji: '🥒', icon: 'cucumber:green', origins: ['miyazaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 300, fieldLabel: 'きゅうりの ハウス',
        harvest: { engine: 'pluck', target: '🥒', targetIcon: 'cucumber:green', prompt: 'ちょうど よい ながさの きゅうりを おさえて、ゆーっくり もぎとろう!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm116', name: 'ピーマン', emoji: '🫑', icon: 'pepper:deepgreen', origins: ['miyazaki'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'ピーマンの ハウス',
        harvest: { engine: 'chain', target: '🫑', targetIcon: 'pepper:deepgreen', prompt: 'つやつやの みどりの ピーマンだけ つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが みを たべてる! タップで とろう!' } } },
    { id: 'm117', name: 'うなぎ', emoji: '🐟', icon: 'eel:dark', origins: ['kagoshima'], rarity: 'unique',
      gather: { type: 'timing', verb: 'いけすに いく',
        theme: { intro: 'あたたかい みずの いけすで うなぎが そだった!', prompt: 'さかなを タップして つりあげよう! おおきい さかなほど なんかいも タップ! ぬしを つると ★3!', stopBtn: 'あみを ひく!', marker: '🐟', markerIcon: 'eel:dark', success: 'たいりょうだ!', stages: ['🪣', '🌊', '🐟'], stageIcons: ['bucket:silver', 'wave:sky', 'eel:dark'] } } },
    { id: 'm118', name: 'そらまめ', emoji: '🫛', icon: 'pod:lime', origins: ['kagoshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 420, fieldLabel: 'そらまめばたけ',
        harvest: { engine: 'chain', target: '🫛', targetIcon: 'pod:lime', prompt: 'そらを むいた さやが ふくらんだら つもう! ちいさいのは まだ はやいよ' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが さやを たべてる! タップで とろう!' } } },
    { id: 'm119', name: 'きんかん', emoji: '🟠', icon: 'citrus:amber', origins: ['kagoshima'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえぎを うえる', growSec: 480, fieldLabel: 'きんかんばたけ',
        harvest: { engine: 'catch', target: '🟠', targetIcon: 'citrus:amber', prompt: 'おちてくる きんかんを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm120', name: 'さとうきび', emoji: '🎍', icon: 'bamboo:lime', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 600, fieldLabel: 'さとうきびばたけ',
        harvest: { engine: 'reap', target: '🎍', targetIcon: 'bamboo:lime', prompt: 'よこに なぞって さとうきびを かりとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'たいふうが きそう! タップで ささえよう!' } } },
    { id: 'm121', name: 'ゴーヤー', emoji: '🥒', icon: 'cucumber:deepgreen', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360, fieldLabel: 'ゴーヤーの たな',
        harvest: { engine: 'chain', target: '🥒', targetIcon: 'cucumber:deepgreen', prompt: 'こい みどりで ぶつぶつが そろった ゴーヤーだけ つもう!' },
        care: { target: '🐛', targetIcon: 'bug:green', label: 'むしが はっぱを たべてる! タップで とろう!' } } },
    { id: 'm122', name: 'パイナップル', emoji: '🍍', icon: 'pineapple:amber', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 600, fieldLabel: 'パインばたけ',
        harvest: { engine: 'catch', target: '🍍', targetIcon: 'pineapple:amber', prompt: 'かりとった パイナップルを かごで うけとめよう! きんの みは とくてん おおい!' },
        care: { target: '🐦', targetIcon: 'bird:sky', label: 'とりが みを ついばんでる! タップで おいはらえ!' } } },
    { id: 'm123', name: 'もずく', emoji: '☘️', icon: 'seaweed:brown', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'あみを はる', growSec: 420, fieldLabel: 'もずくの あみば',
        harvest: { engine: 'reap', target: '☘️', targetIcon: 'seaweed:brown', prompt: 'よこに なぞって もずくを つみとろう! 1れつを ひとふででボーナス!' },
        care: { target: '🌀', targetIcon: 'wind:teal', label: 'なみが たかい! タップで あみを なおそう!' } } },
    { id: 'm124', name: 'べにいも', emoji: '🟣', icon: 'tuber:violet', origins: ['okinawa'], rarity: 'unique',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 480, fieldLabel: 'べにいもばたけ',
        ...
        care: { target: '🐗', targetIcon: 'boar:brown', label: 'いのししが はたけを あらしてる! タップで おいはらえ!' } } },
  ],

  /* ---------- レシピマスタ(Tier2〜4) ---------- */
  recipes: [
    /* --- いばらき --- */
    { id: 'r01', name: 'なっとう', emoji: '🥣', icon: 'bowl:tan', tier: 2, type: 'kakou', pref: 'ibaraki',
      ingredients: [{ ref: 'm03', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r02', name: 'ほしいも', emoji: '🍯', icon: 'sweet:amber', tier: 2, type: 'kakou', pref: 'ibaraki',
      ingredients: [{ ref: 'm04', count: 2 }] },
    { id: 'r03', name: 'うめジュース', emoji: '🧃', icon: 'bottle:lime', tier: 2, type: 'kakou', pref: 'ibaraki',
      ingredients: [{ ref: 'm06', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r05', name: 'かさまやき', emoji: '🏺', icon: 'pottery:brown', tier: 3, type: 'kougei', pref: 'ibaraki',
      ingredients: [{ ref: 'm07', count: 2, origin: 'ibaraki' }, { ref: 'm01', count: 1 }] },
    { id: 'r06', name: 'ブランドメロン', emoji: '👑', icon: 'melon:gold', tier: 3, type: 'syukaku', pref: 'ibaraki',
      ingredients: [{ ref: 'm05', count: 1, quality: 3 }] },
    { id: 'rf1', name: 'かいらくえん うめまつり', emoji: '🏮', icon: 'flower:pink', tier: 4, type: 'matsuri', pref: 'ibaraki',
      implemented: true,
      ingredients: [{ ref: 'r03', count: 1 }, { ref: 'r05', count: 1 }],
      menu: ['r03', 'r05', 'r02'] },

    /* --- ちば --- */
    { id: 'r07', name: 'しょうゆ', emoji: '🍶', icon: 'bottle:dark', tier: 2, type: 'kakou', pref: 'chiba',
      ingredients: [{ ref: 'm03', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r08', name: 'みそ', emoji: '🍲', icon: 'jar:brown', tier: 2, type: 'kakou', pref: 'chiba',
      ingredients: [{ ref: 'm03', count: 1 }, { ref: 'm02', count: 1 }] },
    { id: 'r09', name: 'ゆでらっかせい', emoji: '🥜', icon: 'nut:cream', tier: 2, type: 'kakou', pref: 'chiba',
      ingredients: [{ ref: 'm08', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r10', name: 'なめろう', emoji: '🍽️', icon: 'plate:gray', tier: 3, type: 'gattai', pref: 'chiba',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'r08', count: 1 }] },
    { id: 'r11', name: 'ブランドなし', emoji: '✨', icon: 'round:gold', tier: 3, type: 'syukaku', pref: 'chiba',
      ingredients: [{ ref: 'm10', count: 1, quality: 3 }] },
    { id: 'rf2', name: 'ちょうし みなとまつり', emoji: '🎆', icon: 'sparkle:pink', tier: 4, type: 'matsuri', pref: 'chiba',
      implemented: true, festGame: 'hanabi',
      ingredients: [{ ref: 'r10', count: 1 }, { ref: 'r09', count: 1 }],
      menu: ['r07', 'r10', 'r09'] },

    /* --- とちぎ --- */
    { id: 'r12', name: 'かんぴょう', emoji: '🌀', icon: 'rope:cream', tier: 2, type: 'kakou', pref: 'tochigi',
      ingredients: [{ ref: 'm12', count: 2 }] },
    { id: 'r13', name: 'いちごジャム', emoji: '🫙', icon: 'jar:red', tier: 2, type: 'kakou', pref: 'tochigi',
      ingredients: [{ ref: 'm11', count: 2 }] },
    { id: 'r14', name: 'かんぴょうまき', emoji: '🍣', icon: 'onigiri:dark', tier: 3, type: 'gattai', pref: 'tochigi',
      ingredients: [{ ref: 'r12', count: 1 }, { ref: 'm02', count: 1 }, { ref: 'r07', count: 1 }] },
    { id: 'r15', name: 'ましこやき', emoji: '🍵', icon: 'pottery:gray', tier: 3, type: 'kougei', pref: 'tochigi',
      ingredients: [{ ref: 'm07', count: 2, origin: 'tochigi' }, { ref: 'm01', count: 1 }] },
    { id: 'rf3', name: 'ましこ とうきいち', emoji: '🎪', icon: 'stall:brown', tier: 4, type: 'matsuri', pref: 'tochigi',
      implemented: true, festGame: 'rokuro',
      ingredients: [{ ref: 'r15', count: 1 }, { ref: 'r13', count: 1 }],
      menu: ['r15', 'r12', 'r13'] },

    /* --- ぐんま --- */
    { id: 'r16', name: 'こんにゃく', emoji: '🍢', icon: 'sweet:gray', tier: 2, type: 'kakou', pref: 'gunma',
      ingredients: [{ ref: 'm14', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r17', name: 'きぬの スカーフ', emoji: '🧣', icon: 'cloth:pink', tier: 3, type: 'kougei', pref: 'gunma',
      ingredients: [{ ref: 'm15', count: 2, origin: 'gunma' }, { ref: 'm01', count: 1 }] },
    { id: 'r18', name: 'みそこんにゃく', emoji: '🍡', icon: 'skewer:brown', tier: 3, type: 'gattai', pref: 'gunma',
      ingredients: [{ ref: 'r16', count: 1 }, { ref: 'r08', count: 1 }] },
    { id: 'rf4', name: 'たかさき だるまいち', emoji: '⛩️', icon: 'mask:red', tier: 4, type: 'matsuri', pref: 'gunma',
      implemented: true, festGame: 'daruma',
      ingredients: [{ ref: 'r17', count: 1 }, { ref: 'r18', count: 1 }],
      menu: ['r16', 'r17', 'm13'] },

    /* --- さいたま --- */
    { id: 'r19', name: 'さやまちゃ', emoji: '🫖', icon: 'pot:green', tier: 2, type: 'kakou', pref: 'saitama',
      ingredients: [{ ref: 'm16', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r20', name: 'いもようかん', emoji: '🍮', icon: 'pudding:violet', tier: 2, type: 'kakou', pref: 'saitama',
      ingredients: [{ ref: 'm04', count: 2, origin: 'saitama' }] },
    { id: 'r21', name: 'くさかせんべい', emoji: '🍘', icon: 'senbei:tan', tier: 3, type: 'gattai', pref: 'saitama',
      ingredients: [{ ref: 'm02', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'rf5', name: 'かわごえまつり', emoji: '🎐', icon: 'cart:brown', tier: 4, type: 'matsuri', pref: 'saitama',
      implemented: true, festGame: 'dashi',
      ingredients: [{ ref: 'r20', count: 1 }, { ref: 'r21', count: 1 }],
      menu: ['r19', 'r20', 'r21'] },

    /* --- とうきょう --- */
    { id: 'r22', name: 'ブルーベリージャム', emoji: '🫙', icon: 'jar:navy', tier: 2, type: 'kakou', pref: 'tokyo',
      ingredients: [{ ref: 'm18', count: 2 }] },
    { id: 'r23', name: 'こまつなの おひたし', emoji: '🥗', icon: 'bowl:green', tier: 3, type: 'gattai', pref: 'tokyo',
      ingredients: [{ ref: 'm17', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'rf6', name: 'かんだまつり', emoji: '🎌', icon: 'shrine:gold', tier: 4, type: 'matsuri', pref: 'tokyo',
      implemented: true, festGame: 'mikoshi',
      ingredients: [{ ref: 'r22', count: 1 }, { ref: 'r23', count: 1 }],
      menu: ['r22', 'r23', 'm18'] },

    /* --- かながわ --- */
    { id: 'r24', name: 'かまぼこ', emoji: '🍥', icon: 'kamaboko:pink', tier: 2, type: 'kakou', pref: 'kanagawa',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r25', name: 'ブランドみかん', emoji: '🏵️', icon: 'citrus:gold', tier: 3, type: 'syukaku', pref: 'kanagawa',
      ingredients: [{ ref: 'm19', count: 1, quality: 3 }] },
    { id: 'rf7', name: 'よこはま みなとまつり', emoji: '🎇', icon: 'boat:navy', tier: 4, type: 'matsuri', pref: 'kanagawa',
      implemented: true, festGame: 'sousen',
      ingredients: [{ ref: 'r24', count: 1 }, { ref: 'r25', count: 1 }],
      menu: ['r24', 'r25', 'm19'] },

    /* --- あおもり --- */
    { id: 'r26', name: 'りんごジュース', emoji: '🧃', icon: 'bottle:red', tier: 2, type: 'kakou', pref: 'aomori',
      ingredients: [{ ref: 'm20', count: 2, origin: 'aomori' }] },
    { id: 'r27', name: 'くろにんにく', emoji: '🖤', icon: 'onion:dark', tier: 2, type: 'kakou', pref: 'aomori',
      ingredients: [{ ref: 'm21', count: 2 }] },
    { id: 'rf8', name: 'あおもり ねぶたまつり', emoji: '👹', icon: 'lantern:crimson', tier: 4, type: 'matsuri', pref: 'aomori',
      implemented: true, festGame: 'nebuta',
      ingredients: [{ ref: 'r26', count: 1 }, { ref: 'r27', count: 1 }],
      menu: ['r26', 'r27', 'm22'] },

    /* --- いわて --- */
    { id: 'r28', name: 'のむヨーグルト', emoji: '🥤', icon: 'cup:white', tier: 2, type: 'kakou', pref: 'iwate',
      ingredients: [{ ref: 'm23', count: 2 }] },
    { id: 'r29', name: 'なんぶてっきの てつびん', emoji: '🫖', icon: 'pot:dark', tier: 3, type: 'kougei', pref: 'iwate',
      ingredients: [{ ref: 'm24', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf9', name: 'もりおか さんさおどり', emoji: '🥁', icon: 'drum:brown', tier: 4, type: 'matsuri', pref: 'iwate',
      implemented: true, festGame: 'sansa',
      ingredients: [{ ref: 'r28', count: 1 }, { ref: 'r29', count: 1 }],
      menu: ['r28', 'r29', 'm20'] },

    /* --- みやぎ --- */
    { id: 'r30', name: 'ずんだもち', emoji: '🍡', icon: 'sweet:lime', tier: 3, type: 'gattai', pref: 'miyagi',
      ingredients: [{ ref: 'r60', count: 1 }, { ref: 'm02', count: 1 }] },
    { id: 'r31', name: 'やきがき', emoji: '🔥', icon: 'shell:amber', tier: 2, type: 'kakou', pref: 'miyagi',
      ingredients: [{ ref: 'm26', count: 2 }] },
    { id: 'rf10', name: 'せんだい たなばたまつり', emoji: '🎋', icon: 'banner:pink', tier: 4, type: 'matsuri', pref: 'miyagi',
      implemented: true, festGame: 'tanabata',
      ingredients: [{ ref: 'r30', count: 1 }, { ref: 'r31', count: 1 }],
      menu: ['r30', 'r31', 'm25'] },

    /* --- あきた --- */
    { id: 'r32', name: 'きりたんぽ', emoji: '🍢', icon: 'skewer:cream', tier: 2, type: 'kakou', pref: 'akita',
      ingredients: [{ ref: 'm02', count: 2, origin: 'akita' }] },
    { id: 'r33', name: 'しょっつるなべ', emoji: '🍲', icon: 'pot:amber', tier: 3, type: 'gattai', pref: 'akita',
      ingredients: [{ ref: 'm27', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf11', name: 'あきた かんとうまつり', emoji: '🏮', icon: 'lantern:gold', tier: 4, type: 'matsuri', pref: 'akita',
      implemented: true, festGame: 'kantou',
      ingredients: [{ ref: 'r32', count: 1 }, { ref: 'r33', count: 1 }],
      menu: ['r32', 'r33', 'm27'] },

    /* --- やまがた --- */
    { id: 'r34', name: 'さくらんぼジャム', emoji: '🫙', icon: 'jar:crimson', tier: 2, type: 'kakou', pref: 'yamagata',
      ingredients: [{ ref: 'm28', count: 2 }] },
    { id: 'r35', name: 'いもに', emoji: '🍲', icon: 'pot:brown', tier: 3, type: 'gattai', pref: 'yamagata',
      ingredients: [{ ref: 'm29', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'r36', name: 'ブランドさくらんぼ', emoji: '👑', icon: 'berry:gold', tier: 3, type: 'syukaku', pref: 'yamagata',
      ingredients: [{ ref: 'm28', count: 1, quality: 3 }] },
    { id: 'rf12', name: 'やまがた はながさまつり', emoji: '🌸', icon: 'flower:crimson', tier: 4, type: 'matsuri', pref: 'yamagata',
      implemented: true, festGame: 'hanagasa',
      ingredients: [{ ref: 'r34', count: 1 }, { ref: 'r35', count: 1 }],
      menu: ['r34', 'r35', 'm28'] },

    /* --- ふくしま --- */
    { id: 'r37', name: 'ももジュース', emoji: '🍹', icon: 'bottle:pink', tier: 2, type: 'kakou', pref: 'fukushima',
      ingredients: [{ ref: 'm30', count: 2 }] },
    { id: 'r38', name: 'トマトジュース', emoji: '🥫', icon: 'bottle:crimson', tier: 2, type: 'kakou', pref: 'fukushima',
      ingredients: [{ ref: 'm31', count: 2 }] },
    { id: 'rf13', name: 'ふくしま わらじまつり', emoji: '🩴', icon: 'rope:tan', tier: 4, type: 'matsuri', pref: 'fukushima',
      implemented: true, festGame: 'waraji',
      ingredients: [{ ref: 'r37', count: 1 }, { ref: 'r38', count: 1 }],
      menu: ['r37', 'r38', 'm30'] },

    /* --- ほっかいどう --- */
    { id: 'r39', name: 'バター', emoji: '🧈', icon: 'milk:yellow', tier: 2, type: 'kakou', pref: 'hokkaido',
      ingredients: [{ ref: 'm23', count: 2, origin: 'hokkaido' }] },
    { id: 'r40', name: 'コーンスープ', emoji: '🥣', icon: 'bowl:yellow', tier: 3, type: 'gattai', pref: 'hokkaido',
      ingredients: [{ ref: 'm32', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf14', name: 'さっぽろ ゆきまつり', emoji: '⛄', icon: 'snowman:white', tier: 4, type: 'matsuri', pref: 'hokkaido',
    ...
    /* ぐんま */
    { id: 'r41', name: 'うめぼし', emoji: '🍙', icon: 'onigiri:crimson', tier: 2, type: 'kakou', pref: 'gunma',
      ingredients: [{ ref: 'm06', count: 2, origin: 'gunma' }] },
    /* さいたま */
    { id: 'r42', name: 'ねぎの まるやき', emoji: '🔥', icon: 'stalk:amber', tier: 3, type: 'gattai', pref: 'saitama',
      ingredients: [{ ref: 'm34', count: 2, origin: 'saitama' }, { ref: 'r08', count: 1 }] },
    /* とうきょう */
    { id: 'r43', name: 'わさびづけ', emoji: '🫙', icon: 'jar:teal', tier: 2, type: 'kakou', pref: 'tokyo',
      ingredients: [{ ref: 'm41', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r44', name: 'つくだに', emoji: '🍚', icon: 'bowl:dark', tier: 3, type: 'gattai', pref: 'tokyo',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'r07', count: 1 }] },
    /* かながわ */
    { id: 'r45', name: 'あしがらちゃ', emoji: '🍵', icon: 'cup:green', tier: 2, type: 'kakou', pref: 'kanagawa',
      ingredients: [{ ref: 'm16', count: 2, origin: 'kanagawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r46', name: 'よこすか カレー', emoji: '🍛', icon: 'plate:brown', tier: 3, type: 'gattai', pref: 'kanagawa',
      ingredients: [{ ref: 'm33', count: 2 }, { ref: 'm01', count: 1 }] },
    /* ほっかいどう */
    { id: 'r47', name: 'チーズ', emoji: '🧀', icon: 'cheese:yellow', tier: 2, type: 'kakou', pref: 'hokkaido',
      ingredients: [{ ref: 'm23', count: 2, origin: 'hokkaido' }] },
    { id: 'r48', name: 'かにめし', emoji: '🍱', icon: 'bowl:crimson', tier: 3, type: 'gattai', pref: 'hokkaido',
      ingredients: [{ ref: 'm36', count: 2 }, { ref: 'm02', count: 1 }] },
    /* あおもり */
    { id: 'r49', name: 'ほたての かいやき', emoji: '🐚', icon: 'shell:orange', tier: 3, type: 'gattai', pref: 'aomori',
      ingredients: [{ ref: 'm37', count: 2 }, { ref: 'r08', count: 1 }] },
    { id: 'r50', name: 'アップルパイ', emoji: '🥧', icon: 'cake:tan', tier: 3, type: 'gattai', pref: 'aomori',
      ingredients: [{ ref: 'm20', count: 2, origin: 'aomori' }, { ref: 'r39', count: 1 }] },
    /* いわて */
    { id: 'r51', name: 'ほしわかめ', emoji: '🍂', icon: 'seaweed:navy', tier: 2, type: 'kakou', pref: 'iwate',
      ingredients: [{ ref: 'm38', count: 2 }] },
    { id: 'r52', name: 'わかめの おにぎり', emoji: '🍙', icon: 'onigiri:green', tier: 3, type: 'gattai', pref: 'iwate',
      ingredients: [{ ref: 'm38', count: 1 }, { ref: 'm02', count: 1 }, { ref: 'm01', count: 1 }] },
    /* みやぎ */
    { id: 'r53', name: 'ささかまぼこ', emoji: '🍥', icon: 'kamaboko:cream', tier: 2, type: 'kakou', pref: 'miyagi',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r54', name: 'せりなべ', emoji: '🍲', icon: 'pot:lime', tier: 3, type: 'gattai', pref: 'miyagi',
      ingredients: [{ ref: 'm39', count: 2 }, { ref: 'r08', count: 1 }] },
    /* あきた */
    { id: 'r55', name: 'しょっつる', emoji: '🧴', icon: 'bottle:tan', tier: 2, type: 'kakou', pref: 'akita',
      ingredients: [{ ref: 'm27', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r56', name: 'はたはたずし', emoji: '🍣', icon: 'onigiri:amber', tier: 3, type: 'gattai', pref: 'akita',
      ingredients: [{ ref: 'm27', count: 2 }, { ref: 'm02', count: 1, origin: 'akita' }] },
    /* やまがた */
    { id: 'r57', name: 'たまこんにゃく', emoji: '🍡', icon: 'skewer:gray', tier: 2, type: 'kakou', pref: 'yamagata',
      ingredients: [{ ref: 'm14', count: 2 }, { ref: 'r07', count: 1 }] },
    /* ふくしま */
    { id: 'r58', name: 'いかにんじん', emoji: '🥕', icon: 'bowl:orange', tier: 3, type: 'gattai', pref: 'fukushima',
      ingredients: [{ ref: 'm22', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'r59', name: 'ブランドもも', emoji: '👑', icon: 'round:gold', tier: 3, type: 'syukaku', pref: 'fukushima',
      ingredients: [{ ref: 'm30', count: 1, quality: 3 }] },

    /* --- 数そろえ(2026-07): 全県 tier2×3 に そろえる ---
       いばらき・ちば が 3品だったので、そこに あわせて 各県に 1品ずつ 足した */
    { id: 'r60', name: 'ずんだ', emoji: '🥣', icon: 'bowl:lime', tier: 2, type: 'kakou', pref: 'miyagi',
      ingredients: [{ ref: 'm25', count: 2, origin: 'miyagi' }, { ref: 'm01', count: 1 }] },
    { id: 'r61', name: 'にっこうゆば', emoji: '🍥', icon: 'plate:cream', tier: 2, type: 'kakou', pref: 'tochigi',
      ingredients: [{ ref: 'm03', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r62', name: 'きいと', emoji: '🧵', icon: 'silk:cream', tier: 2, type: 'kakou', pref: 'gunma',
      ingredients: [{ ref: 'm15', count: 2, origin: 'gunma' }, { ref: 'm01', count: 1 }] },
    { id: 'r63', name: 'いもせんべい', emoji: '🍘', icon: 'senbei:amber', tier: 2, type: 'kakou', pref: 'saitama',
      ingredients: [{ ref: 'm04', count: 2, origin: 'saitama' }, { ref: 'm01', count: 1 }] },
    { id: 'r64', name: 'うどの きんぴら', emoji: '🥢', icon: 'bowl:cream', tier: 2, type: 'kakou', pref: 'tokyo',
      ingredients: [{ ref: 'm42', count: 2 }, { ref: 'r07', count: 1 }] },
    { id: 'r65', name: 'ひもの', emoji: '🐟', icon: 'fish:tan', tier: 2, type: 'kakou', pref: 'kanagawa',
      ingredients: [{ ref: 'm09', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r66', name: 'ソフトクリーム', emoji: '🍦', icon: 'icecream:white', tier: 2, type: 'kakou', pref: 'hokkaido',
      ingredients: [{ ref: 'm23', count: 2, origin: 'hokkaido' }] },
    { id: 'r67', name: 'するめ', emoji: '🦑', icon: 'squid:tan', tier: 2, type: 'kakou', pref: 'aomori',
      ingredients: [{ ref: 'm44', count: 2, origin: 'aomori' }] },
    { id: 'r68', name: 'やまぶどうジュース', emoji: '🍷', icon: 'bottle:violet', tier: 2, type: 'kakou', pref: 'iwate',
      ingredients: [{ ref: 'm45', count: 2 }] },
    { id: 'r69', name: 'あまざけ', emoji: '🍶', icon: 'sake:cream', tier: 2, type: 'kakou', pref: 'akita',
      ingredients: [{ ref: 'm02', count: 2, origin: 'akita' }, { ref: 'm01', count: 1 }] },
    { id: 'r70', name: 'べにばなぞめ', emoji: '🧣', icon: 'cloth:red', tier: 2, type: 'kakou', pref: 'yamagata',
      ingredients: [{ ref: 'm40', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r71', name: 'てうちそば', emoji: '🍜', icon: 'noodle:tan', tier: 2, type: 'kakou', pref: 'fukushima',
      ingredients: [{ ref: 'm46', count: 2 }, { ref: 'm01', count: 1 }] },

    /* ===== ちゅうぶ9県(2026-07 追加) ===== */
    /* --- にいがた --- */
    { id: 'r72', name: 'こめせんべい', emoji: '🍘', icon: 'senbei:cream', tier: 2, type: 'kakou', pref: 'niigata',
      ingredients: [{ ref: 'm02', count: 2, origin: 'niigata' }] },
    { id: 'r73', name: 'しおびきざけ', emoji: '🐡', icon: 'bigfish:tan', tier: 2, type: 'kakou', pref: 'niigata',
      ingredients: [{ ref: 'm47', count: 2, origin: 'niigata' }, { ref: 'm51', count: 1 }] },
    { id: 'r74', name: 'なすの つけもの', emoji: '🍆', icon: 'jar:violet', tier: 2, type: 'kakou', pref: 'niigata',
      ingredients: [{ ref: 'm48', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r75', name: 'わっぱめし', emoji: '🍱', icon: 'bowl:brown', tier: 3, type: 'gattai', pref: 'niigata',
      ingredients: [{ ref: 'm47', count: 1 }, { ref: 'm02', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'r76', name: 'チューリップの はなたば', emoji: '💐', icon: 'tulip:pink', tier: 3, type: 'kougei', pref: 'niigata',
      ingredients: [{ ref: 'm49', count: 2, origin: 'niigata' }, { ref: 'm01', count: 1 }] },
    { id: 'rf15', name: 'にいがた まつり', emoji: '🪭', icon: 'person-dancer:pink', tier: 4, type: 'matsuri', pref: 'niigata',
      implemented: true, festGame: 'minyou',
      ingredients: [{ ref: 'r72', count: 1 }, { ref: 'r75', count: 1 }],
      menu: ['r72', 'r75', 'r74'] },

    /* --- とやま --- */
    { id: 'r77', name: 'しろえびせんべい', emoji: '🍘', icon: 'senbei:white', tier: 2, type: 'kakou', pref: 'toyama',
      ingredients: [{ ref: 'm50', count: 2 }] },
    { id: 'r78', name: 'ほたるいかの おきづけ', emoji: '🦑', icon: 'squid:navy', tier: 2, type: 'kakou', pref: 'toyama',
      ingredients: [{ ref: 'm44', count: 2, origin: 'toyama' }, { ref: 'm51', count: 1 }] },
    { id: 'r79', name: 'いろどりかまぼこ', emoji: '🍥', icon: 'kamaboko:red', tier: 2, type: 'kakou', pref: 'toyama',
      ingredients: [{ ref: 'm47', count: 2, origin: 'toyama' }, { ref: 'm51', count: 1 }] },
    { id: 'r80', name: 'ますのすし', emoji: '🍣', icon: 'onigiri:pink', tier: 3, type: 'gattai', pref: 'toyama',
      ingredients: [{ ref: 'm47', count: 2, origin: 'toyama' }, { ref: 'm02', count: 1 }] },
    { id: 'r81', name: 'ブランドしろえび', emoji: '👑', icon: 'shrimp:gold', tier: 3, type: 'syukaku', pref: 'toyama',
      ingredients: [{ ref: 'm50', count: 1, quality: 3 }] },
    { id: 'rf16', name: 'おわら かぜの ぼん', emoji: '🎼', icon: 'person-kimono:navy', tier: 4, type: 'matsuri', pref: 'toyama',
      implemented: true, festGame: 'owara',
      ingredients: [{ ref: 'r80', count: 1 }, { ref: 'r77', count: 1 }],
      menu: ['r77', 'r80', 'r79'] },

    /* --- いしかわ --- */
    { id: 'r82', name: 'かがぼうちゃ', emoji: '🫖', icon: 'pot:tan', tier: 2, type: 'kakou', pref: 'ishikawa',
      ingredients: [{ ref: 'm16', count: 2, origin: 'ishikawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r83', name: 'れんこんもち', emoji: '🍡', icon: 'sweet:tan', tier: 2, type: 'kakou', pref: 'ishikawa',
      ingredients: [{ ref: 'm52', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r84', name: 'かにの しおゆで', emoji: '🦀', icon: 'crab:crimson', tier: 2, type: 'kakou', pref: 'ishikawa',
      ingredients: [{ ref: 'm36', count: 2, origin: 'ishikawa' }, { ref: 'm51', count: 1 }] },
    { id: 'r85', name: 'くたにやき', emoji: '🏺', icon: 'pottery:red', tier: 3, type: 'kougei', pref: 'ishikawa',
      ingredients: [{ ref: 'm07', count: 2, origin: 'ishikawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r86', name: 'はすむし', emoji: '🍲', icon: 'pot:white', tier: 3, type: 'gattai', pref: 'ishikawa',
      ingredients: [{ ref: 'm52', count: 1 }, { ref: 'm36', count: 1 }, { ref: 'm51', count: 1 }] },
    { id: 'rf17', name: 'かなざわ ひゃくまんごく まつり', emoji: '🏮', icon: 'lantern:amber', tier: 4, type: 'matsuri', pref: 'ishikawa',
      implemented: true, festGame: 'tourou',
      ingredients: [{ ref: 'r85', count: 1 }, { ref: 'r86', count: 1 }],
      menu: ['r82', 'r83', 'r85'] },

    /* --- ふくい --- */
    { id: 'r87', name: 'そばこ', emoji: '🌰', icon: 'grain:gray', tier: 2, type: 'kakou', pref: 'fukui',
      ingredients: [{ ref: 'm46', count: 2, origin: 'fukui' }] },
    { id: 'r88', name: 'うめシロップ', emoji: '🧃', icon: 'bottle:green', tier: 2, type: 'kakou', pref: 'fukui',
      ingredients: [{ ref: 'm06', count: 2, origin: 'fukui' }, { ref: 'm01', count: 1 }] },
    { id: 'r89', name: 'かにの こうらやき', emoji: '🦀', icon: 'crab:amber', tier: 2, type: 'kakou', pref: 'fukui',
      ingredients: [{ ref: 'm36', count: 2, origin: 'fukui' }, { ref: 'm51', count: 1 }] },
    { id: 'r90', name: 'おろしそば', emoji: '🍜', icon: 'noodle:gray', tier: 3, type: 'gattai', pref: 'fukui',
      ingredients: [{ ref: 'r87', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'r91', name: 'さばえの めがね', emoji: '👓', icon: 'glasses:silver', tier: 3, type: 'kougei', pref: 'fukui',
      ingredients: [{ ref: 'm53', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf18', name: 'えちぜん がにまつり', emoji: '🦀', icon: 'crab:gold', tier: 4, type: 'matsuri', pref: 'fukui',
      implemented: true, festGame: 'kani',
      ingredients: [{ ref: 'r89', count: 1 }, { ref: 'r90', count: 1 }],
      menu: ['r89', 'r90', 'r91'] },

    /* --- やまなし --- */
    { id: 'r92', name: 'ほしぶどう', emoji: '🍇', icon: 'berry:dark', tier: 2, type: 'kakou', pref: 'yamanashi',
      ingredients: [{ ref: 'm54', count: 2, origin: 'yamanashi' }] },
    { id: 'r93', name: 'ももの コンポート', emoji: '🍑', icon: 'jar:orange', tier: 2, type: 'kakou', pref: 'yamanashi',
      ingredients: [{ ref: 'm30', count: 2, origin: 'yamanashi' }, { ref: 'm01', count: 1 }] },
    { id: 'r94', name: 'かぼちゃの にもの', emoji: '🥣', icon: 'bowl:amber', tier: 2, type: 'kakou', pref: 'yamanashi',
      ingredients: [{ ref: 'm56', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r95', name: 'ほうとう', emoji: '🍲', icon: 'noodle:amber', tier: 3, type: 'gattai', pref: 'yamanashi',
      ingredients: [{ ref: 'm56', count: 1 }, { ref: 'r08', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'r96', name: 'すいしょうざいく', emoji: '💎', icon: 'gem:violet', tier: 3, type: 'kougei', pref: 'yamanashi',
      ingredients: [{ ref: 'm55', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf19', name: 'よしだの ひまつり', emoji: '🔥', icon: 'torch:orange', tier: 4, type: 'matsuri', pref: 'yamanashi',
      implemented: true, festGame: 'himatsuri',
      ingredients: [{ ref: 'r95', count: 1 }, { ref: 'r96', count: 1 }],
      menu: ['r92', 'r95', 'r96'] },

    /* --- ながの --- */
    { id: 'r97', name: 'ほしきのこ', emoji: '🍄', icon: 'mushroom:cream', tier: 2, type: 'kakou', pref: 'nagano',
      ingredients: [{ ref: 'm57', count: 2 }] },
    { id: 'r98', name: 'ぶどうジャム', emoji: '🫙', icon: 'jar:purple', tier: 2, type: 'kakou', pref: 'nagano',
      ingredients: [{ ref: 'm54', count: 2, origin: 'nagano' }] },
    { id: 'r99', name: 'りんごバター', emoji: '🧈', icon: 'jar:amber', tier: 2, type: 'kakou', pref: 'nagano',
      ingredients: [{ ref: 'm20', count: 2, origin: 'nagano' }, { ref: 'r39', count: 1 }] },
    { id: 'r100', name: 'しんしゅうそば', emoji: '🍜', icon: 'noodle:brown', tier: 3, type: 'gattai', pref: 'nagano',
      ingredients: [{ ref: 'm46', count: 2, origin: 'nagano' }, { ref: 'm01', count: 1 }] },
    { id: 'r101', name: 'きのこなべ', emoji: '🍲', icon: 'pot:cream', tier: 3, type: 'gattai', pref: 'nagano',
      ingredients: [{ ref: 'm57', count: 2 }, { ref: 'r08', count: 1 }] },
    { id: 'rf20', name: 'すわの おんばしら', emoji: '🪵', icon: 'log:brown', tier: 4, type: 'matsuri', pref: 'nagano',
      implemented: true, festGame: 'onbashira',
      ingredients: [{ ref: 'r100', count: 1 }, { ref: 'r101', count: 1 }],
      menu: ['r97', 'r100', 'r101'] },

    /* --- ぎふ --- */
    { id: 'r102', name: 'みのわし', emoji: '📜', icon: 'scroll:cream', tier: 2, type: 'kakou', pref: 'gifu',
      ingredients: [{ ref: 'm58', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r103', name: 'ひだの つけもの', emoji: '🥬', icon: 'jar:cream', tier: 2, type: 'kakou', pref: 'gifu',
      ingredients: [{ ref: 'm13', count: 2, origin: 'gifu' }, { ref: 'm51', count: 1 }] },
    { id: 'r104', name: 'あゆの しおやき', emoji: '🐟', icon: 'skewer:tan', tier: 2, type: 'kakou', pref: 'gifu',
      ingredients: [{ ref: 'm59', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r105', name: 'みのやき', emoji: '🍵', icon: 'pottery:cream', tier: 3, type: 'kougei', pref: 'gifu',
      ingredients: [{ ref: 'm07', count: 2, origin: 'gifu' }, { ref: 'm01', count: 1 }] },
    { id: 'r106', name: 'あゆめし', emoji: '🍚', icon: 'bowl:teal', tier: 3, type: 'gattai', pref: 'gifu',
      ingredients: [{ ref: 'm59', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'rf21', name: 'たかやままつり', emoji: '🎎', icon: 'cart:gold', tier: 4, type: 'matsuri', pref: 'gifu',
      implemented: true, festGame: 'karakuri',
      ingredients: [{ ref: 'r105', count: 1 }, { ref: 'r106', count: 1 }],
      menu: ['r102', 'r104', 'r105'] },

    /* --- しずおか --- */
    { id: 'r107', name: 'しずおかちゃ', emoji: '🍵', icon: 'cup:deepgreen', tier: 2, type: 'kakou', pref: 'shizuoka',
      ingredients: [{ ref: 'm16', count: 2, origin: 'shizuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r108', name: 'しらすぼし', emoji: '🐟', icon: 'plate:white', tier: 2, type: 'kakou', pref: 'shizuoka',
      ingredients: [{ ref: 'm60', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r109', name: 'みかんジュース', emoji: '🧃', icon: 'bottle:orange', tier: 2, type: 'kakou', pref: 'shizuoka',
      ingredients: [{ ref: 'm19', count: 2, origin: 'shizuoka' }] },
    { id: 'r110', name: 'しらすどん', emoji: '🍚', icon: 'bowl:silver', tier: 3, type: 'gattai', pref: 'shizuoka',
      ingredients: [{ ref: 'm60', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r111', name: 'さくらえびの かきあげ', emoji: '🍤', icon: 'shrimp:amber', tier: 3, type: 'gattai', pref: 'shizuoka',
      ingredients: [{ ref: 'm62', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf22', name: 'はままつまつり', emoji: '🪁', icon: 'kite:sky', tier: 4, type: 'matsuri', pref: 'shizuoka',
      implemented: true, festGame: 'tako',
      ingredients: [{ ref: 'r107', count: 1 }, { ref: 'r110', count: 1 }],
      menu: ['r107', 'r108', 'r110'] },

    /* --- あいち --- */
    { id: 'r112', name: 'はっちょうみそ', emoji: '🍲', icon: 'jar:tan', tier: 2, type: 'kakou', pref: 'aichi',
      ingredients: [{ ref: 'm03', count: 2, origin: 'aichi' }, { ref: 'm51', count: 1 }] },
    { id: 'r113', name: 'にしおの まっちゃ', emoji: '🍵', icon: 'tealeaf:lime', tier: 2, type: 'kakou', pref: 'aichi',
      ingredients: [{ ref: 'm16', count: 2, origin: 'aichi' }] },
    { id: 'r114', name: 'ゆでうずらたまご', emoji: '🥚', icon: 'egg:white', tier: 2, type: 'kakou', pref: 'aichi',
      ingredients: [{ ref: 'm61', count: 2 }] },
    { id: 'r115', name: 'まっちゃアイス', emoji: '🍨', icon: 'icecream:green', tier: 3, type: 'gattai', pref: 'aichi',
      ingredients: [{ ref: 'r113', count: 1 }, { ref: 'm23', count: 1 }] },
    { id: 'r116', name: 'たまごプリン', emoji: '🍮', icon: 'pudding:gold', tier: 3, type: 'gattai', pref: 'aichi',
      ingredients: [{ ref: 'm61', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf23', name: 'つしま てんのうさい', emoji: '🏮', icon: 'lantern:white', tier: 4, type: 'matsuri', pref: 'aichi',
      implemented: true, festGame: 'makiwara',
      ingredients: [{ ref: 'r112', count: 1 }, { ref: 'r115', count: 1 }],
      menu: ['r112', 'r113', 'r115'] },
    /* ===== きんき7県(2026-07 追加) ===== */
    /* --- みえ --- */
    { id: 'r117', name: 'いせちゃ', emoji: '🍵', icon: 'cup:brown', tier: 2, type: 'kakou', pref: 'mie',
      ingredients: [{ ref: 'm16', count: 2, origin: 'mie' }, { ref: 'm01', count: 1 }] },
    { id: 'r118', name: 'やきのり', emoji: '🟩', icon: 'seaweed:green', tier: 2, type: 'kakou', pref: 'mie',
      ingredients: [{ ref: 'm65', count: 2 }] },
    { id: 'r119', name: 'まつざかぎゅうの しぐれに', emoji: '🍲', icon: 'pot:crimson', tier: 2, type: 'kakou', pref: 'mie',
      ingredients: [{ ref: 'm66', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r120', name: 'いせえびの しおやき', emoji: '🦞', icon: 'shrimp:red', tier: 3, type: 'gattai', pref: 'mie',
      ingredients: [{ ref: 'm64', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r121', name: 'しんじゅの ネックレス', emoji: '📿', icon: 'pearl:silver', tier: 3, type: 'kougei', pref: 'mie',
      ingredients: [{ ref: 'm63', count: 2, quality: 3 }] },
    { id: 'rf24', name: 'くわなの いしどりまつり', emoji: '🔔', icon: 'cart:red', tier: 4, type: 'matsuri', pref: 'mie',
      implemented: true, festGame: 'ishidori',
      ingredients: [{ ref: 'r118', count: 1 }, { ref: 'r120', count: 1 }],
      menu: ['r117', 'r118', 'r120'] },

    /* --- しが --- */
    { id: 'r122', name: 'おうみまいの おにぎり', emoji: '🍙', icon: 'onigiri:white', tier: 2, type: 'kakou', pref: 'shiga',
      ingredients: [{ ref: 'm02', count: 2, origin: 'shiga' }, { ref: 'm51', count: 1 }] },
    { id: 'r123', name: 'あさみやちゃ', emoji: '🍵', icon: 'cup:amber', tier: 2, type: 'kakou', pref: 'shiga',
      ingredients: [{ ref: 'm16', count: 2, origin: 'shiga' }, { ref: 'm01', count: 1 }] },
    { id: 'r124', name: 'ふなずし', emoji: '🐟', icon: 'onigiri:tan', tier: 2, type: 'kakou', pref: 'shiga',
      ingredients: [{ ref: 'm67', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r125', name: 'しがらきやきの たぬき', emoji: '🏺', icon: 'pottery:tan', tier: 3, type: 'kougei', pref: 'shiga',
      ingredients: [{ ref: 'm07', count: 2, origin: 'shiga' }, { ref: 'm01', count: 1 }] },
    { id: 'r126', name: 'おうみの ちゃがゆ', emoji: '🍚', icon: 'bowl:sky', tier: 3, type: 'gattai', pref: 'shiga',
      ingredients: [{ ref: 'r123', count: 1 }, { ref: 'm02', count: 1, origin: 'shiga' }] },
    { id: 'rf25', name: 'ながはま ひきやままつり', emoji: '🎎', icon: 'cart:cream', tier: 4, type: 'matsuri', pref: 'shiga',
      implemented: true, festGame: 'kabuki',
      ingredients: [{ ref: 'r122', count: 1 }, { ref: 'r126', count: 1 }],
      menu: ['r122', 'r124', 'r126'] },

    /* --- きょうと --- */
    { id: 'r127', name: 'うじまっちゃ', emoji: '🍵', icon: 'bowl:deepgreen', tier: 2, type: 'kakou', pref: 'kyoto',
      ingredients: [{ ref: 'm16', count: 2, origin: 'kyoto' }, { ref: 'm01', count: 1 }] },
    { id: 'r128', name: 'くじょうねぎの やきねぎ', emoji: '🧅', icon: 'stalk:yellow', tier: 2, type: 'kakou', pref: 'kyoto',
      ingredients: [{ ref: 'm34', count: 2, origin: 'kyoto' }, { ref: 'm51', count: 1 }] },
    { id: 'r129', name: 'たけのこの にもの', emoji: '🎍', icon: 'bamboo:tan', tier: 2, type: 'kakou', pref: 'kyoto',
      ingredients: [{ ref: 'm68', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r130', name: 'まつたけごはん', emoji: '🍄', icon: 'bowl:tan', tier: 3, type: 'gattai', pref: 'kyoto',
      ingredients: [{ ref: 'm69', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r131', name: 'まっちゃの わらびもち', emoji: '🍡', icon: 'sweet:deepgreen', tier: 3, type: 'gattai', pref: 'kyoto',
      ingredients: [{ ref: 'r127', count: 1 }, { ref: 'm01', count: 1 }] },
    { id: 'rf26', name: 'ぎおんまつり', emoji: '🏮', icon: 'cart:crimson', tier: 4, type: 'matsuri', pref: 'kyoto',
      implemented: true, festGame: 'gion',
      ingredients: [{ ref: 'r127', count: 1 }, { ref: 'r130', count: 1 }],
      menu: ['r127', 'r129', 'r131'] },

    /* --- おおさか --- */
    { id: 'r132', name: 'たこやき', emoji: '🐙', icon: 'round:brown', tier: 2, type: 'kakou', pref: 'osaka',
      ingredients: [{ ref: 'm70', count: 2, origin: 'osaka' }, { ref: 'm01', count: 1 }] },
    { id: 'r133', name: 'みずなすの あさづけ', emoji: '🍆', icon: 'jar:blue', tier: 2, type: 'kakou', pref: 'osaka',
      ingredients: [{ ref: 'm79', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r134', name: 'しゅんぎくの おひたし', emoji: '🌿', icon: 'bowl:green', tier: 2, type: 'kakou', pref: 'osaka',
      ingredients: [{ ref: 'm71', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r135', name: 'せんしゅうたまねぎの スープ', emoji: '🍲', icon: 'bowl:white', tier: 3, type: 'gattai', pref: 'osaka',
      ingredients: [{ ref: 'm72', count: 2, origin: 'osaka' }, { ref: 'm01', count: 1 }] },
    { id: 'r136', name: 'デラウェアの ゼリー', emoji: '🍇', icon: 'cup:purple', tier: 3, type: 'gattai', pref: 'osaka',
      ingredients: [{ ref: 'm54', count: 2, origin: 'osaka' }, { ref: 'm01', count: 1 }] },
    { id: 'rf27', name: 'きしわだ だんじりまつり', emoji: '🏯', icon: 'cart:dark', tier: 4, type: 'matsuri', pref: 'osaka',
      implemented: true, festGame: 'danjiri',
      ingredients: [{ ref: 'r132', count: 1 }, { ref: 'r135', count: 1 }],
      menu: ['r132', 'r133', 'r135'] },

    /* --- ひょうご --- */
    { id: 'r137', name: 'たんばの くろまめに', emoji: '🫘', icon: 'pod:dark', tier: 2, type: 'kakou', pref: 'hyogo',
      ingredients: [{ ref: 'm03', count: 2, origin: 'hyogo' }, { ref: 'm51', count: 1, origin: 'hyogo' }] },
    { id: 'r138', name: 'あかしやき', emoji: '🐙', icon: 'round:cream', tier: 2, type: 'kakou', pref: 'hyogo',
      ingredients: [{ ref: 'm70', count: 2, origin: 'hyogo' }, { ref: 'm01', count: 1 }] },
    { id: 'r139', name: 'いかなごの くぎに', emoji: '🐟', icon: 'bowl:brown', tier: 2, type: 'kakou', pref: 'hyogo',
      ingredients: [{ ref: 'm73', count: 2 }, { ref: 'm51', count: 1, origin: 'hyogo' }] },
    { id: 'r140', name: 'あわじたまねぎの まるやき', emoji: '🧅', icon: 'onion:amber', tier: 3, type: 'gattai', pref: 'hyogo',
      ingredients: [{ ref: 'm72', count: 2, origin: 'hyogo' }, { ref: 'm51', count: 1, origin: 'hyogo' }] },
    { id: 'r141', name: 'たこめし', emoji: '🍚', icon: 'bowl:pink', tier: 3, type: 'gattai', pref: 'hyogo',
      ingredients: [{ ref: 'm70', count: 2, origin: 'hyogo' }, { ref: 'm02', count: 1 }] },
    { id: 'rf28', name: 'にしのみやの とおかえびす', emoji: '🎍', icon: 'person-runner:white', tier: 4, type: 'matsuri', pref: 'hyogo',
      implemented: true, festGame: 'fukuotoko',
      ingredients: [{ ref: 'r137', count: 1 }, { ref: 'r141', count: 1 }],
      menu: ['r137', 'r139', 'r141'] },

    /* --- なら --- */
    { id: 'r142', name: 'やまとちゃ', emoji: '🍵', icon: 'cup:tan', tier: 2, type: 'kakou', pref: 'nara',
      ingredients: [{ ref: 'm16', count: 2, origin: 'nara' }, { ref: 'm01', count: 1 }] },
    { id: 'r143', name: 'あすかルビーの ジャム', emoji: '🍓', icon: 'jar:pink', tier: 2, type: 'kakou', pref: 'nara',
      ingredients: [{ ref: 'm11', count: 2, origin: 'nara' }, { ref: 'm01', count: 1 }] },
    { id: 'r144', name: 'ほしがき', emoji: '🟠', icon: 'sweet:orange', tier: 2, type: 'kakou', pref: 'nara',
      ingredients: [{ ref: 'm74', count: 2 }] },
    { id: 'r145', name: 'あゆの しおやき', emoji: '🐟', icon: 'skewer:teal', tier: 3, type: 'gattai', pref: 'nara',
      ingredients: [{ ref: 'm59', count: 2, origin: 'nara' }, { ref: 'm51', count: 1 }] },
    { id: 'r146', name: 'よしのすぎの わりばし', emoji: '🥢', icon: 'craft:tan', tier: 3, type: 'kougei', pref: 'nara',
      ingredients: [{ ref: 'm75', count: 2 }] },
    { id: 'rf29', name: 'わかくさやまの やまやき', emoji: '🔥', icon: 'fire:orange', tier: 4, type: 'matsuri', pref: 'nara',
      implemented: true, festGame: 'yamayaki',
      ingredients: [{ ref: 'r142', count: 1 }, { ref: 'r145', count: 1 }],
      menu: ['r142', 'r144', 'r145'] },

    /* --- わかやま --- */
    { id: 'r147', name: 'なんこううめの うめぼし', emoji: '🫒', icon: 'round:crimson', tier: 2, type: 'kakou', pref: 'wakayama',
      ingredients: [{ ref: 'm06', count: 2, origin: 'wakayama' }, { ref: 'm51', count: 1 }] },
    { id: 'r148', name: 'ありたみかんの ジュース', emoji: '🧃', icon: 'bottle:amber', tier: 2, type: 'kakou', pref: 'wakayama',
      ingredients: [{ ref: 'm19', count: 2, origin: 'wakayama' }] },
    { id: 'r149', name: 'さんしょうの つくだに', emoji: '🌶️', icon: 'jar:deepgreen', tier: 2, type: 'kakou', pref: 'wakayama',
      ingredients: [{ ref: 'm76', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r150', name: 'まぐろの づけどん', emoji: '🍣', icon: 'bowl:navy', tier: 3, type: 'gattai', pref: 'wakayama',
      ingredients: [{ ref: 'm77', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r151', name: 'すみびやきの まぐろ', emoji: '🔥', icon: 'skewer:crimson', tier: 3, type: 'gattai', pref: 'wakayama',
      ingredients: [{ ref: 'm77', count: 1 }, { ref: 'm78', count: 2 }] },
    { id: 'rf30', name: 'なちの おうぎまつり', emoji: '🪭', icon: 'fan:gold', tier: 4, type: 'matsuri', pref: 'wakayama',
      implemented: true, festGame: 'ougi',
      ingredients: [{ ref: 'r147', count: 1 }, { ref: 'r150', count: 1 }],
      menu: ['r147', 'r148', 'r150'] },
    /* ===== ちゅうごく5県・しこく4県(2026-07 追加) ===== */
    /* --- とっとり --- */
    { id: 'r152', name: 'にじゅっせいきなしの ゼリー', emoji: '🍐', icon: 'cup:yellow', tier: 2, type: 'kakou', pref: 'tottori',
      ingredients: [{ ref: 'm10', count: 2, origin: 'tottori' }, { ref: 'm01', count: 1 }] },
    { id: 'r153', name: 'らっきょうづけ', emoji: '🧄', icon: 'jar:white', tier: 2, type: 'kakou', pref: 'tottori',
      ingredients: [{ ref: 'm80', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r154', name: 'しろねぎの やきねぎ', emoji: '🧅', icon: 'stalk:tan', tier: 2, type: 'kakou', pref: 'tottori',
      ingredients: [{ ref: 'm34', count: 2, origin: 'tottori' }, { ref: 'm51', count: 1 }] },
    { id: 'r155', name: 'まつばがにの しおゆで', emoji: '🦀', icon: 'crab:orange', tier: 3, type: 'gattai', pref: 'tottori',
      ingredients: [{ ref: 'm36', count: 2, origin: 'tottori' }, { ref: 'm51', count: 1 }] },
    { id: 'r156', name: 'かにめし', emoji: '🍚', icon: 'bowl:red', tier: 3, type: 'gattai', pref: 'tottori',
      ingredients: [{ ref: 'm36', count: 2, origin: 'tottori' }, { ref: 'm02', count: 1 }] },
    { id: 'rf31', name: 'とっとり しゃんしゃんまつり', emoji: '🌂', icon: 'umbrella:pink', tier: 4, type: 'matsuri', pref: 'tottori',
      implemented: true, festGame: 'shanshan',
      ingredients: [{ ref: 'r153', count: 1 }, { ref: 'r155', count: 1 }],
      menu: ['r152', 'r153', 'r155'] },

    /* --- しまね --- */
    { id: 'r157', name: 'しじみの みそしる', emoji: '🐚', icon: 'bowl:dark', tier: 2, type: 'kakou', pref: 'shimane',
      ingredients: [{ ref: 'm81', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r158', name: 'いずもそば', emoji: '🍜', icon: 'noodle:dark', tier: 2, type: 'kakou', pref: 'shimane',
      ingredients: [{ ref: 'm46', count: 2, origin: 'shimane' }, { ref: 'm01', count: 1 }] },
    { id: 'r159', name: 'のどぐろの しおやき', emoji: '🐠', icon: 'skewer:red', tier: 2, type: 'kakou', pref: 'shimane',
      ingredients: [{ ref: 'm82', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r160', name: 'たたらの ほうちょう', emoji: '🔪', icon: 'knife:silver', tier: 3, type: 'kougei', pref: 'shimane',
      ingredients: [{ ref: 'm24', count: 2, origin: 'shimane' }] },
    { id: 'r161', name: 'デラウェアの ジュース', emoji: '🧃', icon: 'bottle:purple', tier: 3, type: 'gattai', pref: 'shimane',
      ingredients: [{ ref: 'm54', count: 2, origin: 'shimane' }, { ref: 'm01', count: 1 }] },
    { id: 'rf32', name: 'いわみかぐら', emoji: '🐉', icon: 'dragon:red', tier: 4, type: 'matsuri', pref: 'shimane',
      implemented: true, festGame: 'kagura',
      ingredients: [{ ref: 'r157', count: 1 }, { ref: 'r158', count: 1 }],
      menu: ['r157', 'r158', 'r159'] },

    /* --- おかやま --- */
    { id: 'r162', name: 'マスカットの ゼリー', emoji: '🍇', icon: 'cup:lime', tier: 2, type: 'kakou', pref: 'okayama',
      ingredients: [{ ref: 'm54', count: 2, origin: 'okayama' }, { ref: 'm01', count: 1 }] },
    { id: 'r163', name: 'はくとうの コンポート', emoji: '🍑', icon: 'jar:silver', tier: 2, type: 'kakou', pref: 'okayama',
      ingredients: [{ ref: 'm30', count: 2, origin: 'okayama' }, { ref: 'm01', count: 1 }] },
    { id: 'r164', name: 'ままかりずし', emoji: '🍣', icon: 'onigiri:silver', tier: 2, type: 'kakou', pref: 'okayama',
      ingredients: [{ ref: 'm83', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r165', name: 'きにらの スープ', emoji: '🍲', icon: 'bowl:yellow', tier: 3, type: 'gattai', pref: 'okayama',
      ingredients: [{ ref: 'm84', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r166', name: 'びぜんやきの つぼ', emoji: '🏺', icon: 'pottery:dark', tier: 3, type: 'kougei', pref: 'okayama',
      ingredients: [{ ref: 'm07', count: 2, origin: 'okayama' }] },
    { id: 'rf33', name: 'さいだいじ えよう', emoji: '🪵', icon: 'log:cream', tier: 4, type: 'matsuri', pref: 'okayama',
      implemented: true, festGame: 'eyou',
      ingredients: [{ ref: 'r164', count: 1 }, { ref: 'r165', count: 1 }],
      menu: ['r162', 'r164', 'r166'] },

    /* --- ひろしま --- */
    { id: 'r167', name: 'かきの どてなべ', emoji: '🦪', icon: 'pot:orange', tier: 2, type: 'kakou', pref: 'hiroshima',
      ingredients: [{ ref: 'm26', count: 2, origin: 'hiroshima' }, { ref: 'm51', count: 1 }] },
    { id: 'r168', name: 'レモンの はちみつづけ', emoji: '🍋', icon: 'jar:yellow', tier: 2, type: 'kakou', pref: 'hiroshima',
      ingredients: [{ ref: 'm85', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r169', name: 'ひろしまなの つけもの', emoji: '🥬', icon: 'jar:lime', tier: 2, type: 'kakou', pref: 'hiroshima',
      ingredients: [{ ref: 'm86', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r170', name: 'あなごめし', emoji: '🍚', icon: 'bowl:amber', tier: 3, type: 'gattai', pref: 'hiroshima',
      ingredients: [{ ref: 'm87', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'r171', name: 'わけぎの ぬた', emoji: '🌱', icon: 'bowl:lime', tier: 3, type: 'gattai', pref: 'hiroshima',
      ingredients: [{ ref: 'm88', count: 2 }, { ref: 'm03', count: 1 }] },
    { id: 'rf34', name: 'おのみち べっちゃーまつり', emoji: '👹', icon: 'oni:crimson', tier: 4, type: 'matsuri', pref: 'hiroshima',
      implemented: true, festGame: 'betcha',
      ingredients: [{ ref: 'r167', count: 1 }, { ref: 'r170', count: 1 }],
      menu: ['r167', 'r168', 'r170'] },

    /* --- やまぐち --- */
    { id: 'r172', name: 'ふぐの さしみ', emoji: '🐡', icon: 'plate:teal', tier: 2, type: 'kakou', pref: 'yamaguchi',
      ingredients: [{ ref: 'm89', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r173', name: 'なつみかんの ママレード', emoji: '🍊', icon: 'jar:gold', tier: 2, type: 'kakou', pref: 'yamaguchi',
      ingredients: [{ ref: 'm19', count: 2, origin: 'yamaguchi' }, { ref: 'm01', count: 1 }] },
    { id: 'r174', name: 'いわくにれんこんの きんぴら', emoji: '🪷', icon: 'bowl:white', tier: 2, type: 'kakou', pref: 'yamaguchi',
      ingredients: [{ ref: 'm104', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r175', name: 'はなっこりーの おひたし', emoji: '🥦', icon: 'bowl:teal', tier: 3, type: 'gattai', pref: 'yamaguchi',
      ingredients: [{ ref: 'm90', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r176', name: 'けんさきいかの いかそうめん', emoji: '🦑', icon: 'noodle:white', tier: 3, type: 'gattai', pref: 'yamaguchi',
      ingredients: [{ ref: 'm44', count: 2, origin: 'yamaguchi' }, { ref: 'm51', count: 1 }] },
    { id: 'rf35', name: 'やない きんぎょちょうちんまつり', emoji: '🐟', icon: 'lantern:orange', tier: 4, type: 'matsuri', pref: 'yamaguchi',
      implemented: true, festGame: 'kingyo',
      ingredients: [{ ref: 'r172', count: 1 }, { ref: 'r176', count: 1 }],
      menu: ['r172', 'r173', 'r176'] },

    /* --- とくしま --- */
    { id: 'r177', name: 'すだちの しぼり', emoji: '🟢', icon: 'bottle:teal', tier: 2, type: 'kakou', pref: 'tokushima',
      ingredients: [{ ref: 'm91', count: 2 }] },
    { id: 'r178', name: 'なるときんときの やきいも', emoji: '🍠', icon: 'tuber:amber', tier: 2, type: 'kakou', pref: 'tokushima',
      ingredients: [{ ref: 'm04', count: 2, origin: 'tokushima' }] },
    { id: 'r179', name: 'なるとわかめの すのもの', emoji: '☘️', icon: 'bowl:deepgreen', tier: 2, type: 'kakou', pref: 'tokushima',
      ingredients: [{ ref: 'm38', count: 2, origin: 'tokushima' }, { ref: 'm51', count: 1 }] },
    { id: 'r180', name: 'あわあいぞめの ハンカチ', emoji: '🟦', icon: 'cloth:navy', tier: 3, type: 'kougei', pref: 'tokushima',
      ingredients: [{ ref: 'm92', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r181', name: 'なるとだいの しおやき', emoji: '🐠', icon: 'skewer:pink', tier: 3, type: 'gattai', pref: 'tokushima',
      ingredients: [{ ref: 'm93', count: 2, origin: 'tokushima' }, { ref: 'm51', count: 1 }] },
    { id: 'rf36', name: 'あわおどり', emoji: '👘', icon: 'person-dancer:crimson', tier: 4, type: 'matsuri', pref: 'tokushima',
      implemented: true, festGame: 'awaodori',
      ingredients: [{ ref: 'r178', count: 1 }, { ref: 'r181', count: 1 }],
      menu: ['r177', 'r178', 'r181'] },

    /* --- かがわ --- */
    { id: 'r182', name: 'さぬきうどん', emoji: '🍜', icon: 'noodle:cream', tier: 2, type: 'kakou', pref: 'kagawa',
      ingredients: [{ ref: 'm94', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r183', name: 'オリーブの つけもの', emoji: '🫒', icon: 'jar:green', tier: 2, type: 'kakou', pref: 'kagawa',
      ingredients: [{ ref: 'm95', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r184', name: 'いりこだし', emoji: '🐟', icon: 'bottle:gray', tier: 2, type: 'kakou', pref: 'kagawa',
      ingredients: [{ ref: 'm09', count: 2, origin: 'kagawa' }, { ref: 'm01', count: 1 }] },
    { id: 'r185', name: 'きんときにんじんの にもの', emoji: '🥕', icon: 'bowl:crimson', tier: 3, type: 'gattai', pref: 'kagawa',
      ingredients: [{ ref: 'm96', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r186', name: 'さぬきの てぶくろ', emoji: '🧤', icon: 'glove:white', tier: 3, type: 'kougei', pref: 'kagawa',
      ingredients: [{ ref: 'm97', count: 2, origin: 'kagawa' }] },
    { id: 'rf37', name: 'さぬき ちょうさまつり', emoji: '🥁', icon: 'drum:gold', tier: 4, type: 'matsuri', pref: 'kagawa',
      implemented: true, festGame: 'chousa',
      ingredients: [{ ref: 'r182', count: 1 }, { ref: 'r185', count: 1 }],
      menu: ['r182', 'r183', 'r185'] },

    /* --- えひめ --- */
    { id: 'r187', name: 'いよかんジュース', emoji: '🧃', icon: 'bottle:yellow', tier: 2, type: 'kakou', pref: 'ehime',
      ingredients: [{ ref: 'm19', count: 2, origin: 'ehime' }] },
    { id: 'r188', name: 'まだいの かぶとに', emoji: '🐠', icon: 'pot:pink', tier: 2, type: 'kakou', pref: 'ehime',
      ingredients: [{ ref: 'm93', count: 2, origin: 'ehime' }, { ref: 'm51', count: 1 }] },
    { id: 'r189', name: 'キウイの ジャム', emoji: '🥝', icon: 'jar:sky', tier: 2, type: 'kakou', pref: 'ehime',
      ingredients: [{ ref: 'm98', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r190', name: 'いまばりの タオル', emoji: '🛁', icon: 'towel:white', tier: 3, type: 'kougei', pref: 'ehime',
      ingredients: [{ ref: 'm97', count: 2, origin: 'ehime' }, { ref: 'm01', count: 1 }] },
    { id: 'r191', name: 'はだかむぎの むぎみそ', emoji: '🍲', icon: 'jar:tan', tier: 3, type: 'gattai', pref: 'ehime',
      ingredients: [{ ref: 'm99', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'rf38', name: 'うわじま うしおにまつり', emoji: '🐮', icon: 'oni:brown', tier: 4, type: 'matsuri', pref: 'ehime',
      implemented: true, festGame: 'ushioni',
      ingredients: [{ ref: 'r187', count: 1 }, { ref: 'r188', count: 1 }],
      menu: ['r187', 'r188', 'r190'] },

    /* --- こうち --- */
    { id: 'r192', name: 'ゆずポン', emoji: '🍋', icon: 'bottle:brown', tier: 2, type: 'kakou', pref: 'kochi',
      ingredients: [{ ref: 'm100', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r193', name: 'かつおの たたき', emoji: '🐟', icon: 'plate:crimson', tier: 2, type: 'kakou', pref: 'kochi',
      ingredients: [{ ref: 'm101', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r194', name: 'しょうがの あめに', emoji: '🫚', icon: 'sweet:amber', tier: 2, type: 'kakou', pref: 'kochi',
      ingredients: [{ ref: 'm102', count: 2 }, { ref: 'm01', count: 1, origin: 'kochi' }] },
    { id: 'r195', name: 'ししとうの やきびたし', emoji: '🫑', icon: 'plate:lime', tier: 3, type: 'gattai', pref: 'kochi',
      ingredients: [{ ref: 'm103', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r196', name: 'かつおめし', emoji: '🍚', icon: 'bowl:navy', tier: 3, type: 'gattai', pref: 'kochi',
      ingredients: [{ ref: 'm101', count: 2 }, { ref: 'm02', count: 1 }] },
    { id: 'rf39', name: 'よさこいまつり', emoji: '🪇', icon: 'naruko:red', tier: 4, type: 'matsuri', pref: 'kochi',
      implemented: true, festGame: 'yosakoi',
      ingredients: [{ ref: 'r193', count: 1 }, { ref: 'r196', count: 1 }],
      menu: ['r192', 'r193', 'r196'] },
    /* ===== きゅうしゅう・おきなわ8県(2026-07 追加。これで 47都道府県 コンプリート) ===== */
    /* --- ふくおか --- */
    { id: 'r197', name: 'あまおうの ジャム', emoji: '🍓', icon: 'jar:crimson', tier: 2, type: 'kakou', pref: 'fukuoka',
      ingredients: [{ ref: 'm11', count: 2, origin: 'fukuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r198', name: 'やめちゃ', emoji: '🍵', icon: 'cup:teal', tier: 2, type: 'kakou', pref: 'fukuoka',
      ingredients: [{ ref: 'm16', count: 2, origin: 'fukuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r199', name: 'ありあけの やきのり', emoji: '🟩', icon: 'seaweed:teal', tier: 2, type: 'kakou', pref: 'fukuoka',
      ingredients: [{ ref: 'm65', count: 2, origin: 'fukuoka' }] },
    { id: 'r200', name: 'たけのこの わかたけに', emoji: '🎍', icon: 'bamboo:green', tier: 3, type: 'gattai', pref: 'fukuoka',
      ingredients: [{ ref: 'm68', count: 2, origin: 'fukuoka' }, { ref: 'm01', count: 1 }] },
    { id: 'r201', name: 'かつおなの ぞうに', emoji: '🍲', icon: 'pot:teal', tier: 3, type: 'gattai', pref: 'fukuoka',
      ingredients: [{ ref: 'm105', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'rf40', name: 'はかた ぎおん やまかさ', emoji: '🏮', icon: 'person-carry:white', tier: 4, type: 'matsuri', pref: 'fukuoka',
      implemented: true, festGame: 'yamakasa',
      ingredients: [{ ref: 'r199', count: 1 }, { ref: 'r200', count: 1 }],
      menu: ['r197', 'r198', 'r200'] },

    /* --- さが --- */
    { id: 'r202', name: 'のりの つくだに', emoji: '🟩', icon: 'jar:dark', tier: 2, type: 'kakou', pref: 'saga',
      ingredients: [{ ref: 'm65', count: 2, origin: 'saga' }, { ref: 'm51', count: 1 }] },
    { id: 'r203', name: 'さがびよりの おにぎり', emoji: '🍙', icon: 'onigiri:cream', tier: 2, type: 'kakou', pref: 'saga',
      ingredients: [{ ref: 'm02', count: 2, origin: 'saga' }, { ref: 'm51', count: 1 }] },
    { id: 'r204', name: 'いちごさんの タルト', emoji: '🍓', icon: 'cake:red', tier: 2, type: 'kakou', pref: 'saga',
      ingredients: [{ ref: 'm11', count: 2, origin: 'saga' }, { ref: 'm01', count: 1 }] },
    { id: 'r205', name: 'ありたやきの おさら', emoji: '🏺', icon: 'plate:sky', tier: 3, type: 'kougei', pref: 'saga',
      ingredients: [{ ref: 'm07', count: 2, origin: 'saga' }] },
    { id: 'r206', name: 'むつごろうの かばやき', emoji: '🐟', icon: 'skewer:brown', tier: 3, type: 'gattai', pref: 'saga',
      ingredients: [{ ref: 'm106', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'rf41', name: 'さが バルーンフェスタ', emoji: '🎈', icon: 'balloon:red', tier: 4, type: 'matsuri', pref: 'saga',
      implemented: true, festGame: 'balloon',
      ingredients: [{ ref: 'r203', count: 1 }, { ref: 'r206', count: 1 }],
      menu: ['r202', 'r203', 'r206'] },

    /* --- ながさき --- */
    { id: 'r207', name: 'びわの ゼリー', emoji: '🟠', icon: 'cup:amber', tier: 2, type: 'kakou', pref: 'nagasaki',
      ingredients: [{ ref: 'm107', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r208', name: 'あじの ひらき', emoji: '🐟', icon: 'plate:silver', tier: 2, type: 'kakou', pref: 'nagasaki',
      ingredients: [{ ref: 'm108', count: 2, origin: 'nagasaki' }, { ref: 'm51', count: 1 }] },
    { id: 'r209', name: 'そのぎちゃ', emoji: '🍵', icon: 'cup:sky', tier: 2, type: 'kakou', pref: 'nagasaki',
      ingredients: [{ ref: 'm16', count: 2, origin: 'nagasaki' }, { ref: 'm01', count: 1 }] },
    { id: 'r210', name: 'ちゃんぽん', emoji: '🍜', icon: 'noodle:yellow', tier: 3, type: 'gattai', pref: 'nagasaki',
      ingredients: [{ ref: 'm94', count: 2 }, { ref: 'm108', count: 1, origin: 'nagasaki' }] },
    { id: 'r211', name: 'とらふぐの てっさ', emoji: '🐡', icon: 'pufferfish:white', tier: 3, type: 'gattai', pref: 'nagasaki',
      ingredients: [{ ref: 'm89', count: 2, origin: 'nagasaki' }, { ref: 'm51', count: 1 }] },
    { id: 'rf42', name: 'ながさきくんち', emoji: '🐲', icon: 'dragon:gold', tier: 4, type: 'matsuri', pref: 'nagasaki',
      implemented: true, festGame: 'kokkodesho',
      ingredients: [{ ref: 'r208', count: 1 }, { ref: 'r210', count: 1 }],
      menu: ['r207', 'r209', 'r210'] },

    /* --- くまもと --- */
    { id: 'r212', name: 'いぐさの コースター', emoji: '🎋', icon: 'mat:cream', tier: 2, type: 'kougei', pref: 'kumamoto',
      ingredients: [{ ref: 'm109', count: 2 }] },
    { id: 'r213', name: 'デコポンの ジュース', emoji: '🍊', icon: 'bottle:orange', tier: 2, type: 'kakou', pref: 'kumamoto',
      ingredients: [{ ref: 'm110', count: 2 }] },
    { id: 'r214', name: 'くまもとの こめせんべい', emoji: '🍘', icon: 'senbei:brown', tier: 2, type: 'kakou', pref: 'kumamoto',
      ingredients: [{ ref: 'm02', count: 2, origin: 'kumamoto' }, { ref: 'm51', count: 1 }] },
    { id: 'r215', name: 'くりの きんとん', emoji: '🌰', icon: 'sweet:cream', tier: 3, type: 'gattai', pref: 'kumamoto',
      ingredients: [{ ref: 'm111', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'r216', name: 'らくのうの ミルクプリン', emoji: '🍮', icon: 'pudding:pink', tier: 3, type: 'gattai', pref: 'kumamoto',
      ingredients: [{ ref: 'm23', count: 2, origin: 'kumamoto' }, { ref: 'm01', count: 1 }] },
    { id: 'rf43', name: 'ふじさきはちまんぐうの ぼした祭り', emoji: '🐴', icon: 'horse:brown', tier: 4, type: 'matsuri', pref: 'kumamoto',
      implemented: true, festGame: 'kazariuma',
      ingredients: [{ ref: 'r213', count: 1 }, { ref: 'r216', count: 1 }],
      menu: ['r212', 'r213', 'r216'] },

    /* --- おおいた --- */
    { id: 'r217', name: 'かぼすの ぽんず', emoji: '🟢', icon: 'bottle:deepgreen', tier: 2, type: 'kakou', pref: 'oita',
      ingredients: [{ ref: 'm112', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r218', name: 'ほししいたけ', emoji: '🍄', icon: 'mushroom:gray', tier: 2, type: 'kakou', pref: 'oita',
      ingredients: [{ ref: 'm113', count: 2 }] },
    { id: 'r219', name: 'せきあじの さしみ', emoji: '🐟', icon: 'plate:pink', tier: 2, type: 'kakou', pref: 'oita',
      ingredients: [{ ref: 'm108', count: 2, origin: 'oita' }, { ref: 'm51', count: 1 }] },
    { id: 'r220', name: 'おんせんたまご', emoji: '🥚', icon: 'egg:amber', tier: 3, type: 'gattai', pref: 'oita',
      ingredients: [{ ref: 'm61', count: 2 }, { ref: 'm01', count: 1, origin: 'oita' }] },
    { id: 'r221', name: 'しいたけの にもの', emoji: '🍲', icon: 'bowl:gray', tier: 3, type: 'gattai', pref: 'oita',
      ingredients: [{ ref: 'm113', count: 2 }, { ref: 'm34', count: 1, origin: 'oita' }] },
    { id: 'rf44', name: 'べっぷ おんせんまつり', emoji: '♨️', icon: 'hotspring:sky', tier: 4, type: 'matsuri', pref: 'oita',
      implemented: true, festGame: 'yukake',
      ingredients: [{ ref: 'r218', count: 1 }, { ref: 'r220', count: 1 }],
      menu: ['r217', 'r218', 'r220'] },

    /* --- みやざき --- */
    { id: 'r222', name: 'たいようのタマゴ', emoji: '🥭', icon: 'mango:crimson', tier: 2, type: 'kakou', pref: 'miyazaki',
      ingredients: [{ ref: 'm114', count: 2 }] },
    { id: 'r223', name: 'みやざきの ちゃ', emoji: '🍵', icon: 'tealeaf:green', tier: 2, type: 'kakou', pref: 'miyazaki',
      ingredients: [{ ref: 'm16', count: 2, origin: 'miyazaki' }, { ref: 'm01', count: 1 }] },
    { id: 'r224', name: 'きゅうりの あさづけ', emoji: '🥒', icon: 'jar:green', tier: 2, type: 'kakou', pref: 'miyazaki',
      ingredients: [{ ref: 'm115', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r225', name: 'ピーマンの やきびたし', emoji: '🫑', icon: 'plate:deepgreen', tier: 3, type: 'gattai', pref: 'miyazaki',
      ingredients: [{ ref: 'm116', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r226', name: 'マンゴーの スムージー', emoji: '🥤', icon: 'cup:orange', tier: 3, type: 'gattai', pref: 'miyazaki',
      ingredients: [{ ref: 'm114', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf45', name: 'ひゅうが ひょっとこ なつまつり', emoji: '🤡', icon: 'mask:cream', tier: 4, type: 'matsuri', pref: 'miyazaki',
      implemented: true, festGame: 'hyottoko',
      ingredients: [{ ref: 'r222', count: 1 }, { ref: 'r225', count: 1 }],
      menu: ['r222', 'r223', 'r225'] },

    /* --- かごしま --- */
    { id: 'r227', name: 'さつまいもの かりんとう', emoji: '🍠', icon: 'sweet:brown', tier: 2, type: 'kakou', pref: 'kagoshima',
      ingredients: [{ ref: 'm04', count: 2, origin: 'kagoshima' }, { ref: 'm01', count: 1 }] },
    { id: 'r228', name: 'ちらんちゃ', emoji: '🍵', icon: 'cup:cream', tier: 2, type: 'kakou', pref: 'kagoshima',
      ingredients: [{ ref: 'm16', count: 2, origin: 'kagoshima' }, { ref: 'm01', count: 1 }] },
    { id: 'r229', name: 'そらまめの しおゆで', emoji: '🫛', icon: 'pod:cream', tier: 2, type: 'kakou', pref: 'kagoshima',
      ingredients: [{ ref: 'm118', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r230', name: 'うなぎの かばやき', emoji: '🐟', icon: 'eel:amber', tier: 3, type: 'gattai', pref: 'kagoshima',
      ingredients: [{ ref: 'm117', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r231', name: 'きんかんの あまに', emoji: '🟠', icon: 'jar:orange', tier: 3, type: 'gattai', pref: 'kagoshima',
      ingredients: [{ ref: 'm119', count: 2 }, { ref: 'm01', count: 1 }] },
    { id: 'rf46', name: 'かごしまの ろくがつどう', emoji: '🏮', icon: 'lantern:violet', tier: 4, type: 'matsuri', pref: 'kagoshima',
      implemented: true, festGame: 'rokugatsudo',
      ingredients: [{ ref: 'r227', count: 1 }, { ref: 'r230', count: 1 }],
      menu: ['r227', 'r230', 'r231'] },

    /* --- おきなわ --- */
    { id: 'r232', name: 'くろざとう', emoji: '🍬', icon: 'sweet:dark', tier: 2, type: 'kakou', pref: 'okinawa',
      ingredients: [{ ref: 'm120', count: 2 }] },
    { id: 'r233', name: 'ゴーヤーチャンプルー', emoji: '🥒', icon: 'plate:green', tier: 2, type: 'kakou', pref: 'okinawa',
      ingredients: [{ ref: 'm121', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r234', name: 'パイナップルの ジュース', emoji: '🍍', icon: 'bottle:gold', tier: 2, type: 'kakou', pref: 'okinawa',
      ingredients: [{ ref: 'm122', count: 2 }] },
    { id: 'r235', name: 'もずくの すのもの', emoji: '☘️', icon: 'bowl:gray', tier: 3, type: 'gattai', pref: 'okinawa',
      ingredients: [{ ref: 'm123', count: 2 }, { ref: 'm51', count: 1 }] },
    { id: 'r236', name: 'べにいもの タルト', emoji: '🟣', icon: 'cake:violet', tier: 3, type: 'gattai', pref: 'okinawa',
      ingredients: [{ ref: 'm124', count: 2 }, { ref: 'm23', count: 1 }] },
    { id: 'rf47', name: 'なは おおづなひき', emoji: '🪢', icon: 'rope:crimson', tier: 4, type: 'matsuri', pref: 'okinawa',
  ...
  trivia: [
    ...
    { target: 'rf43', text: 'ぼした祭りでは きれいに かざった うまを ひいて、まちを ねりあるくよ。' },
  ...
  quizzes: [
    ...
    { id: 'qy64', kind: 'bunka', tags: ['rf43', 'r213'], q: 'ぼした祭りで まちを ねりあるくのは?', choices: ['かざった うま', 'ふね', 'ぞう'], answer: 0 },
