...
export const GAME_DATA: GameData = {
  ...
  /* ---------- そざいマスタ(Tier1) ---------- */
  materials: [
    { id: 'm01', name: 'みず', emoji: '💧', origins: ['ibaraki', 'akita', 'yamanashi'], rarity: 'common',
      gather: { type: 'infra', building: 'いど', bEmoji: '⛲', rateSec: 120, max: 3, collectVerb: 'くみあげる' } },
    { id: 'm02', name: 'こめ', emoji: '🌾', origins: ['chiba', 'akita', 'miyagi', 'fukushima', 'niigata', 'toyama', 'fukui', 'gifu'], rarity: 'common',
    ...
    { id: 'm03', name: 'だいず', emoji: '🫘', origins: ['tochigi', 'aichi'], rarity: 'local',
    ...
    { id: 'm06', name: 'うめ', emoji: '🫒', origins: ['ibaraki', 'gunma', 'tokyo', 'fukui'], rarity: 'local',
    ...
    { id: 'm07', name: 'ねんど', emoji: '🟤', origins: ['ibaraki', 'tochigi', 'ishikawa', 'gifu'], rarity: 'local',
    ...
    { id: 'm11', name: 'いちご', emoji: '🍓', origins: ['tochigi', 'miyagi'], rarity: 'local',
      gather: { type: 'plant', verb: 'たねを まく', growSec: 300,
    ...
    /* --- さいたま --- */
    { id: 'm16', name: 'ちゃば', emoji: '🍃', origins: ['saitama', 'kanagawa', 'ishikawa', 'shizuoka', 'aichi'], rarity: 'local',
    ...
    /* --- かながわ --- */
    { id: 'm19', name: 'みかん', emoji: '🍊', origins: ['kanagawa', 'shizuoka', 'aichi'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 1200,
    ...
    { id: 'm34', name: 'ねぎ', emoji: '🧅', origins: ['saitama', 'gunma', 'akita'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 360,
    ...
    { id: 'm51', name: 'しお', emoji: '🧂', origins: ['ishikawa'], rarity: 'unique',
    ...
    { id: 'm54', name: 'ぶどう', emoji: '🍇', origins: ['yamanashi', 'nagano'], rarity: 'local',
      gather: { type: 'plant', verb: 'なえを うえる', growSec: 900,
        harvest: { engine: 'pluck', target: '🍇', prompt: 'むらさきに じゅくした ふさを おさえて、ゆーっくり ひっぱろう!' },
        care: { target: '🐦', label: 'とりが みを ねらってる! タップで おいはらえ!' } } },
    ...
    { id: 'm59', name: 'あゆ', emoji: '🐟', origins: ['gifu'], rarity: 'unique',
