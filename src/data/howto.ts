...
export const HOW_TO: Record<string, HowTo> = {
  ...
  /** ゆきまつり: ゆきの かたまりを タップして けずる */
  yukimatsuri: { kind: 'tap', at: [[92, 207], [166, 207]] },
  ...
  /** かに: わっかを タップして わり、もう一度 タップで みを とる */
  kani: { kind: 'tap', at: [[240, 292], [240, 292]] },
  ...
  rokugatsudo: { kind: 'tap', at: [[200, 340], [280, 400]] },
