...
export const UI_TEXT = {
  ...
  fest: {
    ...
    introAwaodori:
      '「えらいやっちゃ」の 2びょうしで まちを ながれる おどり。\nながれてくる しるしを 見て、\nてのマークは タップ、あしのマークは 上に スワイプ!',
    awaodoriPrompt: 'てのマークは タップ、あしのマークは 上スワイプ! わくに きた しゅんかんに うちわけよう!',
    awaodoriHow: 'て= タップ  /  あし= 上に スワイプ',
    awaodoriOk: 'よし!',
    awaodoriEraiya: 'えらいやっちゃ!',
    awaodoriMiss: 'タイミングが ずれた!',
    awaodoriNeedHand: 'そこは て! タップ!',
    awaodoriNeedFoot: 'そこは あし! 上スワイプ!',
    ...
    yukakePrompt: 'ながおしで ゆを ためる! あつめは たっぷり、ぬるめは すこしで 手を はなす!',
